<div class="owl-carousel owl-theme dots-title mb-0" data-plugin-options="{'items': 1, 'autoHeight': true}">
											<div class="row">
													...
													<article>
														<div class="row">
															...
															<div class="col pl-1">
																...
																<p class="pl-4 mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
																<a href="/" class="read-more text-color-dark font-weight-semibold text-2">read more <i class="fas fa-angle-left position-relative top-1 mr-1"></i></a>
															</div>
														</div>
													</article>
												</div>
