					...
					<div class="row py-5">
						...
						<div class="col-lg-3 mb-4 mb-lg-0">
							...
							<ul class="list list-unstyled">
								...
								<li class="mb-1">
									<a class="link-hover-style-1" data-hash data-hash-offset="95" href="#about">About</a>
								</li>
								<li class="mb-1">
									<a class="link-hover-style-1" data-hash data-hash-offset="95" href="#solutions">Solutions</a>
								</li>
								<li class="mb-1">
									<a class="link-hover-style-1" data-hash data-hash-offset="95" href="#pricing">Pricing</a>
								</li>
								<li class="mb-1">
									<a class="link-hover-style-1" data-hash data-hash-offset="95" href="#reviews">Reviews</a>
								</li>
								<li class="mb-1">
									<a class="link-hover-style-1" data-hash data-hash-offset="95" href="#news">News</a>
								</li>
							</ul>
						</div>
						<div class="col-lg-4">
