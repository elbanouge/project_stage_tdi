		...
		<div class="owl-carousel owl-theme" data-plugin-options="{'items': 1, 'margin': 10, 'animateOut': 'fadeOut', 'autoplay': true, 'autoplayTimeout': 3000}">
			<div>
				<span class="img-thumbnail d-block no-borders">
					<img alt="" class="img-fluid" src="{{asset('porto/img/demos/medical/doctors/doctor-1.jpg')}}">
				</span>
			</div>
			<div>
				<span class="img-thumbnail d-block no-borders">
					<img alt="" class="img-fluid" src="{{asset('porto/img/demos/medical/doctors/doctor-1-2.jpg')}}">
				</span>
			</div>
		</div>
