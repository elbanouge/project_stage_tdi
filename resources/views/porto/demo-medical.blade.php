 ...
 <div role="main" class="main">
			<div class="owl-carousel owl-carousel-light owl-carousel-light-init-fadeIn owl-theme manual dots-inside dots-vertical-center dots-align-right dots-orientation-portrait custom-dots-style-1 show-dots-hover show-dots-xs nav-style-1 nav-inside nav-inside-plus nav-dark nav-lg nav-font-size-lg show-nav-hover mb-0" data-plugin-options="{'autoplayTimeout': 7000}" data-dynamic-height="['650px','650px','650px','550px','500px']" style="height: 650px;">
				<div class="owl-stage-outer">
					<div class="owl-stage">
						...
						<!-- Carousel Slide 1 -->
						<div class="owl-item position-relative overlay overlay-show overlay-op-3" style="background-image: url(img/demos/medical/slides/slide-medical-1.jpg); background-size: cover; background-position: center;">
						...
						<!-- Carousel Slide 2 -->
						<div class="owl-item position-relative overlay overlay-show overlay-op-3" style="background-image: url(img/demos/medical/slides/slide-medical-2.jpg); background-size: cover; background-position: center;">
							<div class="container position-relative z-index-3 h-100">
								<div class="row align-items-center h-100">
									<div class="col pb-4">
			...
			<section class="section-custom-medical">
				<div class="container">
						...
						<div class="col-xl-3 box-one bg-color-primary appear-animation" data-appear-animation="fadeInLeft" data-appear-animation-delay="0">
							<div class="feature-box feature-box-style-2 align-items-center p-4">
								<div class="feature-box-icon p-0">
									<img src="{{asset('porto/img/demos/medical/icons/medical-icon-heart.png')}}" alt class="img-fluid pt-1" />
								</div>
					...
					<div class="row mt-5 mb-5 pt-3 pb-3">
						...
						<div class="col-md-4">
							<img src="{{asset('porto/img/demos/medical/gallery/gallery-1.jpg')}}" alt class="img-fluid box-shadow-custom" /> 
						</div>
					</div>
				</div>
			</section>
				...
				<div class="container">
					...
					<div class="row mt-4">
						...
						<div class="col-lg-4">
							<div class="feature-box feature-box-style-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
								<div class="feature-box-icon" style="min-width: 4.7rem;">
									<img src="{{asset('porto/img/demos/medical/icons/department-icon-gastroenterology.png')}}" alt class="img-fluid" />
								</div>
								<div class="feature-box-info">
						...
						<div class="col-lg-4">
							<div class="feature-box feature-box-style-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
								<div class="feature-box-icon" style="min-width: 4.7rem;">
									<img src="{{asset('porto/img/demos/medical/icons/department-icon-pulmonology.png')}}" alt class="img-fluid" />
								</div>
								<div class="feature-box-info">
					...
					<div class="row mt-lg-4">
						<div class="col-lg-4">
							<div class="feature-box feature-box-style-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
								<div class="feature-box-icon" style="min-width: 4.7rem;">
									<img src="{{asset('porto/img/demos/medical/icons/department-icon-dental.png')}}" alt class="img-fluid" />
								</div>
								<div class="feature-box-info">
						...
						<div class="col-lg-4">
							<div class="feature-box feature-box-style-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
								<div class="feature-box-icon" style="min-width: 4.7rem;">
									<img src="{{asset('porto/img/demos/medical/icons/department-icon-gynecology.png')}}" alt class="img-fluid" />
								</div>
								<div class="feature-box-info">
						...
						<div class="col-lg-4">
							<div class="feature-box feature-box-style-2 appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="300">
								<div class="feature-box-icon" style="min-width: 4.7rem;">
									<img src="{{asset('porto/img/demos/medical/icons/department-icon-hepatology.png')}}" alt class="img-fluid" />
								</div>
								<div class="feature-box-info">
			...
			<section class="team pb-2">
				<div class="container">
					...
					<div class="row pb-4">
						<div class="owl-carousel owl-theme nav-bottom rounded-nav show-nav-title pl-1 pr-1" data-plugin-options="{'items': 4, 'loop': false, 'dots': false, 'nav': true}">
							<div class="pr-3 pl-3">
							...
							<div class="content-grid">
								<div class="row content-grid-row pl-3 pr-3">
									<div class="content-grid-item col-md-4 col-lg-2 text-center">
										<img src="{{asset('porto/img/demos/medical/logos/insurance-logo-1.png')}}" alt class="img-fluid" />
									</div>
									<div class="content-grid-item col-md-4 col-lg-2 text-center">
										<img src="{{asset('porto/img/demos/medical/logos/insurance-logo-2.png')}}" alt class="img-fluid" />
									</div>
									<div class="content-grid-item col-md-4 col-lg-2 text-center">
										<img src="{{asset('porto/img/demos/medical/logos/insurance-logo-3.png')}}" alt class="img-fluid" />
									</div>
									<div class="content-grid-item col-md-4 col-lg-2 text-center">
										<img src="{{asset('porto/img/demos/medical/logos/insurance-logo-4.png')}}" alt class="img-fluid" />
									</div>
									<div class="content-grid-item col-md-4 col-lg-2 text-center">
										<img src="{{asset('porto/img/demos/medical/logos/insurance-logo-5.png')}}" alt class="img-fluid" />
									</div>
									<div class="content-grid-item col-md-4 col-lg-2 text-center">
										<img src="{{asset('porto/img/demos/medical/logos/insurance-logo-6.png')}}" alt class="img-fluid" />
									</div>
								</div>
							</div>
						</div>
