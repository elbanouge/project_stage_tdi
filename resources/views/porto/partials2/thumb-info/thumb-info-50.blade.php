<article class="thumb-info custom-thumb-info custom-box-shadow">
									...
									<span class="thumb-info-caption">
										<span class="custom-thumb-info-wrapper-box text-center justify-content-center d-flex mb-4">
											<div class="countdown custom-newcomers-class custom-secondary-font custom-box-shadow font-weight-bold text-color-dark clock-one-events" data-plugin-countdown data-plugin-options="{'date': '2022/01/01 12:00:00', 'numberClass': 'font-weight-bold text-color-primary', 'wrapperClass': 'text-color-dark', 'textDay': 'Day', 'textHour': 'Hrs', 'textMin': 'Min', 'textSec': 'Sec', 'uppercase': false}"></div>
										</span>
