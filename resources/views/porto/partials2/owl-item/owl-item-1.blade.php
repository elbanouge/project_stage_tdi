<div class="owl-item position-relative overflow-hidden">
								...
								<div class="container position-relative z-index-3 pb-5 h-100">
									<div class="row align-items-center justify-content-center justify-content-lg-end pb-5 h-100">
										<div class="col-sm-9 col-lg-7 text-center text-lg-left pb-5 mb-5">
											...
											<h2 class="text-color-secondary font-weight-extra-bold text-10 line-height-2 pr-lg-5 mr-lg-5 mb-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750" data-plugin-options="{'minWindowWidth': 0}">You Success is Our Main Business!</h2>
