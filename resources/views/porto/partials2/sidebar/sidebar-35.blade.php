<aside class="sidebar" id="sidebar" data-plugin-sticky data-plugin-options="{'minWidth': 991, 'containerSelector': '.row', 'padding': {'top': 10 }}">

								<div class="portfolio-info">
									<ul>
										<li>
											<i class="fas fa-tags"></i> <a href="#">Family</a>, <a href="#">Wedding</a>
										</li>
									</ul>
								</div>
								<p class="lead">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tempus nibh sed elimttis adipiscing. Fusce in hendrerit purus. Suspendisse potenti. Proin quis eros odio, dapibus dictum mauris.</p>
