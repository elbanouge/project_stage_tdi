@extends('porto.app')
@section('header')
@include('porto.partials.header.header-272')
@endsection
				...
				<div class="container mb-5 pb-4">
					...
					<div class="row pb-3">
						<div class="col-lg-8">
							...
							<div class="row">
								<div class="col-sm-6">
									@include('porto.partials.feature-box.feature-box-226')
									@include('porto.partials.feature-box.feature-box-227')
									@include('porto.partials.feature-box.feature-box-228')
									@include('porto.partials.feature-box.feature-box-229')
								</div>
								<div class="col-sm-6">
									@include('porto.partials.feature-box.feature-box-230')
									@include('porto.partials.feature-box.feature-box-231')
									@include('porto.partials.feature-box.feature-box-232')
									@include('porto.partials.feature-box.feature-box-233')
								</div>
							</div>
						</div>
						<div class="col-lg-4">
								...
								<div class="card card-default">
									...
									<div id="collapseOne" class="collapse show">
										<div class="card-body text-2">
											...
											<p class="mb-0">Adipiscing elit phasellus blanit ma... <a href="#" class="d-block text-color-dark font-weight-semibold pt-4">read more <i class="fas fa-angle-left position-relative top-1 mr-1"></i></a></p>
										</div>
									</div>
								</div>
								<div class="card card-default">
							...
							<div class="row mt-5 appear-animation" data-appear-animation="fadeInUpShorter">
								<div class="col-lg-6">
									<div class="recent-posts mb-5">
										...
										@include('porto.partials.owl-carousel.owl-carousel-250')
									</div>
								</div>
								<div class="col-lg-6">
									<h2 class="font-weight-normal text-6 mb-4"><strong class="font-weight-extra-bold">What</strong> Client’s Say</h2>
									<div class="row">
										@include('porto.partials.owl-carousel.owl-carousel-251')
									</div>
								</div>
							</div>
						</div>
...
<footer id="footer">
				<div class="container">
					...
					<div class="row py-5 my-4">
						<div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
							...
							<p class="pl-1">Keep up on our always evolving product features and technology. Enter your e-mail address and subscribe to our newsletter.</p>
							<div class="alert alert-success d-none" id="newsletterSuccess">
								<strong>Success!</strong> You've been added to our email list.
							</div>
							<div class="alert alert-danger d-none" id="newsletterError"></div>
							<form id="newsletterForm" action="php/newsletter-subscribe.php" method="POST" class="ml-4 mb-3 mb-md-0">
						...
						<div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
							...
							<div id="tweet" class="twitter mb-3" data-plugin-tweets data-plugin-options="{'username': 'oklerthemes', 'count': 2}">
								<p>Please wait...</p>
							</div>
						</div>
				...
				@include('porto.partials.footer-copyright.footer-copyright-65', ['key' => 'footer-copyright.footer-copyright-65'])
			</footer>
@endsection
