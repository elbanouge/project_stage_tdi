						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Word Rotator</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Word Rotator</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">With the word rotator plugin you can rotate how much words you want in a simple and beautiful way.</p>
						...
						<div class="col">
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">Rotate</h4>
										<p class="m-0">This is the default word rotator animation.</p>
									</div>
								...
								<div class="col-sm-9">
									...
									<h2 class="word-rotator rotate-1 mb-2">
										<span>Porto is </span>
										<span class="word-rotator-words">
											<b class="is-visible text-color-primary">incredibly</b>
											<b class="text-color-primary">especially</b>
											<b class="text-color-primary">extremely</b>
										</span>
										<span> beautiful.</span>
									</h2>
									<h2 class="word-rotator rotate-1 mb-2">
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">Typewriter</h4>
										<p class="m-0">This is the typewriter word rotator animation.</p>
									</div>

								</div>
								<div class="col-sm-9">

									<h2 class="word-rotator letters type mb-2">
										<span>Porto is </span> 
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">Rotate 2</h4>
										<p class="m-0">This is the default rotate 2 animation.</p>
									</div>
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">Loading Bar</h4>
										<p class="m-0">This is the loading bar word rotator animation.</p>
									</div>

								</div>
								<div class="col-sm-9">

									<h2 class="word-rotator loading-bar mb-2">
										<span>Porto is </span>
										<span class="word-rotator-words">
											<b class="is-visible">incredibly</b>
											<b>especially</b>
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">Slide</h4>
										<p class="m-0">This is the slide word rotator animation.</p>
									</div>

								</div>
								<div class="col-sm-9">

									<h2 class="word-rotator slide mb-2">
										<span>Porto is </span>
										<span class="word-rotator-words">
											<b class="is-visible">incredibly</b>
											<b>especially</b>
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">Clip</h4>
										<p class="m-0">This is the clip word rotator animation.</p>
									</div>
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">Zoom</h4>
										<p class="m-0">This is the zoom word rotator animation.</p>
									</div>
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">Rotate 3</h4>
										<p class="m-0">This is the rotate 3 word rotator animation.</p>
									</div>
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">Scale</h4>
										<p class="m-0">This is the scale word rotator animation.</p>
									</div>
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">Push</h4>
										<p class="m-0">This is the push word rotator animation.</p>
									</div>
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										...
										<p class="m-0">These are the colors available for the word rotator animation.</p>
									</div>
								...
								<div class="col-sm-9">
									...
									<h2 class="word-rotator slide mb-2">
										<span>Porto is </span>
										<span class="word-rotator-words bg-tertiary">
											<b class="is-visible">incredibly</b>
											<b>especially</b>
											<b>extremely</b>
										</span>
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										...
										<p class="m-0">Word Rotator can be used in paragraph content.</p>
									</div>

								</div>
								<div class="col-sm-9">

									<p>Pellentesque pellentesque eget tempor tellus. Fusce <span class="word-rotator slide mb-2">
										<span>Porto is </span>
										<span class="word-rotator-words bg-primary">
											<b class="is-visible">incredibly</b>
											<b>especially</b>
										...
										<span> beautiful.</span>
									</span> lacllentesque eget tempor tellus ellentesque pelleinia tempor malesuada. Pellentesque pellentesque eget tempor tellus ellentesque pellentesque eget tempor tellus. Fusce lacinia tempor malesuada.</p>
