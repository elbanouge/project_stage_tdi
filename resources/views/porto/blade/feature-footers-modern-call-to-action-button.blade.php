				...
				<div class="container my-4">
					<div class="row py-5">
						<div class="col-lg-5 mb-5 mb-lg-0 text-center text-lg-left pt-3">
							<h5 class="text-5 text-transform-none font-weight-semibold text-color-light mb-4">Porto Template - Best HTML Template</h5>
							<a href="http://themeforest.net/item/porto-responsive-html5-template/4106987" target="_blank" class="btn btn-primary btn-rounded px-5 py-3 font-weight-semibold text-color-light mt-2 ml-2">PURCHASE PORTO</a>
						</div>
						<div class="col-lg-4 mb-4 mb-md-0 text-center text-lg-left pt-3">
							<h5 class="text-5 text-transform-none font-weight-semibold text-color-light mb-4">Contact Us</h5>
							<p class="text-4 mb-3"><span class="text-color-light">Address:</span> 1234 Street Name, City Name, USA</p>
							<p class="text-4 mb-3"><span class="text-color-light">Phone:</span> (123) 456-7890</p>
							<p class="text-4 mb-3"><span class="text-color-light">Email:</span> <a href="mailto:mail@example.com">mail@example.com</a></p>
						</div>
