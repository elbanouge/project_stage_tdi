...
<div role="main" class="main">
						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Call to Action</li>
								</ul>
				...
				<div id="examples" class="container py-2">
					...
					<div class="row">
						<div class="col">
							<h4>Default</h4>
							@include('porto.partials.call-to-action.call-to-action-4')

							<hr class="solid my-5">

							<h4>Borders</h4>
							@include('porto.partials.call-to-action.call-to-action-5')

							@include('porto.partials.call-to-action.call-to-action-6')

							<hr class="solid my-5">

							<h4>Featured</h4>
							@include('porto.partials.call-to-action.call-to-action-7')

							@include('porto.partials.call-to-action.call-to-action-8')

							@include('porto.partials.call-to-action.call-to-action-9')

							@include('porto.partials.call-to-action.call-to-action-10')

							<hr class="solid my-5">

							<h4>Colors</h4>
							@include('porto.partials.call-to-action.call-to-action-11')

							@include('porto.partials.call-to-action.call-to-action-12')

							@include('porto.partials.call-to-action.call-to-action-13')

							@include('porto.partials.call-to-action.call-to-action-14')

							@include('porto.partials.call-to-action.call-to-action-15')

							<hr class="solid my-5">

							<h4>With Arrow</h4>
							@include('porto.partials.call-to-action.call-to-action-16')

							<hr class="solid my-5">

							<h4>Animated</h4>
							@include('porto.partials.call-to-action.call-to-action-17')

							<hr class="solid my-5">

							<h4>Button Centered</h4>
							@include('porto.partials.call-to-action.call-to-action-18')
							...
							<div class="row">
								<div class="col-lg-4">
									@include('porto.partials.call-to-action.call-to-action-19')
								</div>
								<div class="col-lg-4">
									@include('porto.partials.call-to-action.call-to-action-20')
								</div>
								<div class="col-lg-4">
									@include('porto.partials.call-to-action.call-to-action-21')
								</div>
							</div>
				...
				@include('porto.partials.call-to-action.call-to-action-22')

				@include('porto.partials.call-to-action.call-to-action-23')

				@include('porto.partials.call-to-action.call-to-action-24')

				@include('porto.partials.call-to-action.call-to-action-25')
				...
				<section class="parallax section section-text-light section-parallax" data-plugin-parallax data-plugin-options="{'speed': 1.5, 'parallaxHeight': '210%'}" data-image-src="img/parallax/parallax-2.jpg">
					@include('porto.partials.call-to-action.call-to-action-26')
				</section>
				...
				@include('porto.partials.call-to-action.call-to-action-27')
