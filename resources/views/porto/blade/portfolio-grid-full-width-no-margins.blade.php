...
<div role="main" porto.partials
				...
				@include('porto.partials.page-header.page-header-290')
porto.partials
				<div class="container py-2">

					<ul class="nporto.partialsurce sort-source-style-3 justify-content-center" data-sort-id="portfolio" data-option-key="filter" data-plugin-options="{'layoutMode': 'fitRows', 'filter': '*'}">
				...
				<div class="sort-destination-loader sort-destination-loader-showing mt-4 pt-2">
					<div class="row portfolio-list sort-destination" data-sort-id="portfolio">
						...
						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 brands">
							@include('porto.partials.portfolio-item.portfolio-item-267')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 medias">
							@include('porto.partials.portfolio-item.portfolio-item-268')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 logos">
							@include('porto.partials.portfolio-item.portfolio-item-269')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 websites">
							@include('porto.partials.portfolio-item.portfolio-item-270')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 logos">
							@include('porto.partials.portfolio-item.portfolio-item-271')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 brands">
							@include('porto.partials.portfolio-item.portfolio-item-272')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 websites">
							@include('porto.partials.portfolio-item.portfolio-item-273')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 medias">
							@include('porto.partials.portfolio-item.portfolio-item-274')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 logos">
							@include('porto.partials.portfolio-item.portfolio-item-275')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 websites">
							@include('porto.partials.portfolio-item.portfolio-item-276')
						</div>
