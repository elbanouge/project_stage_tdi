...
<div role="main" class="main">
						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Headings</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Headings</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">The template comes with a well organized typography structure for headings.</p>
				...
				<div id="examples" class="container py-2">
					...
					<div class="row">
						<div class="col-lg-3">
							<h1 class="font-weight-normal">Heading <strong class="font-weight-extra-bold">H1</strong></h1>
							<h2 class="font-weight-normal">Heading <strong class="font-weight-extra-bold">H2</strong></h2>
							<h3 class="font-weight-normal">Heading <strong class="font-weight-extra-bold">H3</strong></h3>
							<h4>Heading <strong>H4</strong></h4>
							<h5>Heading <strong>H5</strong></h5>
							<h6>Heading <strong>H6</strong></h6>
						</div>
						<div class="col-lg-3">
							<h1 class="text-uppercase font-weight-normal">Heading <strong class="font-weight-extra-bold">H1</strong></h1>
							<h2 class="text-uppercase font-weight-normal">Heading <strong class="font-weight-extra-bold">H2</strong></h2>
							<h3 class="text-uppercase font-weight-normal">Heading <strong class="font-weight-extra-bold">H3</strong></h3>
					...
					<div class="row mt-5 text-center">
						...
						<div class="col-lg-2">
							<h1 class="text-secondary">H1</h1>
							<h2 class="text-secondary">H2</h2>
							<h3 class="text-secondary">H3</h3>
							<h4 class="text-secondary">H4</h4>
							<h5 class="text-secondary">H5</h5>
							<h6 class="text-secondary">H6</h6>
						</div>
						<div class="col-lg-2">
							<h1 class="text-tertiary">H1</h1>
							<h2 class="text-tertiary">H2</h2>
							<h3 class="text-tertiary">H3</h3>
							<h4 class="text-tertiary">H4</h4>
							<h5 class="text-tertiary">H5</h5>
							<h6 class="text-tertiary">H6</h6>
						</div>
						<div class="col-lg-2">
							<h1 class="text-quaternary">H1</h1>
							<h2 class="text-quaternary">H2</h2>
							<h3 class="text-quaternary">H3</h3>
							<h4 class="text-quaternary">H4</h4>
							<h5 class="text-quaternary">H5</h5>
							<h6 class="text-quaternary">H6</h6>
						</div>
						<div class="col-lg-2">
							<h1 class="text-light bg-color-primary">H1</h1>
							<h2 class="text-light bg-color-primary">H2</h2>
							<h3 class="text-light bg-color-primary">H3</h3>
							<h4 class="text-light bg-color-primary">H4</h4>
							<h5 class="text-light bg-color-primary">H5</h5>
							<h6 class="text-light bg-color-primary">H6</h6>
						</div>
					</div>
					<div class="row mt-5">
						<div class="col-lg-3">
							<div class="heading text-primary heading-border heading-bottom-border">
								<h1>Heading <strong class="font-weight-extra-bold">H1</strong></h1>
							</div>
						</div>
						<div class="col-lg-3">
						...
						<div class="col-lg-3">
							<div class="heading text-quaternary heading-border heading-bottom-border">
								<h1>Heading <strong class="font-weight-extra-bold">H1</strong></h1>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-3">
							<div class="heading text-primary heading-border heading-bottom-border">
								<h1 class="text-primary">Heading <strong class="font-weight-extra-bold">H1</strong></h1>
							</div>
						</div>
						<div class="col-lg-3">
							<div class="heading text-secondary heading-border heading-bottom-border">
								<h1 class="text-secondary">Heading <strong class="font-weight-extra-bold">H1</strong></h1>
							</div>
						</div>
						<div class="col-lg-3">
							<div class="heading text-tertiary heading-border heading-bottom-border">
								<h1 class="text-tertiary">Heading <strong class="font-weight-extra-bold">H1</strong></h1>
							</div>
						</div>
						<div class="col-lg-3">
							<div class="heading text-quaternary heading-border heading-bottom-border">
								<h1 class="text-quaternary">Heading <strong class="font-weight-extra-bold">H1</strong></h1>
							</div>
						</div>
					</div>
					<div class="row mt-5">
					...
					<div class="row mt-5">
						<div class="col">
							<h1 class="mb-0 font-weight-normal">Heading <strong class="font-weight-extra-bold">H1</strong></h1>
							<p class="mb-5">Sub-title pellentesque pellentesque tempor tellus eget fermentum. usce lacllentesque eget tempor tellus ellentesque pelleinia tempor malesuada.</p>

							<h2 class="mb-0 font-weight-normal">Heading <strong class="font-weight-extra-bold">H2</strong></h2>
							<p class="mb-5">Sub-title pellentesque pellentesque tempor tellus eget fermentum. usce lacllentesque eget tempor tellus ellentesque pelleinia tempor malesuada.</p>

							<h3 class="mb-0 font-weight-normal">Heading <strong class="font-weight-extra-bold">H3</strong></h3>
							<p class="mb-5">Sub-title pellentesque pellentesque tempor tellus eget fermentum. usce lacllentesque eget tempor tellus ellentesque pelleinia tempor malesuada.</p>

							<h4 class="mb-0">Heading <strong>H4</strong></h4>
							<p class="mb-5">Sub-title pellentesque pellentesque tempor tellus eget fermentum. usce lacllentesque eget tempor tellus ellentesque pelleinia tempor malesuada.</p>

							<h5 class="mb-0">Heading <strong>H5</strong></h5>
							<p class="mb-4">Sub-title pellentesque pellentesque tempor tellus eget fermentum. usce lacllentesque eget tempor tellus ellentesque pelleinia tempor malesuada.</p>
