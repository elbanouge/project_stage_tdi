...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-88')

				<div class="container">
					<div class="row pt-1 pb-4 mb-3">
						<div class="col">

							@include('porto.partials.nav-pills.nav-pills-3')
								...
								<div class="row portfolio-list sort-destination" data-sort-id="portfolio">
									<div class="col-lg-4 isotope-item economic">
										<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
											@include('porto.partials.thumb-info.thumb-info-16')
										</a>
									</div>
									<div class="col-lg-4 isotope-item economic">
										<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
											@include('porto.partials.thumb-info.thumb-info-17')
										</a>
									</div>
									<div class="col-lg-4 isotope-item strategic">
										<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
											@include('porto.partials.thumb-info.thumb-info-18')
										</a>
									</div>
									<div class="col-lg-4 isotope-item tech">
										<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
											@include('porto.partials.thumb-info.thumb-info-19')
										</a>
									</div>
									<div class="col-lg-4 isotope-item economic">
										<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
											@include('porto.partials.thumb-info.thumb-info-20')
										</a>
									</div>
									<div class="col-lg-4 isotope-item strategic">
										<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
											@include('porto.partials.thumb-info.thumb-info-21')
										</a>
									</div>
									<div class="col-lg-4 isotope-item economic">
										<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
											@include('porto.partials.thumb-info.thumb-info-22')
										</a>
									</div>
									<div class="col-lg-4 isotope-item tech">
										<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
											@include('porto.partials.thumb-info.thumb-info-23')
										</a>
									</div>
									<div class="col-lg-4 isotope-item economic">
										<a href="demo-business-consulting-cases-detail.html" class="text-decoration-none">
											@include('porto.partials.thumb-info.thumb-info-24')
										</a>
									</div>
								</div>
							</div>
