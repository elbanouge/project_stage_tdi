...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-262')
...
porto.partials
					<div class="row pt-2">
						...
						<div class="col-lg-6">
							...
							<h2 class="font-weight-normal text-7 mb-2"><strong class="font-weight-extra-bold">Left and Right</strong> Sidebar Page</h2>
...
porto.partials
						...
						<div class="col-lg-3 mt-4 mt-lg-0">
							@include('porto.partials.sidebar.sidebar-57')
						</div>
