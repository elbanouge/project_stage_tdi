...
<div role="main" class="main">
						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Sticky Elements</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Sticky Elements</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">With the sticky plugin you can have fixed elements in the browser window view.</p>
				...
				<div id="examporto.partialser py-2">
					...
					<div class="row">
						<div class="col-lg-3">
							@include('porto.partials.sidebar.sidebar-54')
						</div>
						<div class="col-lg-9">

							<h2 class="font-weight-normal text-7 mb-2"><strong class="font-weight-extra-bold">Sticky</strong> Elements Page</h2>
								...
								<div class="row">
									...
									<div class="col-lg-4">
										<div class="text-center" data-plugin-sticky data-plugin-options="{'minWidth': 991, 'containerSelector': '.sticky-container', 'padding': {'top': 110}}">
											<img class="float-right img-fluid" width="300" height="211" src="img/device.png" alt="">
