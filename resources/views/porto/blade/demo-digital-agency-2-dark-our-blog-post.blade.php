@extends('porto.app')
@section('header')
@include('porto.partials.header.header-77')
@endsection

@section('main')
<div role="main" class="main">

				@include('porto.partials.page-header.page-header-122')
								...
								<div class="container py-5 p-relative z-index-2">
									<div class="row">
										<div class="col-lg-9 pb-5">
											<article>
												...
												<div class="post-block post-author">
													<h3 class="text-color-light text-capitalize font-weight-bold text-5 m-0 mb-3">Author</h3>
												...
												<div id="comments" class="post-block post-comments">
													<h3 class="text-color-light text-capitalize font-weight-bold text-5 m-0 mb-3">3 comments for "An Interview with John Doe"</h3>
													...
													<h3 class="text-color-light text-capitalize font-weight-bold text-5 m-0 mb-3 mt-5">Leave a Reply</h3>

													<form class="contact-form p-0" action="php/contact-form.php" method="POST">			
														<div class="p-2">
															<div class="form-row">
																<div class="form-group col-lg-6">
																	<label class="required mb-1 font-weight-bold text-light">Full Name</label>
																	<input type="text" value="" data-msg-required="Please enter your name." maxlength="100" class="form-control text-color-light bg-color-secondary py-4 px-3 border-0 box-shadow-none" name="name" id="name" required>
																</div>
																<div class="form-group col-lg-6">
																	<label class="required mb-1 font-weight-bold text-light">Email Address</label>
																	<input type="email" value="" data-msg-required="Please enter your email address." data-msg-email="Please enter a valid email address." maxlength="100" class="form-control text-color-light bg-color-secondary py-4 px-3 border-0 box-shadow-none" name="email" id="email" required>
																</div>
															</div>
															<div class="form-row">
																<div class="form-group col">
																	<label class="required mb-1 font-weight-bold text-light">Comment</label>
																	<textarea maxlength="5000" data-msg-required="Please enter your message." rows="8" class="form-control text-color-light bg-color-secondary px-3 border-0 box-shadow-none" name="message" id="message" required></textarea>
																</div>
															</div>
															<div class="form-row">
																<div class="form-group col mb-0">
																	<input type="submit" value="Post Comment" class="btn btn-outline custom-btn-outline btn-primary rounded-0 text-color-light custom-text-4 bg-color-hover-transparent text-color-hover-light font-weight-semibold custom-btn-with-arrow px-4 py-3" data-loading-text="Loading...">
																</div>
															</div>
														</div>
													</form>
										...
										<div class="col-lg-3 pt-4 pt-lg-0">
											@include('porto.partials.sidebar.sidebar-14')
										</div>
									</div>
								</div>
