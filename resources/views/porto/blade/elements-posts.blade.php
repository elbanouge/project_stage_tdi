						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Posts</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Posts</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">Create a blog post page will not be a problem using Porto. Start with these ready styles below.</p>
...
porto.partials
							<div class="row">
								<div class="col-lg-4 mb-4 mb-lg-0">
									<div class="recent-posts">
										@include('porto.partials.post.post-139')
									</div>porto.partials
								</div>
								<div class="col-lg-4 mb-4 mb-lg-0">
									<div class="recent-posts">
										@include('porto.partials.post.post-140')
									</div>porto.partials
								</div>
								<div class="col-lg-4">
									<div class="recent-posts">
										@include('porto.partials.post.post-141')
									</div>
								</div>
							</div>
							<div class="row mt-5">
								<div class="col">
									...
									<hr class="soporto.partials
									<div class="row">
										<div class="col-lg-4 mb-4 mb-lg-0">
											<div class="recent-posts">
												@include(porto.partialss.post.post-142')
											</div>
										</div>
										<div class="col-lg-4 mb-4 mb-lg-0">
											@include('pporto.partialspost.post-143')
										</div>
										<div class="col-lg-4">
											<div class="recent-posts">
												@include('porto.partials.post.post-144')
											</div>
										</div>
									</div>
								</div>
							...
							<div class="row mt-5 pb-4">
								<div class="col">
									<h4>Carousel porto.partials
									@include('porto.partials.owl-carousel.owl-carousel-179')
								</div>
							</div>

							<div class="row mt-5">
								<div class="col">
									<h4>Posts Wiporto.partials
									<hr class="solid mt-3">
									<div class="row">
										<div class=porto.partials
											@include('porto.partials.post.post-152')
										</div>
										<div class=porto.partials
											@include('porto.partials.post.post-153')
										</div>
										<div class=porto.partials
											@include('porto.partials.post.post-154')
										</div>
										<div class=porto.partials-0">
											@include('porto.partials.post.post-155')
										</div>
										<div class=porto.partials-0">
											@include('porto.partials.post.post-156')
										</div>
										<div class="col-lg-4">
											@include('porto.partials.post.post-157')
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row mt-5 pt-4">
								<div class="col-lg-6 mb-5 mb-lg-0">
									...
									<div class="row">
										<div class="col">
											@include('porto.partials.post.post-158')
										</div>
									</div>
								</div>
								<div class="col-lg-6 mb-5 mb-lg-0">
									...
									<div class="row">
										<div class="col">
											@include('porto.partials.post.post-159')
										</div>
									</div>
								</div>
							</div>
