@extends('porto.app')
@section('header')
@include('porto.partials.header.header-191')
@endsection
...
<div role="main" class="main">
					...
					<div class="container position-relative z-index-1 pt-5 mt-5">
						...
						<div class="row align-items-center pt-4">
							...
							<div class="col-md-6 pb-5">
								<img src="img/demos/seo-2/concept-1.png" class="img-fluid position-relative z-index-1 pb-5 mb-5 ml-5 top-10 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="750" data-appear-animation-duration="1500ms" alt="Demo SEO 2">
							</div>
						</div>
					</div>
				</section>
					...
					<div class="container position-relative z-index-1 mt-3 mb-5">
						...
						<div class="row">
							<div class="col-lg-6 mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="450">
								...
								@include('porto.partials.feature-box.feature-box-142')
								@include('porto.partials.feature-box.feature-box-143')
							</div>
				...
				<div class="container position-relative pb-lg-5 mb-5">
					...
					<div class="row py-5 mt-5 mb-lg-3">
						<div class="col-lg-6 mb-5 mb-lg-0">
							...
							<div class="custom-circles-group-1 counters pr-5 mr-5">
								...
								<div class=porto.partialsm-circle-extra-small custom-circle-pos-40 custom-bg-color-grey-2"></div>
								<div class="circle-1 bg-color-secondary">
									@include('porto.partials.counter.counter-76')
								</div>porto.partials
								<div class="circle-2 bg-color-tertiary">
									@include('porto.partials.counter.counter-77')
								</div>porto.partials
								<div class="circle-3 bg-color-quaternary">
									@include('porto.partials.counter.counter-78')
								</div>
							</div>
						...
						<div class="col-lg-6">
							...
							<div class="progress-bars custom-progress-bars-style-1 mt-4">
								...
								@include('porto.partials.progress.progress-33')
								<div class="progress-label">
									<span class="d-block text-3 mb-1">Average Improvements</span>
								</div>
								@include('porto.partials.progress.progress-34')
								<div class="progress-label">
									<span class="d-block text-3 mb-1">Customer Approval</span>
								</div>
								@include('porto.partials.progress.progress-35')
							</div>
						</div>
					</div>
					<div class="row">
					...
					<div class="row mt-5 mb-5">
						...
						<div class="col-lg-8 pl-lg-4">
							<div class="porto.partialscarousel-style-1 custom-carousel-dots-style-1" data-plugin-options="{'responsive': {'0': {'items': 1}, '479': {'items': 1}, '979': {'items': 2}, '1199': {'items': 2}}, 'margin': 0, 'loop': true, 'dots': true, 'nav': false, 'autoplay': true}">
								<div>
									@include('porto.partials.testimonial.testimonial-79')
								</div>porto.partials
								<div>
									@include('porto.partials.testimonial.testimonial-80')
								</div>porto.partials
								<div>
									@include('porto.partials.testimonial.testimonial-81')
								</div>porto.partials
								<div>
									@include('porto.partials.testimonial.testimonial-82')
								</div>
							</div>
						</div>
					</div>
				...
				<section class="section position-relative custom-bg-color-light-2 border-0 pt-4 m-0">
					...
					<div class="container position-relative z-index-1 pb-lg-4 mb-lg-5">
						...
						@include('porto.partials.pricing-table.pricing-table-1')
					</div>
				</section>
