...
<div role="main" class="main">
						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Process</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Process</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">With process feature you can display your step content in a modern and intuitive way.</p>
				...
				<div id="examples" class="container py-2">
					...
					<div class="row">
						<div class="col">
							<h4 class="mb-2">4 Steps</h4>

							@include('porto.partials.process.process-7')
					...
					<div class="row mt-5">
						<div class="col">
							<h4 class="mb-2">3 Steps</h4>

							@include('porto.partials.process.process-8')
					...
					<div class="row">
						<div class="col">
							<h4 class="mb-2">2 Steps</h4>

							@include('porto.partials.process.process-9')
					...
					<div class="container">
						<div class="row">
							<div class="col mt-5 mb-2">
								...
								@include('porto.partials.process.process-10')
				...
				<div class="container pt-4">
					...
					<div class="row mt-5">
						<div class="col">
							<h4 class="mb-2">Shapes</h4>

							@include('porto.partials.process.process-11')
					...
					<div class="row mt-5">
						<div class="col">
							<h4 class="mb-2">Shapes Hover Animate</h4>

							@include('porto.partials.process.process-12')
					...
					<div class="row mt-5">
						<div class="col">
							<h4 class="mb-2">Shapes Always Animate</h4>

							@include('porto.partials.process.process-13')
					...
					<div class="row">
						<div class="col">
							...
							@include('porto.partials.process.process-14')
					...
					<div class="row">
						<div class="col">
							...
							@include('porto.partials.process.process-15')
