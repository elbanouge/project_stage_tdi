@extends('porto.app')
@section('header')
@include('porto.partials.header.header-242')
@endsection

@section('main')
<div role="main" class="main">
				<section class="section border-0 m-0" style="background-image: url(img/slides/slide-corporate-3-1.jpg); background-size: cover; background-position: center; height: 100vh;">
