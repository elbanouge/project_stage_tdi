...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-15')
					...
					<div class="row">
						<div class="col-lg-9">
							<div class="blog-posts">
								...
								@include('porto.partials.post.post-57')

								@include('porto.partials.post.post-58')

								@include('porto.partials.post.post-59')

								@include('porto.partials.post.post-60')

								@include('porto.partials.post.post-61')
