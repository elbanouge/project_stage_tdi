						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Image Frames</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Image Frames</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">Tons of ready image frame styles gives to your website infinite ways to show images.</p>
						...
						<div class="col">
							...
							<div class="row">
								<div class="col">
									...
									<p>By default, thumbnails are designed to showcase linked images with minimal required markup.</p>

									<div class="row">
										<div class="col-lg-3">
											<img class="img-fluid rounded mb-4" src="img/blog/square/blog-1.jpg" alt="Project Image">
										</div>
										<div class="col-lg-3">
											<img class="img-fluid mb-4 border-radius-0" src="img/blog/square/blog-2.jpg" alt="Project Image">
										</div>
										<div class="col-lg-3">
											<img class="img-fluid rounded-circle mb-4" src="img/blog/square/blog-25.jpg" alt="Project Image">
										</div>
										<div class="col-lg-3">
											<span class="img-thumbnail d-block">
												<img class="img-fluid" src="img/blog/square/blog-4.jpg" alt="Project Image">
											</span>
										</div>
									</div>
							...
							<div class="row">
								<div class="col">
									...
									<h4 class="mb-0">Hover Styles</h4>
									<p>The thumbnail details can be displayed in different styles.</p>

									<div class="rporto.partials
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Default</h5>
											<a href="portfolio-single-wide-slider.html">
												@include('porto.partials.thumb-info.thumb-info-397')
											</a>
										</div>porto.partials
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Default Lighten</h5>
											<a href="portfolio-single-wide-slider.html">
												@include('porto.partials.thumb-info.thumb-info-398')
											</a>
										</div>porto.partials
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">No Zoom</h5>
											<a href="portfolio-single-wide-slider.html">
												@include('porto.partials.thumb-info.thumb-info-399')
											</a>
										</div>
									</div>
...
porto.partials
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">With Title and Type</h5>
											<a href="portfolio-single-wide-slider.html">
												@include('porto.partials.thumb-info.thumb-info-400')
											</a>
										</div>porto.partials
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Centered Icons</h5>
											
											@include('porto.partials.thumb-info.thumb-info-401')
										</div>porto.partials
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Icons Colors</h5>
											
											@include('porto.partials.thumb-info.thumb-info-402')
										</div>
									</div>
...
porto.partials
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Centered Info</h5>
											<a href="portfolio-single-wide-slider.html">
												@include('porto.partials.thumb-info.thumb-info-403')
											</a>
										</div>porto.partials

										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Bottom Info Light</h5>
											@include('porto.partials.thumb-info.thumb-info-404')
										</div>porto.partials

										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Bottom Info Dark</h5>
											@include('porto.partials.thumb-info.thumb-info-405')
										</div>
									...
									<div class="porto.partials
										...
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Bottom Info Light Linear</h5>
											@include('porto.partials.thumb-info.thumb-info-406')
										</div>porto.partials

										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Bottom Info Dark Linear</h5>
											@include('porto.partials.thumb-info.thumb-info-407')
										</div>porto.partials

										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Bottom Info Show More</h5>
											@include('porto.partials.thumb-info.thumb-info-408')
										</div>
...
porto.partials
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Push Horizontally</h5>
											<a href="portfolio-single-wide-slider.html">
												@include('porto.partials.thumb-info.thumb-info-409')
											</a>
										</div>
porto.partials
										<div class="col-lg-4">
											...
											@include('porto.partials.thumb-info.thumb-info-410')

										</div>porto.partials
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Hide Info Hover</h5>
											<a href="portfolio-single-wide-slider.html">
												@include('porto.partials.thumb-info.thumb-info-411')
											</a>
										</div>
...
porto.partials
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Slide Info Hover Type</h5>
											<a href="portfolio-single-wide-slider.html">
												@include('porto.partials.thumb-info.thumb-info-412')
											</a>
										</div>porto.partials

										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Slide Info Hover Button</h5>
											@include('porto.partials.thumb-info.thumb-info-413')
										</div>porto.partials

										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Slide Info Hover Centered Icons</h5>
											@include('porto.partials.thumb-info.thumb-info-414')
										</div>
...
porto.partials
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Light Block Hover</h5>
											<a href="portfolio-single-wide-slider.html">
												@include('porto.partials.thumb-info.thumb-info-415')
											</a>
										</div>
porto.partials
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Dark Block Hover</h5>
											<a href="portfolio-single-wide-slider.html">
												@include('porto.partials.thumb-info.thumb-info-416')
											</a>
										</div>
porto.partials
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">Color Block Hover</h5>
											<a href="portfolio-single-wide-slider.html">
												@include('porto.partials.thumb-info.thumb-info-417')
											</a>
										</div>
									...
									<div class="row mt-lg-5">
										...
										<div class="cporto.partials
											<h5 class="text-uppercase mt-4">HOVER 3D</h5>
											<div class="hover-effect-3d">
												<a href="portfolio-single-wide-slider.html">
													@include('porto.partials.thumb-info.thumb-info-418')
												</a>
											</div>
										</div>

										<div class="cporto.partials
											<h5 class="text-uppercase mt-4">HOVER 3D + CENTERED INFO</h5>
											<div class="hover-effect-3d">
												<a href="portfolio-single-wide-slider.html">
													@include('porto.partials.thumb-info.thumb-info-419')
												</a>
											</div>
										</div>
porto.partials
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">HOVER 3D + CENTERED ICONS</h5>
											<div class="hover-effect-3d">
												@include('porto.partials.thumb-info.thumb-info-420')
											</div>
										</div>
									...
									<div class="row mt-lg-5">
										porto.partials
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">HOVER FLOATING CAPTION</h5>
											<a href="portfolio-single-wide-slider.html">
												@include('porto.partials.thumb-info.thumb-info-421')
											</a>
										</div>
porto.partials
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">HOVER FLOATING CAPTION + TYPE</h5>
											<a href="portfolio-single-wide-slider.html">
												@include('porto.partials.thumb-info.thumb-info-422')
											</a>
										</div>
porto.partials
										<div class="col-lg-4">
											<h5 class="text-uppercase mt-4">HOVER FLOATING CAPTION CLEAN</h5>
											<a href="portfolio-single-wide-slider.html">
												@include('porto.partials.thumb-info.thumb-info-423')
											</a>
										</div>
...
porto.partials
										<div class="col-lg-6">
											...
											<h5 class="text-uppercase mt-4">Side Image Left</h5>
											@include('porto.partials.thumb-info.thumb-info-424')

										</div>
porto.partials
										<div class="col-lg-6">

											<h5 class="text-uppercase mt-4 text-right">Side Image Right</h5>
											@include('porto.partials.thumb-info.thumb-info-425')
							...
							<div class="row">
								<div class="col">
									...
									<h4 class="mt-5 mb-0">Grid Dashed</h4>

									<div class="content-grid content-grid-dashed mt-5 mb-4">
										<div class="row content-grid-row">
											<div class="content-grid-item col-lg-4 text-center">
												<div class="p-4">
													<img class="img-fluid" src="img/logos/logo-1.png" alt="">
												</div>
											</div>
