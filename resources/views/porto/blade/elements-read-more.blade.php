...
<div role="main" class="main">
						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Read More</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Read More</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">Simple and easy way to hide and show partial content in a interactive way.</p>
				...
				<div id="examples" class="container py-2">
					...
					<div class="row">
						...
						<div class="col-lg-6 mb-5 mb-lg-0">
							...
							<div data-plugin-readmore data-plugin-options="{
								...
								@include('porto.partials.readmore-button-wrapper.readmore-button-wrapper')
							</div>
						</div>
						<div class="col-lg-6 mb-5 mb-lg-0">
							<h4>Start Rendered On First Load of Page</h4>

							<div class="readmore-rendered" data-plugin-readmore data-plugin-options="{
									'buttonOpenLabel': 'Read More &lt;i class=\'fas fa-chevron-down text-2 ml-1\'&gt;&lt;/i&gt;',
									'buttonCloseLabel': 'Read Less &lt;i class=\'fas fa-chevron-up text-2 ml-1\'&gt;&lt;/i&gt;'
								}" style="height: 110px;">
								<p>Lorem ipsum dolor, sit amet consectetur adipisicing, elit. Totam placeat dolores, minima voluptas quo eos, repellat delectus inventore velit. Nulla placeat eius in, alias architecto magnam aliquid debitis adipisci voluptate. Lorem ipsum, dolor, sit amet consectetur adipisicing elit. Voluptate, aut. Aspernatur sapiente ad quod perspiciatis pariatur necessitatibus, omnis, labore dolore minus expedita, suscipit rerum vitae repellendus quia at aperiam laborum!</p>
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis iusto odit quidem commodi voluptates vitae dolores temporibus itaque labore cumque nobis animi facilis, quod, nisi laboriosam sit. Veritatis tenetur, commodi.</p>
								<div class="readmore-overlay" style="background: linear-gradient(rgba(2, 0, 36, 0) 0%, #FFF 100%); height: 100px;"></div>
								@include('porto.partials.readmore-button-wrapper.readmore-button-wrapper-8')
							</div>
						</div>
					</div>
						...
						<div class="col-lg-6 mb-5 mb-lg-0">
							...
							<div class="bg-primary p-5">
								<div data-plugin-readmore data-plugin-options="{
									...
									<p class="text-color-light">Lorem ipsum dolor, sit amet consectetur adipisicing, elit. Totam placeat dolores, minima voluptas quo eos, repellat delectus inventore velit. Nulla placeat eius in, alias architecto magnam aliquid debitis adipisci voluptate. Lorem ipsum, dolor, sit amet consectetur adipisicing elit. Voluptate, aut. Aspernatur sapiente ad quod perspiciatis pariatur necessitatibus, omnis, labore dolore minus expedita, suscipit rerum vitae repellendus quia at aperiam laborum!</p>
									<p class="text-color-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis iusto odit quidem commodi voluptates vitae dolores temporibus itaque labore cumque nobis animi facilis, quod, nisi laboriosam sit. Veritatis tenetur, commodi.</p>
									@include('porto.partials.readmore-button-wrapper.readmore-button-wrapper-9')
								</div>
							</div>
						</div>
						<div class="col-lg-6 mb-5 mb-lg-0">
					...
					<div class="row">
						...
						<div class="col-lg-6 mb-5">
							<div data-plugin-readmore data-plugin-options="{
								...
								<p>Lorem ipsum dolor, sit amet consectetur adipisicing, elit. Totam placeat dolores, minima voluptas quo eos, repellat delectus inventore velit. Nulla placeat eius in, alias architecto magnam aliquid debitis adipisci voluptate. Lorem ipsum, dolor, sit amet consectetur adipisicing elit. Voluptate, aut. Aspernatur sapiente ad quod perspiciatis pariatur necessitatibus, omnis, labore dolore minus expedita, suscipit rerum vitae repellendus quia at aperiam laborum!</p>
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis iusto odit quidem commodi voluptates vitae dolores temporibus itaque labore cumque nobis animi facilis, quod, nisi laboriosam sit. Veritatis tenetur, commodi.</p>
								@include('porto.partials.readmore-button-wrapper.readmore-button-wrapper-10')
							</div>
						</div>
						<div class="col-lg-6 mb-5">
							<div data-plugin-readmore data-plugin-options="{
								...
								<p>Lorem ipsum dolor, sit amet consectetur adipisicing, elit. Totam placeat dolores, minima voluptas quo eos, repellat delectus inventore velit. Nulla placeat eius in, alias architecto magnam aliquid debitis adipisci voluptate. Lorem ipsum, dolor, sit amet consectetur adipisicing elit. Voluptate, aut. Aspernatur sapiente ad quod perspiciatis pariatur necessitatibus, omnis, labore dolore minus expedita, suscipit rerum vitae repellendus quia at aperiam laborum!</p>
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis iusto odit quidem commodi voluptates vitae dolores temporibus itaque labore cumque nobis animi facilis, quod, nisi laboriosam sit. Veritatis tenetur, commodi.</p>
								@include('porto.partials.readmore-button-wrapper.readmore-button-wrapper-11')
							</div>
						</div>
						<div class="col-lg-6 mb-5 mb-lg-0">
							<div data-plugin-readmore data-plugin-options="{
								...
								<p>Lorem ipsum dolor, sit amet consectetur adipisicing, elit. Totam placeat dolores, minima voluptas quo eos, repellat delectus inventore velit. Nulla placeat eius in, alias architecto magnam aliquid debitis adipisci voluptate. Lorem ipsum, dolor, sit amet consectetur adipisicing elit. Voluptate, aut. Aspernatur sapiente ad quod perspiciatis pariatur necessitatibus, omnis, labore dolore minus expedita, suscipit rerum vitae repellendus quia at aperiam laborum!</p>
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis iusto odit quidem commodi voluptates vitae dolores temporibus itaque labore cumque nobis animi facilis, quod, nisi laboriosam sit. Veritatis tenetur, commodi.</p>
								@include('porto.partials.readmore-button-wrapper.readmore-button-wrapper-12')
							</div>
						</div>
						<div class="col-lg-6 mb-5 mb-lg-0">
							<div data-plugin-readmore data-plugin-options="{
								...
								<p>Lorem ipsum dolor, sit amet consectetur adipisicing, elit. Totam placeat dolores, minima voluptas quo eos, repellat delectus inventore velit. Nulla placeat eius in, alias architecto magnam aliquid debitis adipisci voluptate. Lorem ipsum, dolor, sit amet consectetur adipisicing elit. Voluptate, aut. Aspernatur sapiente ad quod perspiciatis pariatur necessitatibus, omnis, labore dolore minus expedita, suscipit rerum vitae repellendus quia at aperiam laborum!</p>
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis iusto odit quidem commodi voluptates vitae dolores temporibus itaque labore cumque nobis animi facilis, quod, nisi laboriosam sit. Veritatis tenetur, commodi.</p>
								@include('porto.partials.readmore-button-wrapper.readmore-button-wrapper-13')
							</div>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-6 mb-5 mb-lg-0">
							<div data-plugin-readmore data-plugin-options="{
									'buttonOpenLabel': '&lt;i class=\'fas fa-chevron-down text-4 ml-1\'&gt;&lt;/i&gt;',
									'buttonCloseLabel': '&lt;i class=\'fas fa-chevron-up text-4 ml-1\'&gt;&lt;/i&gt;'
								}">
								<p>Lorem ipsum dolor, sit amet consectetur adipisicing, elit. Totam placeat dolores, minima voluptas quo eos, repellat delectus inventore velit. Nulla placeat eius in, alias architecto magnam aliquid debitis adipisci voluptate. Lorem ipsum, dolor, sit amet consectetur adipisicing elit. Voluptate, aut. Aspernatur sapiente ad quod perspiciatis pariatur necessitatibus, omnis, labore dolore minus expedita, suscipit rerum vitae repellendus quia at aperiam laborum!</p>
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis iusto odit quidem commodi voluptates vitae dolores temporibus itaque labore cumque nobis animi facilis, quod, nisi laboriosam sit. Veritatis tenetur, commodi.</p>
								@include('porto.partials.readmore-button-wrapper.readmore-button-wrapper-14')
							</div>
						</div>
						<div class="col-lg-6 mb-5 mb-lg-0">
							<div data-plugin-readmore data-plugin-options="{
									'buttonOpenLabel': '&lt;i class=\'fas fa-plus text-2\'&gt;&lt;/i&gt;',
									'buttonCloseLabel': '&lt;i class=\'fas fa-minus text-2\'&gt;&lt;/i&gt;'
								}">
								<p>Lorem ipsum dolor, sit amet consectetur adipisicing, elit. Totam placeat dolores, minima voluptas quo eos, repellat delectus inventore velit. Nulla placeat eius in, alias architecto magnam aliquid debitis adipisci voluptate. Lorem ipsum, dolor, sit amet consectetur adipisicing elit. Voluptate, aut. Aspernatur sapiente ad quod perspiciatis pariatur necessitatibus, omnis, labore dolore minus expedita, suscipit rerum vitae repellendus quia at aperiam laborum!</p>
								<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis iusto odit quidem commodi voluptates vitae dolores temporibus itaque labore cumque nobis animi facilis, quod, nisi laboriosam sit. Veritatis tenetur, commodi.</p>
								@include('porto.partials.readmore-button-wrapper.readmore-button-wrapper-15')
							</div>
						</div>
					</div>
