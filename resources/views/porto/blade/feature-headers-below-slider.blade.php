@extends('porto.app')
@section('header')
@include('porto.partials.header.header-197')
@endsection
...
<div role="main" class="main">
								...
								<div class="header-row">
									...
									<div class="porto.partialsy-content-end">
										<div class="header-row">porto.partials
											@include('porto.partials.header-nav.header-nav-201')
				...
				<div class="container mb-5 pb-4">
					...
					<div class="row text-center mt-5">
						@include('porto.partials.owl-carousel.owl-carousel-189')
					</div>
							...
							<div class="row mt-5 appear-animation" data-appear-animation="fadeInUpShorter">
								<div class="col-lg-6">
									<div class="recent-posts mb-5">
										...
										@include('porto.partials.owl-carousel.owl-carousel-190')
									</div>
								</div>
								<div class="col-lg-6">
