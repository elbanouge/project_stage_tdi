...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-34')

				<div class="container py-4">

					<div class="row">
						<div class="col-lg-3">
							@include('porto.partials.sidebar.sidebar-2')
						</div>
						<div class="col-lg-6">
							<div class="blog-posts single-post">

								@include('porto.partials.post.post-120')

							</div>
						</div>
						<div class="col-lg-3">
							@include('porto.partials.sidebar.sidebar-3')
						</div>
					</div>
