...
porto.partials
				@include('porto.partials.page-header.page-header-284')
					...
					<div class="sort-destination-loader sort-destination-loader-showing mt-4 pt-2">
						<div class="row portfolio-list sort-destination" data-sort-id="portfolio">
							...
							<div class="col-lg-12 isotope-item brands">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-239'])
							</div>

							<div class="col-lg-12 isotope-item medias">
								@include('porto.partials.portfolio-item.portfolio-item-240')
							</div>

							<div class="col-lg-12 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-241'])
							</div>

							<div class="col-lg-12 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-242'])
							</div>
