				...
				<div class="container">
					<div class="row py-5 justify-content-center">
							...
							<div class="footer-nav footer-nav-links footer-nav-bottom-line">
								<nav>
									<ul class="nav" id="footerNav">
										<li>
											<a href="#" class="text-3">Home</a>
										</li>
										<li>
											<a href="#" class="text-3">Elements</a>
										</li>
										<li>
											<a class="text-3 active" href="#">Features</a>
										</li>
										<li>
											<a href="#" class="text-3">Pages</a>
										</li>
										<li>
											<a href="#" class="text-3">Portfolio</a>
										</li>
										<li>
											<a href="#" class="text-3">Blog</a>
										</li>
										<li>
											<a href="#" class="text-3">Shop</a>
										</li>
									</ul>
								</nav>
							</div>
						...
						<div class="col-md-4 col-lg-3 mb-4 mb-lg-0 text-center text-lg-right">
							...
							<p clasporto.partialslto:mail@example.com">mail@example.com</a></p>
						</div>
					</div>
				</div>
