...
<div role="main" class="main">
						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Toggles</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Toggles</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">With toggle plugin you can separate your content in topics and show within a beautiful and interactive design.</p>
				...
				<div id="examples" class="container py-2">
					...
					<div class="row">
						<div class="col-lg-6">
							<h4>Default</h4>
							@include('porto.partials.toggle.toggle-26')
						</div>
						...
						<div class="col-lg-6">
							...
							@include('porto.partials.toggle.toggle-30')
						</div>
					...
					<div class="row">
						<div class="col-lg-6">
							<h4>Minimal</h4>
							@include('porto.partials.toggle.toggle-34')
						</div>
						...
						<div class="col-lg-6">
							...
							<h4>Minimal and One Toggle Open At A Time</h4>

							@include('porto.partials.toggle.toggle-38')
						</div>
					...
					<div class="row">
						<div class="col-lg-3">
							@include('porto.partials.toggle.toggle-42')
						</div>
						<div class="col-lg-3">
							@include('porto.partials.toggle.toggle-46')
						</div>
						<div class="col-lg-3">
							@include('porto.partials.toggle.toggle-50')
						</div>
						<div class="col-lg-3">
							@include('porto.partials.toggle.toggle-54')
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-3">
							<h4>Small</h4>
							@include('porto.partials.toggle.toggle-58')
						</div>
						<div class="col-lg-3">
							<h4>Default</h4>
							@include('porto.partials.toggle.toggle-62')
						</div>
						<div class="col-lg-6">
							<h4>Large</h4>
							@include('porto.partials.toggle.toggle-66')
						</div>
					</div>
					...
					<div class="row">
						<div class="col">
							<h4>FAQ</h4>
							@include('porto.partials.toggle.toggle-70')
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-6">
							<h4>Simple</h4>
							@include('porto.partials.toggle.toggle-74')
						</div>
						...
						<div class="col-lg-6">
							...
							<h4>Simple and One Toggle Open At A Time</h4>

							@include('porto.partials.toggle.toggle-78')
						</div>
					...
					<div class="row pb-4">
						<div class="col-lg-3">
							@include('porto.partials.toggle.toggle-82')
						</div>
						<div class="col-lg-3">
							@include('porto.partials.toggle.toggle-86')
						</div>
						<div class="col-lg-3">
							@include('porto.partials.toggle.toggle-90')
						</div>
						<div class="col-lg-3">
							@include('porto.partials.toggle.toggle-94')
						</div>
					</div>
