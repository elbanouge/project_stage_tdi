...
<div role="main" class="main">
	...
	@include('porto.partials.page-header.page-header-23')
		...
		<div class="row">
			...
			<div class="col-lg-9">
				<div class="blog-posts">
					...
					@include('porto.partials.post.post-101')

					@include('porto.partials.post.post-102')

					@include('porto.partials.post.post-103')

					@include('porto.partials.post.post-104')

					@include('porto.partials.post.post-105')

					@include('porto.partials.post.post-106')

					@include('porto.partials.post.post-107')

					@include('porto.partials.post.post-108')
