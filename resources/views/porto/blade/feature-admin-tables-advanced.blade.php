...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-209')
				<div class="container">
					<div class="row">
						<div class="col">
					...
					<div class="row">
						<div class="col">
							<section class="card card-admin">
								...
								<div class="card-body">
									@include('porto.partials.table.table-9')
								</div>
							</section>
						</div>
					</div>
					<div class="row">
						<div class="col">
							<section class="card card-admin">
								...
								<div class="card-body">
									@include('porto.partials.table.table-10')
								</div>
							</section>
						</div>
					</div>
					<div class="row">
						<div class="col">
							<section class="card card-admin">
								...
								<div class="card-body">
									@include('porto.partials.table.table-11')
								</div>
							</section>
						</div>
					</div>
