						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Medias</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Medias</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">Very simple, responsive and easy to add medias in your website. Embed youtube, vimeo, soundcloud, etc... with few lines of code.</p>
									...
									<div class="row">
										<div class="col-md-6 mb-4 mb-md-0">
											...
											<div class="embed-responsive embed-responsive-4by3">
												<video width="100%" height="100%" controls muted loop preload="metadata" poster="video/presentation.jpg">
										...
										<div class="col-md-6">
											<h4>HTML5 With Play Button</h4>
											<div class="position-relative">
												<div class="embed-responsive embed-responsive-4by3">
													<video id="presentation2" class="float-left" width="100%" height="100%" muted loop preload="metadata" poster="video/presentation.jpg">
													  	<source src="video/presentation.webm" type="video/webm">
													  	<source src="video/presentation.mp4" type="video/mp4">
													</source></source></video>
									...
									<div class="row">
										<div class="col-lg-6 mb-4 mb-lg-0">
											...
											<div class="embed-responsive embed-responsive-4by3 mb-0">
												<iframe frameborder="0" allowfullscreen="" src="//www.youtube.com/embed/gQaXbSPQoDQ?showinfo=0&amp;wmode=opaque"></iframe>
											</div>
										</div>
										<div class="col-lg-6">
											<h4>Borders</h4>
											<div class="embed-responsive embed-responsive-16by9 embed-responsive-borders">
												<iframe frameborder="0" allowfullscreen="" src="//www.youtube.com/embed/l-epKcOA7RQ?showinfo=0&amp;wmode=opaque"></iframe>
											</div>
										</div>
									</div>
