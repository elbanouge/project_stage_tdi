...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-255')

				<div class="container">

					<div class="row">
						<div class="col pt-3 mt-2">
							<h4>Page Transition Effect</h4>

							<p>
								This effect will apply a opacity in whole content when changes the page by clicking in a link or reloading the page. Click on the button below to reload this page and see the page transition effect.
							</p>
							<hr class="solid my-5">
						</div>
					</div>
					...
					<div class="row">
						<div class="col text-center pb-3">
							...
							<a href="feature-page-transition.html" class="btn py-3 px-5 btn-primary btn-rounded btn-modern"><i class="fas fa-sync-alt mr-1"></i> RELOAD PAGE</a>
