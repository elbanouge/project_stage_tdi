...
@section('main')
<div id="examples" role="main" class="main">
						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Carousels</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Carousels</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">Tons of carousel types giving to your website opportunity to show large contents in a small area.</p>
				...
				<div class="container py-2">
					...
					<div class="row">
						<div class="col">
							<h4>Default</h4>
							@include('porto.partials.owl-carousel.owl-carousel-147')
						</div>
					</div>
					...
					<div class="row">
						<div class="col">
							...
							@include('porto.partials.owl-carousel.owl-carousel-148')
						</div>
					</div>
					...
					<div class="row">
						<div class="col">
							...
							@include('porto.partials.owl-carousel.owl-carousel-149')
						</div>
					</div>
					...
					<div class="row">
						<div class="col">
							...
							@include('porto.partials.owl-carousel.owl-carousel-150')
						</div>
					</div>
					...
					<div class="row">
						<div class="col">
							...
							@include('porto.partials.owl-carousel.owl-carousel-151')
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-6">
							...
							@include('porto.partials.owl-carousel.owl-carousel-152')
						</div>
						<div class="col-lg-6">
							<h4>Navigation Inside Arrows No Background</h4>
							@include('porto.partials.owl-carousel.owl-carousel-153')
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-6">
							...
							@include('porto.partials.owl-carousel.owl-carousel-154')
						</div>
						<div class="col-lg-6">
							<h4>Navigation Inside Edge Light</h4>
							@include('porto.partials.owl-carousel.owl-carousel-155')
						</div>
					</div>
					<div class="row">
						<div class="col">
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-10">
								...
								@include('porto.partials.owl-carousel.owl-carousel-156')
					...
					<div class="row">
						<div class="col-lg-5">
							<div class="row">
								<div class="col-lg-6">
									<h4>Vertical</h4>
									@include('porto.partials.owl-carousel.owl-carousel-157')
								</div>
								<div class="col-lg-6">
									<h4>Animation (FadeOut)</h4>
									@include('porto.partials.owl-carousel.owl-carousel-158')
								</div>
							</div>
							<div class="row">
								<div class="col">
...
porto.partials
									...
									@include('porto.partials.owl-carousel.owl-carousel-159')
								</div>
							</div>
							<div class="row">
								<div class="col">
									...
									@include('porto.partials.owl-carousel.owl-carousel-160')
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							...
							@include('porto.partials.owl-carousel.owl-carousel-161')

							<hr class="solid my-5">

							<h4>Auto Play</h4>

							@include('porto.partials.owl-carousel.owl-carousel-162')

							<hr class="solid my-5">

							<h4>Rounded Navigation</h4>

							@include('porto.partials.owl-carousel.owl-carousel-163')

							<hr class="solid my-5">

							<h4>Navigation Bottom</h4>

							@include('porto.partials.owl-carousel.owl-carousel-164')

							<hr class="solid my-5">

							<h4>Navigation Bottom Rounded</h4>

							@include('porto.partials.owl-carousel.owl-carousel-165')
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-6">
							<h4>Center</h4>
							@include('porto.partials.owl-carousel.owl-carousel-166')
						</div>
						<div class="col-lg-6">
							<h4>Center With Loop</h4>
							@include('porto.partials.owl-carousel.owl-carousel-167')
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-6">
							<h4>Dots Morphing</h4>
							@include('porto.partials.owl-carousel.owl-carousel-168')
						</div>
						<div class="col-lg-6">
							<h4>Dots Modern</h4>
							@include('porto.partials.owl-carousel.owl-carousel-169')
						</div>
					</div>
					...
					<div class="row">
						<div class="col">
							...
							@include('porto.partials.owl-carousel.owl-carousel-170')
						</div>
					</div>
					...
					<div class="row">
						<div class="col">
							...
							@include('porto.partials.owl-carousel.owl-carousel-171')
						</div>
					</div>
						...
						<div class="col">
							...
							<div class="row">
								<div class="col">
									...
									@include('porto.partials.owl-carousel.owl-carousel-172')
...
porto.partials
				@include('porto.partials.owl-carousel.owl-carousel-173')
				...
				<div class="container">
					...
					<div class="row pb-4">
						<div class="col">
							<h4>Videos</h4>
							@include('porto.partials.owl-carousel.owl-carousel-174')
						</div>
					</div>
