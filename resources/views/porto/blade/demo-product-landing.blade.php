@extends('porto.app')
@section('header')
@include('porto.partials.header.header-175')
@endsection
...
<div role="main" class="main">
				...
				<section id="intro" class="section section-with-shape-divider border-0 custom-bg-color-grey-1 overflow-visible m-0 pt-5 pb-5 pb-lg-0">
					<div class="container position-relative z-index-2 h-100 py-md-5">
						<div class="row align-items-center justify-content-center h-100 pt-5 py-xl-5 my-xl-5">
							<div class="col-md-10 col-lg-6 text-center text-sm-right order-2 order-lg-1 pr-lg-0 py-lg-5 my-lg-5">
								<h1 class="text-13 ls-0 line-height-1 custom-ws-nowrap mb-3 z-index-1 position-relative text-center text-sm-left">
									...
									<strong class="font-weight-extra-bold text-3 text-sm-3-4 text-md-4 text-lg-3 text-xl-4 d-inline-block negative-ls-2 position-relative z-index-1 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1200">Porto Headphone</strong>
								</h1>
								<p class="font-weight-light text-5 text-center text-sm-right mb-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1400">The most advanced headphone in the world</p>
								...
								<a href="#" class="d-inline-flex align-items-center text-color-default text-color-hover-primary text-decoration-none font-weight-medium ml-3 ml-sm-0 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1800">Learn More <i class="icons icon-arrow-right text-1 ml-2"></i></a>
							</div>
							<div class="col-lg-6 align-self-xl-stretch order-1 order-lg-2">
								<div class="custom-product-image-style-1 d-none d-lg-block">
									<div data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.3, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}">
										<img src="img/demos/product-landing/product-1.png" class="img-fluid appear-animation" alt="" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="600">
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row align-items-start justify-content-center py-5 mt-lg-4 mb-4">
							<div class="col-md-9 col-lg-5 col-xl-6 order-2 order-lg-1">
								<div data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.3, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}">
									<img src="img/demos/product-landing/product-2.png" class="img-fluid appear-animation" alt="" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200" style="margin-top: -65px;">
								</div>
							</div>
							<div class="col-lg-7 col-xl-6 order-1 order-lg-2 mb-5 mb-xl-0 pb-5 pb-xl-0">
								<div class="overflow-hidden mb-1">
									<span class="d-block text-color-default custom-letter-spacing-1 text-3-5 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="400">POWERFUL DEVICE</span>
								</div>
								...
								<p class="font-weight-semibold text-4-5 line-height-6 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi euismod, sed porta est.</p>
								<p class="text-3-5 pb-3 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">Vestibulum auctor felis eget orci semper vestibulum. Pellentesque ultricies nibh gravida, accumsan libero luctus, molestie nunc. In nibh ipsum, blandit id faucibus ac, finibus vitae dui.</p>
								<a href="#reviews" data-hash data-hash-offset="70" class="btn btn-primary btn-rounded font-weight-bold text-3-5 px-5 py-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">Reviews</a>
							</div>
						</div>
					</div>
					...
					<div class="container custom-xs-margin-top-1 pt-3 pb-lg-5 mb-lg-5">
						<div class="row align-items-start justify-content-center pb-5 mb-4">
							<div class="col-lg-7 col-xl-6 pb-5 pb-lg-0 mb-lg-5 mb-xl-0">
								<div class="overflow-hidden mb-1">
									<span class="d-block text-color-default custom-letter-spacing-1 text-3-5 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="400">ANYWHERE YOU WANT</span>
								</div>
								<div class="overflow-hidden mb-4">
									<h2 class="font-weight-bold text-9 negative-ls-05 line-height-2 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="600">Bluetooth Connection</h2>
								</div>
								<p class="font-weight-bold text-4-5 line-height-6 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
								<p class="text-3-5 pb-3 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">Vestibulum auctor felis eget orci semper vestibulum. Pellentesque ultricies nibh gravida, accumsan libero luctus, molestie nunc. In nibh ipsum, blandit id faucibus ac, finibus vitae dui.</p>
								<a href="#features" data-hash data-hash-offset="70" class="btn btn-primary btn-rounded font-weight-bold text-3-5 px-5 py-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1200">Features</a>
							</div>
							<div class="col-md-9 col-lg-5 col-xl-6 mb-5 mb-lg-0">
								<div data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.3, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}">
									<img src="img/demos/product-landing/product-3.png" class="img-fluid custom-xl-margin-top-1 appear-animation" alt="" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="container pt-5 mt-md-5 mt-xl-0 pt-xl-0">
					<div class="row align-items-center justify-content-center">
						<div class="col-md-9 col-lg-5 col-xl-6 mb-5 mb-lg-0">
							<div data-plugin-float-element data-plugin-options="{'startPos': 'bottom', 'speed': 0.3, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}">
								<img src="img/demos/product-landing/noise.jpg" class="img-fluid appear-animation" alt="" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
							</div>
						</div>
						<div class="col-lg-7 col-xl-6 pb-4">
							<div class="overflow-hidden mb-1">
								<span class="d-block text-color-default custom-letter-spacing-1 text-3-5 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="400">EXTRA CONFORT</span>
							</div>
							<div class="overflow-hidden mb-4">
								<h2 class="font-weight-bold text-9 negative-ls-05 line-height-2 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="600">Noise Cancelling</h2>
							</div>
							<p class="font-weight-bold text-4-5 line-height-6 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="800">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi euismod, sed porta est.</p>
							<p class="text-3-5 pb-3 mb-4 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1000">Vestibulum auctor felis eget orci semper vestibulum. Pellentesque ultricies nibh gravida, accumsan libero luctus, molestie nunc. In nibh ipsum, blandit id faucibus ac, finibus vitae dui.</p>
				...
				<div class="container container-xl-custom position-relative overflow-hidden pb-5">
					<svg class="position-absolute w-100 h-100 z-index-2 p-events-none d-none d-lg-block" viewbox="0 0 120 120" version="1.1" xmlns="http://www.w3.org/2000/svg" style="bottom: -80px; left: 0;">
						<circle cx="60" cy="90" r="90" stroke="#edeeee" stroke-width="0.3" fill="transparent" class="appear-animation" data-appear-animation="customSVGLineAnimTwo" data-appear-animation-delay="200" data-appear-animation-duration="3s" data-plugin-options="{'accY': -300, 'forceAnimation': true}"></circle>
					</svg>
					...
					<div class="container">
						<div class="row align-items-center">
							<div class="col-lg-7 col-xl-8 mb-lg-4">
								...
								<p class="text-3-5 text-color-light opacity-5">Vestibulum auctor felis eget orci semper vestibulum. Pellentesque ultricies nibh gravida, accumsan libero luctus, molestie nunc. In nibh ipsum, blandit id faucibus ac, finibus vitae dui.</p>
							</div>
						...
						<div class="row">
							<div class="col-md-6 col-lg-4 pr-lg-4 py-lg-2">
								<ul class="list list-light list-unstyled mb-0">
									<li class="text-color-light font-weight-light mb-1"><span class="custom-min-width opacity-5">Designed For</span> Smartphones</li>
									<li class="text-color-light font-weight-light mb-1"><span class="custom-min-width opacity-5">Circumaural</span> Supra-aural</li>
									<li class="text-color-light font-weight-light mb-1"><span class="custom-min-width opacity-5">Magnet Type</span> Neodymium</li>
									<li class="text-color-light font-weight-light mb-1 mb-lg-0"><span class="custom-min-width opacity-5">Wih Microphone</span> Yes</li>
								</ul>
							</div>
							<div class="col-md-6 col-lg-4 px-lg-4 py-lg-2">
								<ul class="list list-light list-unstyled mb-0">
									<li class="text-color-light font-weight-light mb-1"><span class="custom-min-width opacity-5">Glass Type</span> Monocle</li>
									<li class="text-color-light font-weight-light mb-1"><span class="custom-min-width opacity-5">Lens Type</span> Bi Convex</li>
									<li class="text-color-light font-weight-light mb-1"><span class="custom-min-width opacity-5">Suitable For</span> Entertainment</li>
									<li class="text-color-light font-weight-light mb-1 mb-lg-0"><span class="custom-min-width opacity-5">Functions</span> Graphical Display</li>
								</ul>
							</div>
							<div class="col-md-6 col-lg-4 pl-lg-4 py-lg-2">
								<ul class="list list-light list-unstyled mb-0">
									<li class="text-color-light font-weight-light mb-1"><span class="custom-min-width opacity-5">Compatible OS</span> Android</li>
									<li class="text-color-light font-weight-light mb-1"><span class="custom-min-width opacity-5">Compatible Eye</span> Both</li>
									<li class="text-color-light font-weight-light mb-1 mb-lg-0"><span class="custom-min-width opacity-5">Control Type</span> Manual</li>
								</ul>
							</div>
						</div>
					</div>
					...
					<div id="reviews" class="container position-relative pb-5 mb-5">
						<div class="row pt-4 mt-5">
							<div class="col text-center">
								<div class="overflow-hidden mb-1">
									<span class="d-block text-color-default custom-letter-spacing-2 text-3-5 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="300">FROM BUYERS</span>
								</div>
								<div class="overflow-hidden mb-4">
									<h2 class="font-weight-bold negative-ls-05 text-9 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="500">Reviews</h2>
								</div>
							</div>						
						</div>
						<div class="row justify-content-center position-relative z-index-1 pb-5 mb-5 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700">
							<div class="col-lg-11 pb-5 mb-3">
								@include('porto.partials.owl-carousel.owl-carousel-126')
							</div>
						</div>
						<div class="position-absolute bottom-0 w-100" style="left: 93%;">
							<img src="img/demos/product-landing/product-wire.jpg" class="img-fluid" alt="">
						</div>
					</div>
					<div class="shape-divider shape-divider-bottom" style="height: 215px;">
						<svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewbox="0 0 1920 215" preserveaspectratio="xMinYMin">
				...
				<section class="section custom-bg-color-grey-1 position-relative z-index-1 border-0 pt-0 m-0">
					<div class="container shop pb-4" style="margin-top: -45px;">
						<div class="row">
							<div class="col-lg-5 mb-4 mb-lg-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">

								<div class="thumb-gallery-wrapper">
									@include('porto.partials.owl-carousel.owl-carousel-127')
									@include('porto.partials.owl-carousel.owl-carousel-128')
								</div>
								...
								<div class="summary entry-summary position-relative">
									...
									<div class="pb-0 clearfix d-flex align-items-center">
										...
										<div class="review-num">
											<a href="#reviews" class="text-decoration-none text-color-default text-color-hover-primary" data-hash data-hash-offset="75">
									...
									<p class="price mb-3">
										<span class="sale text-color-primary font-weight-bold ml-1">$350</span>
									...
									<form enctype="multipart/form-data" method="post" class="cart" action="shop-cart.html">
										@include('porto.partials.table.table-1')
										<div class="d-flex align-items-center my-4">
											<div class="quantity quantity-lg float-none mr-3 mb-0">
												...
												<input type="text" class="input-text qty text bg-transparent border border-left-0 border-right-0" title="Qty" value="1" name="quantity" min="1" step="1">
											...
											<button type="submit" class="btn btn-primary btn-rounded font-weight-bold text-3-5 btn-px-5 btn-py-2">Buy Now!</button>
										</div>
									</form>
									...
									<div class="d-flex align-items-center">
										<ul class="social-icons social-icons-medium social-icons-clean-with-border social-icons-clean-with-border-border-grey social-icons-clean-with-border-icon-dark mr-3 mb-0">
											...
											<li class="social-icons-facebook">
												<a href="http://www.facebook.com/sharer.php?u=https://www.okler.net" class="border" target="_blank" data-toggle="tooltip" data-placement="top" title="Share On Facebook">
													<i class="fab fa-facebook-f"></i>
												</a>
											</li>
											<!-- Google+ -->
											<li class="social-icons-googleplus">
												<a href="https://plus.google.com/share?url=https://www.okler.net" class="border" target="_blank" data-toggle="tooltip" data-placement="top" title="Share On Google+">
													<i class="fab fa-google-plus-g"></i>
												</a>
											</li>
											<!-- Twitter -->
											<li class="social-icons-twitter">
												<a href="https://twitter.com/share?url=https://www.okler.net&amp;text=Simple%20Share%20Buttons&amp;hashtags=simplesharebuttons" class="border" target="_blank" data-toggle="tooltip" data-placement="top" title="Share On Twitter">
													<i class="fab fa-twitter"></i>
												</a>
											</li>
											<!-- Email -->
											<li class="social-icons-email">
												<a href="mailto:?Subject=Share%20This%20Page&amp;Body=I%20saw%20this%20and%20thought%20of%20you!%20%20https://www.okler.net" class="border" data-toggle="tooltip" data-placement="top" title="Share By Email">
				...
				<section id="explore" class="section video section-height-4 overlay overlay-show overlay-op-8 border-0 m-0" data-video-path="video/memory-of-a-woman" data-plugin-video-background data-plugin-options="{'posterType': 'jpg', 'position': '50% 50%', 'autoplay': false, 'changePoster': 'img/demos/product-landing/backgrounds/background-1.jpg'}">
					<div class="container py-5 my-5">
						<div class="row">
							<div class="col text-center">
								<div class="video-background-play-wrapper">
									<h2 class="d-flex flex-wrap align-items-center justify-content-center text-color-light font-weight-bold text-10 negative-ls-05 mb-0 appear-animation" data-appear-animation="blurIn" data-appear-animation-delay="400">
										Explore The Best Of You 
										<a href="https://vimeo.com/45830194" class="video-background-play text-decoration-none custom-play-button-1 bg-primary bg-hover-primary text-color-light ml-3 my-4">
					...
					<div class="container">
						<div class="row align-items-center">
							<div class="col-lg-5 mb-4 mb-lg-0">
								@include('porto.partials.feature-box.feature-box-132')
							</div>
							<div class="col-lg-7">
								...
								<form id="newsletterForm" action="php/newsletter-subscribe.php" method="POST" class="mw-100">
									<div class="input-group">
										<input class="form-control form-control-sm bg-light border-0 px-4 text-3" placeholder="Your E-mail Address" name="newsletterEmail" id="newsletterEmail" type="text">
										<span class="input-group-append">
											<button class="btn btn-primary  text-color-light text-2 py-3 px-5" type="submit"><strong class="position-relative top-1">SUBSCRIBE NOW!</strong></button>
										</span>
									</div>
								</form>
							</div>
