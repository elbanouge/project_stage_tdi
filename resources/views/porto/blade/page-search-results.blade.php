...
<div role="maiporto.partials
				...
				@include('porto.partials.page-header.page-header-266')
				<hr class="m-0">
				...
				<div class="container py-5 mt-3">
					...
					<div class="row">
						<div class="col">
							<h2 class="font-weight-normal text-7 mb-0">Showing results for <strong class="font-weight-extra-bold">test</strong></h2>
							...
							<ul class="simple-post-list m-0">
								<li>
									<div class="post-info">
										...
										<div class="post-meta">
											 <span class="text-dark text-uppercase font-weight-semibold">Page</span> | Nov 10, 2021
										</div>
									</div>
								</li>
								<li>
									<div class="post-info">
										...
										<div class="post-meta">
											 <span class="text-dark text-uppercase font-weight-semibold">Post</span> | Nov 10, 2021
										</div>
									</div>
								</li>
								<li>
