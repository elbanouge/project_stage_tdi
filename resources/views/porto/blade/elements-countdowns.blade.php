						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Countdowns</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Countdowns</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">The countdown plugin is very useful if you need a down timer. You can play with the ready styles and plugin options.</p>
				...
				<div id="examples" class="container py-2">
					...
					<div class="row">
						<div class="col">
							...
							<div class="row">
								<div class="col">
									@include('porto.partials.countdown.countdown-3')
								</div>
							</div>
							...
							<div class="row">
								<div class="col">
									@include('porto.partials.countdown.countdown-4')
								</div>
							</div>
							...
							<div class="row">
								<div class="col">
									@include('porto.partials.countdown.countdown-5')
								</div>
							</div>
							...
							<div class="row">
								<div class="col">
									@include('porto.partials.countdown.countdown-6')
								</div>
							</div>

							<hr class="solid my-5">

							<h4>Inside Parallax</h4>

						</div>
					</div>
				</div>

				<section class="section section-parallax section-height-4 border-0 m-0" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="img/parallax/parallax-2.jpg">
					<div class="container">
						<div class="row">
							<div class="col">
								<div class="row">
									<div class="col">
										@include('porto.partials.countdown.countdown-7')
									</div>
								</div>
							</div>
						</div>
