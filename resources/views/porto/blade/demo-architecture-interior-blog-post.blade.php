...
<div role="main" class="main">
				@include('porto.partials.page-header.page-header-52')

				<section class="section section-height-2 bg-light border-0 mt-3">
									...
									<div class="row">
										<div class="col">
											<article class="border-bottom-0 pb-0 mb-5 pt-4">
												...
												<div class="row pb-5">
													<div class="col-sm-4">
														@include('porto.partials.lightbox.lightbox-4')
													</div>
													<div class="col-sm-4">
														@include('porto.partials.lightbox.lightbox-5')
													</div>
													<div class="col-sm-4">
														@include('porto.partials.lightbox.lightbox-6')
													</div>
												</div>
														...
														<div class="p-2">
															...
															<div class="form-row">
																<div class="form-group col mb-0">
																	<input type="submit" value="Post Comment" class="btn btn-primary btn-outline ml-2 font-weight-extra-bold text-3 px-5 py-3 border-width-4 appear-animation animated fadeInUpShorter appear-animation-visible" data-loading-text="Loading...">
																</div>
															</div>
														</div>
													</form>
