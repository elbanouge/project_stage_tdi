@extends('porto.app')
@section('header')
@include('porto.partials.header.header-5')
@endsection
						...
						<div class="row">
							<div class="col-md-8 col-lg-8">
								<div class="custom-top-title-box">
									...
									<span class="text-color-light font-weight-semibold mb-5">You will ever need!</span>
							...
							<div class="col-8 col-md-4 col-lg-4 mx-auto">
								@include('porto.partials.owl-carousel.owl-carousel-4')
							</div>
						</div>
					</div>
				</section>
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-md-8 col-lg-5">
								...
								<img src="img/demos/app-landing/product/how-works-product-image-2.png" data-appear-animation="fadeInUp" data-appear-animation-delay="300" data-plugin-options="{'accY': 200}" alt class="appear-animation custom-product-image-pos-1 _relative img-fluid">

								<img src="img/demos/app-landing/product/how-works-product-image-1.png" data-appear-animation="fadeInUp" data-appear-animation-delay="100" data-plugin-options="{'accY': 10}" alt class="appear-animation custom-product-image-pos-1 _absolute img-fluid">
							</div>
										...
										<div class="custom-box-icon">
											<svg version="1.1" id="sign-up" x="0px" y="0px" width="65px" height="65px" viewbox="0 0 50 50" enable-background="new 0 0 50 50" xml:space="preserve">
												<path class="icon appear-animation" data-appear-animation="icons-anim" data-appear-animation-duration="1500ms" data-appear-animation-delay="500ms" fill="#F1645B" stroke="#F1645B" d="M25,0C15.263,0,6.343,5.724,2.274,14.583c-0.23,0.502-0.01,1.096,0.492,1.326
													...
													c5.161,1.869,7.772,3.122,8.844,4.229C37.727,45.209,31.679,48.1,25,48.1z"></path>
												<path class="plus appear-animation" data-appear-animation="icons-anim" data-appear-animation-duration="1500ms" data-appear-animation-delay="800" fill="#F1645B" d="M11,24H7v-4c0-0.553-0.447-1-1-1s-1,0.447-1,1v4H1c-0.553,0-1,0.447-1,1c0,0.552,0.447,1,1,1h4v4
													c0,0.552,0.447,1,1,1s1-0.448,1-1v-4h4c0.553,0,1-0.448,1-1C12,24.447,11.553,24,11,24z"></path>
											</svg>
											<span class="appear-animation" data-appear-animation="fadeInDown" data-appear-animation-delay="1500">Sign up</span>
										</div>
										<div class="custom-box-icon">
											<div class="wrap-dashed-lines">
												<svg version="1.1" id="connect-people" x="0px" y="0px" width="65px" height="65px" viewbox="0 0 50 50" enable-background="new 0 0 50 50" xml:space="preserve">
													<path class="icon appear-animation" data-appear-animation="icons-anim" data-appear-animation-duration="3500ms" data-appear-animation-delay="700" fill="#F1645B" d="M25,0C11.215,0,0,11.215,0,25s11.215,25,25,25s25-11.215,25-25S38.785,0,25,0z M25,1.9
														...
														C37.38,45.396,31.502,48.1,25,48.1z"></path>
												</svg>
												<span class="appear-animation" data-appear-animation="fadeInDown" data-appear-animation-delay="3700">Connect with people</span>
												<svg version="1.1" id="dashed-line-1" class="dashed-line _left" x="0px" y="0px" width="98.5px" height="26.5px" viewbox="0 0 98.5 26.5" enable-background="new 0 0 98.5 26.5" xml:space="preserve">
													<path class="line" data-appear-animation="line-anim" data-appear-animation-duration="1000ms" data-appear-animation-delay="2000" fill="none" stroke="#010101" stroke-miterlimit="10" stroke-dasharray="3,3" d="M4,16.93c0,0,40.589-36.872,83.192,1.084"></path>
													...
													<circle class="circle appear-animation" data-appear-animation="line-circle-anim" data-appear-animation-duration="700ms" data-appear-animation-delay="2700" fill="none" stroke="#010101" stroke-miterlimit="10" stroke-dasharray="3,3" cx="91.01" cy="21.014" r="4.627"></circle>
												...
												<svg version="1.1" id="dashed-line-2" class="dashed-line _right" x="0px" y="0px" width="98.5px" height="26.5px" viewbox="0 0 98.5 26.5" enable-background="new 0 0 98.5 26.5" xml:space="preserve">
													<path class="line" data-appear-animation="line-anim" data-appear-animation-duration="1s" data-appear-animation-delay="4000" fill="none" stroke="#010101" stroke-miterlimit="10" stroke-dasharray="3,3" d="M4,9.57c0,0,40.589,36.871,83.192-1.084"></path>
													...
													<circle class="circle appear-animation" data-appear-animation="line-circle-anim" data-appear-animation-duration="1000ms" data-appear-animation-delay="4700" fill="none" stroke="#010101" stroke-miterlimit="10" stroke-dasharray="3,3" cx="91.01" cy="5.486" r="4.627"></circle>
										...
										<div class="custom-box-icon">
											<svg version="1.1" id="share" x="0px" y="0px" width="65px" height="65px" viewbox="0 0 50 50" enable-background="new 0 0 50 50" xml:space="preserve">
												<path class="icon appear-animation" data-appear-animation="icons-anim" data-appear-animation-duration="3000ms" data-appear-animation-delay="3500" fill="#F1645B" d="M32,27c-1.923,0-3.577,1.104-4.413,2.699l-4.625-1.321C22.972,28.251,23,28.129,23,28
													...
													S19.654,31,18,31z M32,35c-1.654,0-3-1.346-3-3s1.346-3,3-3s3,1.346,3,3S33.654,35,32,35z"></path>
												<circle class="icons-circle appear-animation" data-appear-animation="icons-circle-anim" data-appear-animation-duration="1000ms" data-appear-animation-delay="5300" fill="none" stroke="#F1645B" stroke-width="2" stroke-miterlimit="50" cx="25.027" cy="25.092" r="24.062"></circle>
											</svg>
											<span class="appear-animation" data-appear-animation="fadeInDown" data-appear-animation-delay="5800">Share result</span>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="col">
								<div class="row counters counters-text-dark custom-counters-style-1">
									<div class="col-sm-4 col-lg-4 col-lg-2 m-auto">
										@include('porto.partials.counter.counter-4')
									</div>
									<div class="col-sm-4 col-lg-4 col-lg-2 m-auto">
										@include('porto.partials.counter.counter-5')
									</div>
									<div class="col-sm-4 col-lg-4 col-lg-2 m-auto">
										@include('porto.partials.counter.counter-6')
									</div>
								</div>
							</div>
						</div>
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-md-8 col-lg-6 m-auto">
								@include('porto.partials.feature-box.feature-box')
							</div>
							<div class="col-md-8 col-lg-6 m-auto">
								@include('porto.partials.feature-box.feature-box-1')
							</div>
						</div>
						<div class="row">
							<div class="col-md-8 col-lg-6 m-auto">
								@include('porto.partials.feature-box.feature-box-2')
							</div>
							<div class="col-md-8 col-lg-6 m-auto">
								@include('porto.partials.feature-box.feature-box-3')
							</div>
						</div>
						<div class="row">
							<div class="col-md-8 col-lg-6 m-auto">
								@include('porto.partials.feature-box.feature-box-4')
							</div>
							<div class="col-md-8 col-lg-6 m-auto">
								@include('porto.partials.feature-box.feature-box-5')
							</div>
						</div>
						<div class="row">
							<div class="col-md-8 col-lg-6 m-auto">
								@include('porto.partials.feature-box.feature-box-6')
							</div>
							<div class="col-md-8 col-lg-6 m-auto">
								@include('porto.partials.feature-box.feature-box-7')
							</div>
						</div>
						<hr class="solid custom-tall">
						<div class="row mb-5 pb-5 justify-content-center">
							<div class="col-lg-5 text-center">
								<img src="img/demos/app-landing/product/features-product-image-1.png" data-appear-animation="fadeInLeft" data-appear-animation-delay="300" data-plugin-options="{'accY': 200}" alt class="img-fluid">
							</div>
							<div class="col-md-10 col-lg-7 text-center text-lg-left">
								<h2 class="custom-bar _left text-color-dark">Very Active Community</h2>
								<p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Mollitia earum unde reprehenderit blanditiis eveniet pariatur quaerat veniam, optio repudiandae quis dignissimos nesciunt doloremque, eligendi aliquam dolores. Voluptatum tempore nemo unde incidunt, cum quod magnam molestias!</p>
						...
						<div class="row justify-content-center">
							<div class="col-md-10 col-lg-7 order-2 order-lg-1 text-center text-lg-right">
								...
								<p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum ad, fugiat consequuntur repudiandae soluta assumenda reprehenderit, rem totam incidunt impedit tempora veniam sit minus unde eaque illum, ratione eius dicta animi! Tempora quod itaque obcaecati.</p>
							...
							<div class="col-lg-5 order-1 order-lg-2 text-center">
								<img src="img/demos/app-landing/product/features-product-image-2.png" data-appear-animation="fadeInRight" data-appear-animation-delay="300" data-plugin-options="{'accY': 200}" alt class="img-fluid">
							</div>
						</div>
					</div>
				</section>
					...
					<div class="container">
						<div class="row">
							<div class="col text-center">
								...
								@include('porto.partials.owl-carousel.owl-carousel-5')
							</div>
						</div>
					</div>
				</section>
