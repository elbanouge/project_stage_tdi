...
<div role="main" class="main shop pt-4">
				...
				<div class="container">
					...
					<div class="row">
								...
								<div class="products product-thumb-info-list" data-plugin-masonry data-plugin-options="{'layoutMode': 'fitRows'}">
									...
									<div class="row align-items-center">
										<div class="col-sm-5 mb-4 mb-sm-0">
											@include('porto.partials.product.product-12')
										</div>
										<div class="col-sm-7">
											<div class="summary entry-summary">
												...
												<div class="pb-0 clearfix d-flex align-items-center">
													...
													<div class="review-num">
														<a href="shop-product-sidebar-left.html#description" class="text-decoration-none text-color-default text-color-hover-primary" data-hash data-hash-offset="75" data-hash-trigger-click=".nav-link-reviews" data-hash-trigger-click-delay="1000">
									...
									<div class="row align-items-center">
										<div class="col-sm-5 mb-4 mb-sm-0">
											@include('porto.partials.product.product-13')
										</div>
										<div class="col-sm-7">
											<div class="summary entry-summary">
									...
									<div class="row align-items-center">
										<div class="col-sm-5 mb-4 mb-sm-0">
											@include('porto.partials.product.product-14')
										</div>
										<div class="col-sm-7">
											<div class="summary entry-summary">
									...
									<div class="row align-items-center">
										<div class="col-sm-5 mb-4 mb-sm-0">
											@include('porto.partials.product.product-15')
										</div>
										<div class="col-sm-7">
											<div class="summary entry-summary">
									...
									<div class="row align-items-center">
										<div class="col-sm-5 mb-4 mb-sm-0">
											@include('porto.partials.product.product-16')
										</div>
										<div class="col-sm-7">
											<div class="summary entry-summary">
									...
									<div class="row align-items-center">
										<div class="col-sm-5 mb-4 mb-sm-0">
											@include('porto.partials.product.product-17')
										</div>
										<div class="col-sm-7">
											<div class="summary entry-summary">
									...
									<div class="row align-items-center">
										<div class="col-sm-5 mb-4 mb-sm-0">
											@include('porto.partials.product.product-18')
										</div>
										<div class="col-sm-7">
											<div class="summary entry-summary">
									...
									<div class="row align-items-center">
										<div class="col-sm-5 mb-4 mb-sm-0">
											@include('porto.partials.product.product-19')
										</div>porto.partials
										<div class="col-sm-7">
											<div class="summary entry-summary">
												...
												<div porto.partials d-flex align-items-center">
													<div title="Rated 3 out of 5" class="float-left">
														<input type="text" class="d-none" value="3" title="" data-plugin-star-rating data-plugin-options="{'displayOnly': true, 'color': 'primary', 'size':'xs'}">
													</div>
						...
						<div class="col-lg-3">
							@include('porto.partials.sidebar.sidebar-64')
						</div>
					</div>
				</div>
				...
				<div class="container">
					<div class="row py-4 my-5">
						...
						<div class="col-md-6 col-lg-3 mb-5 mb-md-0">
							...
							<ul clasporto.partialsd list-inline mb-0">
