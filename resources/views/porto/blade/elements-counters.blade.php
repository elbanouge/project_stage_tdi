...
<div role="main" class="main">
						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Counters</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Counters</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">The counter plugin is very useful when you need highlight your website numbers. Play with the ready styles and plugin options.</p>
				...
				<div id="examples" class="container py-2">
					...
					<div class="row">
						<div class="col">
							...
							<h4>Default<porto.partials

							<div class="row counters text-dark">
								<div class=porto.partialsb-4 mb-lg-0">
									@include('porto.partials.counter.counter-79')
								</div>
								<div class=porto.partialsb-4 mb-lg-0">
									@include('porto.partials.counter.counter-80')
								</div>
								<div class=porto.partialsb-4 mb-sm-0">
									@include('porto.partials.counter.counter-81')
								</div>
								<div class="col-sm-6 col-lg-3">
									@include('porto.partials.counter.counter-82')
								</div>
							</div>

							<hr class="solid my-5">

							<h4>Sizes</hporto.partials
							...
							<div class="row mb-4 counters text-dark">
								<div class=porto.partialsb-4 mb-lg-0">
									@include('porto.partials.counter.counter-79')
								</div>
								<div class=porto.partialsb-4 mb-lg-0">
							...
							<div class="row mb-4 counters counters-lg text-dark">
								<div class=porto.partialsb-4 mb-lg-0">
									@include('porto.partials.counter.counter-79')
								</div>
								<div class=porto.partialsb-4 mb-lg-0">
							...
							<h4>Colors</porto.partials

							<div class="row counters">
								<div class=porto.partialsb-4 mb-lg-0">
									@include('porto.partials.counter.counter-95')
								</div>
								<div class=porto.partialsb-4 mb-lg-0">
									@include('porto.partials.counter.counter-96')
								</div>
								<div class=porto.partialsb-4 mb-sm-0">
									@include('porto.partials.counter.counter-97')
								</div>
								<div class="col-sm-6 col-lg-3">
									@include('porto.partials.counter.counter-98')
								</div>
							</div>
				...
				<section classporto.partialsfault">
					<div class="container">
						<div class="row counters counters-text-dark">
							<div class=porto.partialsb-4 mb-lg-0">
								@include('porto.partials.counter.counter-99')
							</div>
							<div class=porto.partialsb-4 mb-lg-0">
								@include('porto.partials.counter.counter-100')
							</div>
							<div class=porto.partialsb-4 mb-sm-0">
								@include('porto.partials.counter.counter-101')
							</div>
							<div class="col-sm-6 col-lg-3">
								@include('porto.partials.counter.counter-102')
							</div>
						</div>
					</div>
				</section>

				<section classporto.partialsimary">
					<div class="container">
				...
				<section classporto.partialsection-text-light section-parallax section-center mt-0" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="img/parallax/parallax-2.jpg">
					<div class="container">
						<div class="row counters counters-text-light">
							<div class=porto.partialsb-4 mb-lg-0">
								@include('porto.partials.counter.counter-107')
							</div>
							<div class=porto.partialsb-4 mb-lg-0">
								@include('porto.partials.counter.counter-108')
							</div>
							<div class=porto.partialsb-4 mb-sm-0">
								@include('porto.partials.counter.counter-109')
							</div>
							<div class="col-sm-6 col-lg-3">
								@include('porto.partials.counter.counter-110')
							</div>
						</div>
					</div>
				</section>
				...
				<div class="container">
					...
					<div class="row">
						<div class="col">
							...
							<h4>With Icoporto.partials

							<div class="row counters">
								<div class=porto.partialsb-4 mb-lg-0">
									@include('porto.partials.counter.counter-111')
								</div>
								<div class=porto.partialsb-4 mb-lg-0">
									@include('porto.partials.counter.counter-112')
								</div>
								<div class=porto.partialsb-4 mb-sm-0">
									@include('porto.partials.counter.counter-113')
								</div>
								<div class="col-sm-6 col-lg-3">
									@include('porto.partials.counter.counter-114')
								</div>
							</div>

							<hr class="solid my-5">

							<h4>Animatioporto.partials

							<div class="row counters">
								<div class=porto.partialsb-4 mb-lg-0">
									@include('porto.partials.counter.counter-115')
								</div>
								<div class=porto.partialsb-4 mb-lg-0">
									@include('porto.partials.counter.counter-116')
								</div>
								<div class=porto.partialsb-4 mb-sm-0">
									@include('porto.partials.counter.counter-117')
								</div>
								<div class="col-sm-6 col-lg-3">
									@include('porto.partials.counter.counter-118')
								</div>
							</div>

							<hr class="solid my-5">
							
							<h4>Borders<porto.partials
							...
							<div class="row counters with-borders">
								...
								<div class=porto.partialsb-4 mb-lg-0">
									@include('porto.partials.counter.counter-120')
								</div>
								<div class=porto.partialsb-4 mb-sm-0">
									@include('porto.partials.counter.counter-121')
								</div>
								<div class="col-sm-6 col-lg-3">
									@include('porto.partials.counter.counter-122')
								</div>
							</div>
							...
							<div class="roporto.partials
								<div class="col">
									<div class="row counters">
										<div class=porto.partialsb-4 mb-lg-0">
											@include('porto.partials.counter.counter-123')
										</div>
										<div class=porto.partialsb-4 mb-lg-0">
											@include('porto.partials.counter.counter-124')
										</div>
										<div class=porto.partialsb-4 mb-sm-0">
											@include('porto.partials.counter.counter-125')
										</div>
										<div class="col-sm-6 col-lg-3">
											@include('porto.partials.counter.counter-126')
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row mb-4">
								<div class="cporto.partials
									<h4>Options</h4>
									<div class="row counters">
										<div class=porto.partials-0">
											@include('porto.partials.counter.counter-127')
										</div>
										<div class="col-lg-6">
											@include('porto.partials.counter.counter-128')
										</div>
									</div>
								</div>
								<div class="col-lg-5">
									...
									<div class="row">
										<div class="col">
											<p>Porto has more than <strong data-to="40000" data-plugin-counter data-plugin-options="{'speed': 3500}">0</strong> happy customers.</p>

											<p>Porto has more than <strong class="alternative-font" data-to="40000" data-plugin-counter data-plugin-options="{'speed': 3500}">0</strong> happy customers.</p>
										</div>
									</div>
								</div>
							</div>
