...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-277')
					...
					<div id="combinationFilters" class="filters mb-5">
						...
						<div class="row">
							<div class="col-lg-6">
								...
								<h5 class="text-uppercase mb-3">Filter By Type:</h5>
								<ul class="nav nav-pills sort-source sort-source-style-3 portfolio-filter-group" data-filter-group="group1">
									...
									<li classporto.partialsion-value=".websites"><a class="nav-link text-1 text-uppercase" href="#">Websites</a></li>
									...
									<li classporto.partialsion-value=".medias"><a class="nav-link text-1 text-uppercase" href="#">Medias</a></li>
								</ul>

							</div>porto.partials
							<div class="col-lg-6">

								<h5 class=porto.partials">Filter By Size:</h5>
								<ul class="nav nav-pills sort-source sort-source-style-3 portfolio-filter-group" data-filter-group="group2">
									<li data-option-value="" class="nav-item active"><a class="nav-link text-1 text-uppercase active" href="#">Show All</a></li>
									<li classporto.partialsion-value=".small"><a class="nav-link text-1 text-uppercase" href="#">Small</a></li>
									<li class="nav-item" data-option-value=".medium"><a class="nav-link text-1 text-uppercase" href="#">Medium</a></li>
									<li class="nav-item" data-option-value=".big"><a class="nav-link text-1 text-uppercase" href="#">Big</a></li>
								</ul>porto.partials
...
porto.partials
					<div class="sort-destination-loader sort-destination-loader-showing">				
						<div class="row portfolio-list">
							...
							<div class="col-sm-6 col-lg-3 isotope-item brands small">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-205'])
							</div>

							<div class=porto.partialssotope-item medias small">
								@include('porto.partials.portfolio-item.portfolio-item-206')
							</div>
porto.partials
							<div class="col-sm-6 col-lg-3 isotope-item logos medium">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-207'])
							</div>

							<div class="col-sm-6 col-lg-3 isotope-item websites medium">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-208'])
							</div>

							<div class="col-sm-6 col-lg-3 isotope-item logos medium">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-209'])
							</div>

							<div class="col-sm-6 col-lg-3 isotope-item brands big">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-210'])
							</div>

							<div class="col-sm-6 col-lg-3 isotope-item websites big">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-211'])
							</div>

							<div class="col-sm-6 col-lg-3 isotope-item medias big">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-212'])
							</div>

							<div class="col-sm-6 col-lg-3 isotope-item logos small">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-213'])
							</div>

							<div class="col-sm-6 col-lg-3 isotope-item websites big">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-214'])
							</div>

							<div class="col-sm-6 col-lg-3 isotope-item medias medium">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-215'])
							</div>

							<div class="col-sm-6 col-lg-3 isotope-item websites small">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-216'])
							</div>
