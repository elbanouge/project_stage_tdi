						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Star Ratings</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Star Ratings</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">Powered by bootstrap star rating plugin, we adapt the plugin in a easy way initialize trough HTML without the need of custom JS code.</p>
						...
						<div class="col">
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										...
										<p class="m-0">This is the default star rating style.</p>
									</div>
								...
								<div class="col-sm-9">
									...
									<div class="d-block pb-2">
										<input type="text" class="rating-invisible" value="5" title="" data-plugin-star-rating data-plugin-options="{'color': 'dark', 'size':'xs'}">
									</div>
							...
							<div class="row align-items-center mt-5">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										...
										<p class="m-0">These are the color options for star rating.</p>
									</div>
								...
								<div class="col-sm-9">
									...
									<div class="d-block pb-2">
										<input type="text" class="rating-invisible" value="1" title="" data-plugin-star-rating data-plugin-options="{'color': 'dark', 'size':'xs'}">
									</div>

									<div class="d-block pb-2">
										<input type="text" class="rating-invisible" value="2" title="" data-plugin-star-rating data-plugin-options="{'color': 'primary', 'size':'xs'}">
									</div>

									<div class="d-block pb-2">
										<input type="text" class="rating-invisible" value="3" title="" data-plugin-star-rating data-plugin-options="{'color': 'secondary', 'size':'xs'}">
									</div>
									...
									<div class="d-block pb-2">
										<input type="text" class="rating-invisible" value="5" title="" data-plugin-star-rating data-plugin-options="{'color': 'quaternary', 'size':'xs'}">
									</div>
							...
							<div class="row align-items-center mt-5">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">Caption</h4>
										<p class="m-0">You can add captions for star rating.</p>
									</div>
								...
								<div class="col-sm-9">
									...
									<div class="d-block pb-2">
										<input type="text" class="rating-invisible" value="5" title="" data-plugin-star-rating data-plugin-options="{'showCaption': true, 'color': 'dark', 'size':'sm'}">
									</div>
							...
							<div class="row align-items-center mt-5">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">Clear</h4>
										<p class="m-0">You can add clear button for star rating.</p>
									</div>
								...
								<div class="col-sm-9">
									...
									<div class="d-block pb-2">
										<input type="text" class="rating-invisible" value="5" title="" data-plugin-star-rating data-plugin-options="{'showClear': true, 'color': 'dark', 'size':'sm'}">
									</div>
							...
							<div class="row align-items-center mt-5">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">Step 0.1</h4>
										<p class="m-0">Step to increment the rating when each star is clicked.</p>
									</div>
							...
							<div class="row align-items-center mt-5">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">Display Only</h4>
										<p class="m-0">You can set the stars to be display only.</p>
									</div>
							...
							<div class="row align-items-center mt-5">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										...
										<p class="m-0">These are the size options for the star rating.</p>
									</div>
								...
								<div class="col-sm-9">
									...
									<div class="d-block pb-2">
										<input type="text" class="rating-invisible" value="1" title="" data-plugin-star-rating data-plugin-options="{'color': 'dark', 'size':'xl'}">
									</div>
									<div class="d-block pb-2">
										<input type="text" class="rating-invisible" value="2" title="" data-plugin-star-rating data-plugin-options="{'color': 'dark', 'size':'lg'}">
									</div>
									<div class="d-block pb-2">
										<input type="text" class="rating-invisible" value="3" title="" data-plugin-star-rating data-plugin-options="{'color': 'dark', 'size':'md'}">
									</div>
									<div class="d-block pb-2">
										<input type="text" class="rating-invisible" value="4" title="" data-plugin-star-rating data-plugin-options="{'color': 'dark', 'size':'sm'}">
									</div>
									<div class="d-block pb-2">
										<input type="text" class="rating-invisible" value="5" title="" data-plugin-star-rating data-plugin-options="{'color': 'dark', 'size':'xs'}">
									</div>
