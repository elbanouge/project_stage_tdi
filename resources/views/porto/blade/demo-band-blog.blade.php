...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-66')

				<div class="container container-lg-custom">
					<div class="row justify-content-md-center pb-1">
						<div class="col-lg-4 mb-5 mb-lg-0 pb-2">
							<div class="custom-card-style-1 card rounded-0 hover-effect-1 mb-4">
						...
						<div class="col-lg-4 mb-5 mb-lg-0 pb-2">
							<div class="custom-card-style-1 card rounded-0 hover-effect-1 mb-4">
								<div class="custom-card-img-top-wrapper">
									...
									<a href="demo-band-blog-post.html"><img class="card-img-top" src="img/demos/band/blog/blog-4.jpg" alt=""></a>
								</div>
								<div class="card-body p-5">
									<h4 class="card-title font-weight-bold text-5 mb-3"><a href="demo-band-blog-post.html" class="text-decoration-none text-color-light">Top Artists of 2021</a></h4>
									<p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eget risus porta...</p>
								</div>
							</div>
						</div>
						<div class="col-lg-4 mb-5 mb-lg-0 pb-2">
							<div class="custom-card-style-1 card rounded-0 hover-effect-1 mb-4">
								<div class="custom-card-img-top-wrapper">
									...
									<a href="demo-band-blog-post.html"><img class="card-img-top" src="img/demos/band/blog/blog-5.jpg" alt=""></a>
								</div>
								<div class="card-body p-5">
									<h4 class="card-title font-weight-bold text-5 mb-3"><a href="demo-band-blog-post.html" class="text-decoration-none text-color-light">What a Band Plays</a></h4>
									<p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed eget risus porta...</p>
								</div>
							</div>
						</div>
