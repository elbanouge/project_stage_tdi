...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-263')
...
porto.partials
					<div class="row pt-2">
						...
						<div class="col-lg-9 order-1 order-lg-2">
							...
							<h2 class="font-weight-normal text-7 mb-2"><strong class="font-weight-extra-bold">Left</strong> Width Page</h2>
