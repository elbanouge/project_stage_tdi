...
porto.partials
				@include('porto.partials.page-header.page-header-296')
					...
					<div class="sort-destination-loader sort-destination-loader-showing mt-4 pt-2">
						<div class="row portfolio-list sort-destination" data-sort-id="portfolio">
							...
							<div class="col-md-6 col-lg-1-5 isotope-item brands">
								@include('porto.partials.portfolio-item.portfolio-item-289')
							</div>

							<div class="col-md-6 col-lg-1-5 isotope-item medias">
								@include('porto.partials.portfolio-item.portfolio-item-290')
							</div>

							<div class="col-md-6 col-lg-1-5 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-291')
							</div>

							<div class="col-md-6 col-lg-1-5 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-292')
							</div>

							<div class="col-md-6 col-lg-1-5 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-293')
							</div>

							<div class="col-md-6 col-lg-1-5 isotope-item brands">
								@include('porto.partials.portfolio-item.portfolio-item-294')
							</div>

							<div class="col-md-6 col-lg-1-5 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-295')
							</div>

							<div class="col-md-6 col-lg-1-5 isotope-item medias">
								@include('porto.partials.portfolio-item.portfolio-item-296')
							</div>

							<div class="col-md-6 col-lg-1-5 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-297')
							</div>

							<div class="col-md-6 col-lg-1-5 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-298')
							</div>
