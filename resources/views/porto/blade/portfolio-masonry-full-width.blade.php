...
<div role="main" porto.partials
				...
				@include('porto.partials.page-header.page-header-298')
porto.partials
				<div class="container py-2">

					<ul class="nporto.partialsurce sort-source-style-3 justify-content-center" data-sort-id="portfolio" data-option-key="filter" data-plugin-options="{'layoutMode': 'masonry', 'filter': '*'}">
						...
						<li class="porto.partialsn-value=".logos"><a class="nav-link text-1 text-uppercase" href="#">Logos</a></li>
...
porto.partials
				<div class="sort-destination-loader sort-destination-loader-showing mt-4 pt-2">
					<div class="row portfolio-list sort-destination mb-5" data-sort-id="portfolio">
						porto.partials

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 brands">
							@include('porto.partials.portfolio-item.portfolio-item-311')
						</div>

						<div class=porto.partials isotope-item m-0 p-0 medias">
							@include('porto.partials.portfolio-item.portfolio-item-312')
						</div>
porto.partials
						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 logos">
							@include('porto.partials.portfolio-item.portfolio-item-313')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 websites">
							@include('porto.partials.portfolio-item.portfolio-item-314')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 logos">
							@include('porto.partials.portfolio-item.portfolio-item-315')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 brands">
							@include('porto.partials.portfolio-item.portfolio-item-316')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 websites">
							@include('porto.partials.portfolio-item.portfolio-item-317')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 medias">
							@include('porto.partials.portfolio-item.portfolio-item-318')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 logos">
							@include('porto.partials.portfolio-item.portfolio-item-319')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 websites">
							@include('porto.partials.portfolio-item.portfolio-item-320')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 medias">
							@include('porto.partials.portfolio-item.portfolio-item-321')
						</div>

						<div class="col-md-6 col-lg-1-5 isotope-item m-0 p-0 websites">
							@include('porto.partials.portfolio-item.portfolio-item-322')
						</div>
