...
<div role="main" class="main">
						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Maps</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Maps</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">A simple and easy way for add maps to your website. Easy to configure trough the template files and documentation.</p>
				...
				<!-- Full Width -->
				@include('porto.partials.google-map.google-map-27')
				...
				<div class="container">
					...
					<div class="row">
						<div class="col">
							<h4>Animated Pin (Pulse)</h4>
							@include('porto.partials.google-map.google-map-28')
						</div>
					</div>
					...
					<div class="row">
						<div class="col">
							<h4>Full Width (Inside Container)</h4>
							@include('porto.partials.google-map.google-map-29')
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-6">
							<h4>Markers</h4>
							@include('porto.partials.google-map.google-map-30')
						</div>
						<div class="col-lg-6">
							<h4>Custom Controls</h4>
							@include('porto.partials.google-map.google-map-31')
						</div>
					</div>
					...
					<div class="row">
						<div class="col-lg-6">
							<h4>Custom Style</h4>
							@include('porto.partials.google-map.google-map-32')
						</div>
						<div class="col-lg-6">
							<h4>Borders</h4>
							<div class="google-map-borders">
								@include('porto.partials.google-map.google-map-33')
							</div>
						</div>
					</div>
							...
							<div class="row">
								<div class="col">
									...
									<div class="float-left mr-4 mb-2" style="width: 280px;">
										@include('porto.partials.google-map.google-map-34')
									</div>
