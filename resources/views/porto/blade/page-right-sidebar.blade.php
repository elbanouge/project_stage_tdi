...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-265')
				...
				<div class="container pt-3 pb-2">
					...
					<div class="row pt-2">
						<div class="col-lg-9">
							...
							<h2 class="font-weight-normal text-7 mb-2"><strong class="font-weight-extra-bold">Right</strong> Sidebar Page</h2>
