@extends('porto.app')
@section('header')
@include('porto.partials.header.header-90')
@endsection

@section('main')
<div role="maiporto.partials
				
				@include('porto.partials.page-header.page-header-134')
					...
					<div class="row pt-1 pb-4 mb-3">
						<div class="col">
							...
							<div class="row pt-4 pb-4">
								<div class="col-lg-4">
									@include('porto.partials.feature-box.feature-box-58')		
								</div>
								<div class="col-lg-4">
									@include('porto.partials.feature-box.feature-box-59')		
								</div>
								<div class="col-lg-4">
									@include('porto.partials.feature-box.feature-box-60')		
								</div>
							</div>
							...
							<div class="row pb-4 pt-4 mt-4">
								<div class="col-lg-3">
									<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="0">
										<img src="img/demos/education/courses/course-1.jpg" class="img-fluid mb-4" alt="">
									</div>
								</div>
								<div class="col-lg-3">
									<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="300">
										<img src="img/demos/education/courses/course-2.jpg" class="img-fluid mb-4" alt="">
									</div>
								</div>
								<div class="col-lg-3">
									<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">
										<img src="img/demos/education/courses/course-3.jpg" class="img-fluid mb-4" alt="">
									</div>
								</div>
								<div class="col-lg-3">
									<div class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="900">
										<img src="img/demos/education/courses/course-4.jpg" class="img-fluid mb-4" alt="">
									</div>
								</div>
							</div>
