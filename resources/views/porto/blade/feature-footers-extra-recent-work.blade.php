...
<footer id="footer">
					...
					<div class="row py-5 my-4">
						<div class="col-md-5 mb-4 mb-lg-0">
							<a href="index.html" class="logo pr-0 pr-lg-3">
								<img alt="Porto Website Template" src="img/logo-footer.png" class="mb-4 mt-1" height="32">
							</a>
							<p class="mt-2 mb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec eu pulvinar magna. Phasellus semper scelerisque purus, et semper nisl lacinia sit amet semper scelerisque purus, et semper nisl lacinia sit amet. Praesent venenatis turpis vitae purus semper...</p>
						...
						<div class="col-sm-8 col-md-4 mb-4 mb-lg-0">
							...
							@include('porto.partials.lightbox.lightbox-66')
						</div>
						<div class="col-sm-4 col-md-3">
							<h5 class="text-3 mb-3 mt-4 mt-sm-0">USEFUL LINKS</h5>
							<ul class="list list-icons list-icons-sm">
								<li><i class="fas fa-angle-right"></i><a href="#" class="link-hover-style-1 ml-1"> Our Services</a></li>
								<li><i class="fas fa-angle-right"></i><a href="#" class="link-hover-style-1 ml-1"> About Us</a></li>
								<li><i class="fas fa-angle-right"></i><a href="#" class="link-hover-style-1 ml-1"> Contact Us</a></li>
								<li><i class="fas fa-angle-right"></i><a href="#" class="link-hover-style-1 ml-1"> Get a Quote</a></li>
				...
				@include('porto.partials.footer-copyright.footer-copyright-56', ['key' => 'footer-copyright.footer-copyright-56'])
			</footer>
@endsection
