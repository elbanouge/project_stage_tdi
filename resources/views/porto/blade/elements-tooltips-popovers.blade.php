						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Tooltips &amp; Popovers</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Tooltips &amp; Popovers</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">Very useful to give more description to buttons or links trough mouseover/touch interaction.</p>
						...
						<div class="col">
							...
							<div class="row">
								<div class="col">
									...
									<p>Tight pants next level keffiyeh <a href="#" class="text-primary" data-toggle="tooltip" title="" data-original-title="Default Tooltip">you probably</a> haven't heard of them. Photo booth beard raw denim letterpress vegan messenger bag stumptown. Farm-to-table seitan, mcsweeney's fixie sustainable quinoa 8-bit american apparel <a href="#" class="text-primary" data-toggle="tooltip" title="" data-original-title="Another tooltip">have a</a> terry richardson vinyl chambray. Beard stumptown, cardigans banh mi lomo thundercats. Tofu biodiesel williamsburg marfa, four loko mcsweeney's cleanse vegan chambray. A really ironic artisan <a href="#" class="text-primary" data-toggle="tooltip" title="Another one here too">whatever keytar</a>, scenester farm-to-table banksy Austin <a href="#" class="text-primary" data-toggle="tooltip" title="The last tip!">twitter handle</a> freegan cred raw denim single-origin coffee viral.
									</p>
									...
									<div class="row">
										<div class="col">
											...
											<div class="text-center">
												<button type="button" class="btn btn-modern btn-primary m-3" data-toggle="tooltip" data-placement="top" title="Tooltip on top">
												Tooltip on Top
												</button>

												<button type="button" class="btn btn-modern btn-primary m-3" data-toggle="tooltip" data-placement="right" title="Tooltip on right">
												Tooltip on Right
												</button>

												<button type="button" class="btn btn-modern btn-primary m-3" data-toggle="tooltip" data-placement="bottom" title="Tooltip on bottom">
												Tooltip on Bottom
												</button>

												<button type="button" class="btn btn-modern btn-primary m-3" data-toggle="tooltip" data-placement="left" title="Tooltip on left">
												Tooltip on Left
												</button>
											</div>
									...
									<div class="row mb-3">
										<div class="col">
											...
											<div class="text-center">
												<button type="button" class="btn btn-modern btn-dark m-3" data-container="body" data-trigger="focus" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
												Popover on Top
												</button>

												<button type="button" class="btn btn-modern btn-dark m-3" data-container="body" data-trigger="focus" data-toggle="popover" data-placement="right" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
												Popover on Right
												</button>

												<button type="button" class="btn btn-modern btn-dark m-3" data-container="body" data-trigger="focus" data-toggle="popover" data-placement="bottom" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
												Popover on Bottom
												</button>

												<button type="button" class="btn btn-modern btn-dark m-3" data-container="body" data-trigger="focus" data-toggle="popover" data-placement="left" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
												Popover on Left
												</button>
											</div>
