@extends('porto.app')
@section('header')
@include('porto.partials.header.header-53')
@endsection

@section('main')
<div role="main" class="main">
				
				@include('porto.partials.page-header.page-header-103')
				...
				<div class="container pb-2 mb-5">
					...
					<div class="row appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">
						<div class="col">
							@include('porto.partials.owl-carousel.owl-carousel-36')
						</div>
					</div>
				</div>
				<div class="container mb-5">
					...
					<div class="row appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">
						<div class="col">
							@include('porto.partials.owl-carousel.owl-carousel-37')
						</div>
					</div>
				</div>
