				...
				<div class="container my-4">
					<div class="row py-5">
						<div class="col-md-5 col-lg-3 mb-5 mb-lg-0 pt-3">
							...
							<p class="text-4 mb-1">Porto Blvd, Suite</p>
							<p class="text-4 mb-1">Call: 123-456-7890</p>
							<p class="text-4 mb-0">Email: <a href="mailto:info@porto.com" class="text-color-primary">info@porto.com</a></p>
						</div>
						...
						<div class="col-lg-4 pt-3">
							<h5 class="text-6 text-transform-none font-weight-semibold text-color-light mb-4">Our Instagram</h5>
							<div clporto.partials data-type="basic"></div>
						</div>
					</div>
				</div>
