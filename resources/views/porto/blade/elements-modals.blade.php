						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Modals</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Modals</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">A simple and easy way to show hidden content in a popup trough a button.</p>
						...
						<div class="col">
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										...
										<p class="m-0">This is the default modal options without settings.</p>
									</div>
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">Optional Sizes</h4>
										<p class="m-0">You can change the size of the modal.</p>
									</div>
								...
								<div class="col-sm-9">
									...
									<button class="btn btn-modern btn-primary" data-toggle="modal" data-target="#smallModal">
										Launch Small Modal
									</button>
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">With Form</h4>
										<p class="m-0">Add forms in the content of the modal.</p>
									</div>
							...
							<div class="row align-items-center pb-4 mb-2">
								<div class="col-sm-3">

									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">No Animation</h4>
										<p class="m-0">Remove the animation of the modal.</p>
									</div>

								</div>
								<div class="col-sm-9">

									<button class="btn btn-modern btn-primary" data-toggle="modal" data-target="#noAnimModal">
										Launch Modal
									</button>
									...
									<div class="modal" id="noAnimModal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													<h4 class="modal-title" id="noAnimModalLabel">Remove Animation Modal Title</h4>
													<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
												</div>
												<div class="modal-body">
													<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque neque eget diam posuere porta. Quisque ut nulla at nunc <a href="#">vehicula</a> lacinia. Proin adipiscing porta tellus, ut feugiat nibh adipiscing sit amet. In eu justo a felis faucibus ornare vel id metus. Vestibulum ante ipsum primis in faucibus.</p>
