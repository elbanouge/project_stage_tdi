...
porto.partials
				@include('porto.partials.page-header.page-header-292')
...
porto.partials
					<div class="sort-destination-loader sort-destination-loader-showing pb-4 mt-4 pt-2">
						<div class="row portfolio-list no-gutters sort-destination" data-sort-id="portfolio">
							...
							<div class="col-sm-6 col-lg-4 isotope-item m-0 p-0 brands">
								@include('porto.partials.portfolio-item.portfolio-item-267')
							</div>

							<div class=porto.partialssotope-item m-0 p-0 medias">
								@include('porto.partials.portfolio-item.portfolio-item-268')
							</div>
porto.partials
							<div class="col-sm-6 col-lg-4 isotope-item m-0 p-0 logos">
								@include('porto.partials.portfolio-item.portfolio-item-269')
							</div>

							<div class="col-sm-6 col-lg-4 isotope-item m-0 p-0 websites">
							...
							<div class="col-sm-6 col-lg-4 isotope-item m-0 p-0 medias">
							...
							<div class="col-sm-6 col-lg-4 isotope-item m-0 p-0 medias">
								@include('porto.partials.portfolio-item.portfolio-item-277')
							</div>

							<div class="col-sm-6 col-lg-4 isotope-item m-0 p-0 websites">
								@include('porto.partials.portfolio-item.portfolio-item-278')
							</div>
