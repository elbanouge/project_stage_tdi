...
<div role="main" class="main">
						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Pricing Tables</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Pricing Tables</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">Simple, modern and intuitive way to show your product features and pricing.</p>
				...
				<div id="examples" class="container py-4">
					...
					@include('porto.partials.pricing-table.pricing-table-4')

					<div class="row mb-4">
						<div class="col">
							<hr class="solid my-5">
							<h4><strong>Three</strong> Plans</h4>
						</div>
					</div>

					@include('porto.partials.pricing-table.pricing-table-5')

					<div class="row mb-4">
						<div class="col">
							<hr class="tall my-5">
							<h4><strong>With Gap</strong> Style</h4>
						</div>
					</div>

					@include('porto.partials.pricing-table.pricing-table-6')

					<div class="row mb-4">
						<div class="col">
							<hr class="tall my-5">
							<h4><strong>Pricing Block</strong> Style</h4>
						</div>
					</div>
					...
					<div class="row">
						<div class="col">
							<div class="pricing-block border rounded">
								<div class="row">
									<div class="col-lg-9">
										<h2 class="font-weight-semibold text-6 line-height-1 mb-3">Start right now! The best HTML theme ever!</h2>
										<hr>
										<div class="row">
											<div class="col-lg-4">
												<ul class="list list-icons list-primary mb-0">
													<li><i class="icons icon-support text-color-primary"></i> Customer Support</li>
													<li><i class="icons icon-doc text-color-primary"></i> HTML5 / CSS3 / JS</li>
													<li class="mb-lg-0"><i class="icons icon-social-google text-color-primary"></i> 500+ Google Fonts</li>
												</ul>
											</div>
											<div class="col-lg-4">
												<ul class="list list-icons list-primary mb-0">
													<li><i class="icons icon-pencil text-color-primary"></i> Multiple Colors</li>
													<li><i class="icons icon-layers text-color-primary"></i> Ready Sliders</li>
													<li class="mb-lg-0"><i class="icons icon-user text-color-primary"></i> Tons of Icons</li>
												</ul>
											</div>
											<div class="col-lg-4">
												<ul class="list list-icons list-primary mb-0">
													<li><i class="icons icon-menu text-color-primary"></i> Buttons</li>
													<li><i class="icons icon-screen-desktop text-color-primary"></i> Lightbox</li>
													<li class="mb-0"><i class="icons icon-bubble text-color-primary"></i> Contact Forms</li>
												</ul>
											</div>
										</div>
									</div>
				...
				<section class="parallax section section-text-light section-parallax mt-0 mb-0" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="img/parallax/parallax-2.jpg">
					<div class="container py-5 my-5">
						@include('porto.partials.pricing-table.pricing-table-7')
					</div>
				</section>

				<section id="elements" class="section section-height-2 border-0 mt-0 mb-0 pt-5">
