@extends('porto.app')
@section('header')
@include('porto.partials.header.header-205')
@endsection
												...
												<div class=porto.partials
													<article>
														<div class="row">
															<div class="col-auto pr-0">
																<div class="date">
																	<span porto.partialsht-extra-bold">10</span>
																	<span class="month text-1">JAN</span>
																</div>
															</div>
															<div class="col pl-1">
				...
				<div class="container">
					<div class="row py-4 my-5">
						...
						<div class="col-md-6 col-lg-4 mb-5 mb-md-0">
							...
							<article>
								<a hrefporto.partialsass="text-color-light text-3-5">Best Practices for Top UI Design</a>
								<p class="line-height-2 mb-0"><a href="#">Nov 25, 2020</a> in <a href="#">Design,</a> <a href="#">Coding</a></p>
							</article>
						</div>
