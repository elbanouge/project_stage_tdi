...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-19')
							...
							<div class="blog-posts blog-posts-no-margins">
								...
								<div class="masonry-loader masonry-loader-showing">
									<div class="masonry row" data-plugin-masonry data-plugin-options="{'itemSelector': '.masonry-item'}">
										...
										<div class=porto.partialsault-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5 p-0">
											@include('porto.partials.post.post-86')
										</div>
porto.partials
										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5 p-0">
											@include('porto.partials.post.post-87')
										</div>porto.partials

										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5 p-0">
											@include('porto.partials.post.post-88')
										</div>

										<div class=porto.partialsault-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5 p-0">
											@include('porto.partials.post.post-89')
										</div>
porto.partials
										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5 p-0">
											@include('porto.partials.post.post-90')
										</div>porto.partials

										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5 p-0">
											@include('porto.partials.post.post-91')
										</div>

										<div class=porto.partialsault-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5 p-0">
											@include('porto.partials.post.post-92')
										</div>
porto.partials
										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5 p-0">
											@include('porto.partials.post.post-93')
										</div>porto.partials

										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5 p-0">
											@include('porto.partials.post.post-94')
										</div>

										<div class=porto.partialsault-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5 p-0">
											@include('porto.partials.post.post-95')
										</div>
porto.partials
										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5 p-0">
											@include('porto.partials.post.post-96')
										</div>porto.partials

										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5 p-0">
											@include('porto.partials.post.post-97')
										</div>

										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5 p-0">
											@include('porto.partials.post.post-98')
										</div>

										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5 p-0">
											@include('porto.partials.post.post-99')
										</div>

										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5 p-0">
											@include('porto.partials.post.post-100')
										</div>porto.partials
