...
<div role="main" class="main">
						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Testimonials</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Testimonials</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">Show your clients testimonials with an unique and beatiful design.</p>
				...
				<div id="examporto.partialser py-2">

					<div class="row">
						<div class=porto.partials
							@include('porto.partials.testimonial.testimonial-87')
						</div>
						<div class=porto.partials
							@include('porto.partials.testimonial.testimonial-88')
						</div>
						<div class="col-lg-4">
							@include('porto.partials.testimonial.testimonial-89')
						</div>
					</div>porto.partials

					<div class="row mt-lg-5">
						<div class=porto.partials
							@include('porto.partials.testimonial.testimonial-90')
						</div>
						<div class="col-lg-6">
							@include('porto.partials.testimonial.testimonial-91')
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-6">
							@include('porto.partials.testimonial.testimonial-93')
						</div>
					</div>porto.partials

					<div class="row mt-lg-5">
						<div class=porto.partials
							@include('porto.partials.testimonial.testimonial-94')
						</div>
						<div class="col-lg-6">
							@include('porto.partials.testimonial.testimonial-95')
						</div>
					</div>
					...
					<div class="roporto.partials
						<div class="col-lg-6">
							@include('porto.partials.owl-carousel.owl-carousel-180')
						</div>porto.partials
						<div class="col-lg-6">
							@include('porto.partials.owl-carousel.owl-carousel-181')
						</div>
					</div>
				</div>
				<section class="section section-height-3 bg-color-grey-scale-1 border-0 m-0 appear-animation" data-appear-animation="fadeIn">
					<div class="container">
						<div class="row">
							<div class="cporto.partials data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
								
								@include('porto.partials.owl-carousel.owl-carousel-182')
				...
				<section class="parallax section section-text-light section-parallax section-center mt-0 mb-0" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="img/parallax/parallax-2.jpg">
					<div class="container">
						<div class="roporto.partialsnter">
							<div class="col-lg-10">
								@include('porto.partials.owl-carousel.owl-carousel-183')
							</div>
						</div>
					</div>
				</section>
porto.partials
				<div class="container pb-2">
					<div class="row mb-3 pt-5">
						<div class=porto.partials
							@include('porto.partials.testimonial.testimonial-104')
						</div>
						<div class=porto.partials
							@include('porto.partials.testimonial.testimonial-104')
						</div>
