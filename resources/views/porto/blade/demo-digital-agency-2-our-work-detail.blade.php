@extends('porto.app')
@section('header')
@include('porto.partials.header.header-83')
@endsection

@section('main')
<div role="main" class="main">

				@include('porto.partials.page-header.page-header-132')
								...
								<div class="container py-5 mb-xl-5 p-relative z-index-2">
									<div class="row">
										<div class="col-xl-4">
											<div class="project-details pb-5">
												...
												<ul class="list-unstyled pl-0 pb-0 mb-0">
													...
													<li class="mb-4 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="300">
														<span class="text-color-quaternary custom-text-4"><strong class="text-color-dark">Year: </strong>2021</span>
													</li>
											...
											@include('porto.partials.sidebar.sidebar-19')
										</div>
										<div class="col-xl-8">
