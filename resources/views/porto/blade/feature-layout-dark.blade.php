@extends('porto.app')
@section('header')
@include('porto.partials.header.header-271')
@endsection
...
<div role="main" class="main">
				...
				<div class="container mb-5 pb-4">
						...
						<div class="col-lg-4">
							...
							<div class="accordion accordion-modern" id="accordion">
								<div class="card card-default">
									<div class="card-header">
										<h4 class="card-title m-0">
											<a class="accordion-toggle text-color-light font-weight-bold" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">
									...
									<div id="collapseOne" class="collapse show">
										<div class="card-body text-2">
											...
											<p class="mb-0">Adipiscing elit phasellus blanit ma... <a href="#" class="d-block text-color-light font-weight-semibold pt-4">read more <i class="fas fa-angle-right position-relative top-1 ml-1"></i></a></p>
										</div>
									</div>
								</div>
								<div class="card card-default">
									<div class="card-header">
										<h4 class="card-title m-0">
											<a class="accordion-toggle text-color-light font-weight-bold" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
								...
								<div class="card card-default">
									<div class="card-header">
										<h4 class="card-title m-0">
											<a class="accordion-toggle text-color-light font-weight-bold" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">
					...
					<div class="row text-center mt-5">
						@include('porto.partials.owl-carousel.owl-carousel-247')
					</div>
							...
							<div class="row mt-5 appear-animation" data-appear-animation="fadeInUpShorter">
								<div class="col-lg-6">
									<div class="recent-posts mb-5">
										...
										@include('porto.partials.owl-carousel.owl-carousel-248')
									</div>
								</div>
								<div class="col-lg-6">
									<h2 class="font-weight-normal text-6 mb-4"><strong class="font-weight-extra-bold">What</strong> Client’s Say</h2>
									<div class="row">
										@include('porto.partials.owl-carousel.owl-carousel-249')
									</div>
								</div>
							</div>
						</div>
