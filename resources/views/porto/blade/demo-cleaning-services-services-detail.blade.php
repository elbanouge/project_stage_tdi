@extends('porto.app')
@section('header')
@include('porto.partials.header.header-58')
@endsection

@section('main')
<div role="main" class="main">
				
				@include('porto.partials.page-header.page-header-110')
					...
					<div class="container my-lg-4">
						<div class="row">
							<div class="col-lg-8 order-lg-2 mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">
								...
								<img src="img/demos/cleaning-services/portfolio/portfolio-1.jpg" class="img-fluid float-left custom-max-width-1 my-3 mr-4" alt="">
								...
								<img src="img/demos/cleaning-services/portfolio/portfolio-2.jpg" class="img-fluid float-right custom-max-width-1 my-3 ml-4" alt="">
