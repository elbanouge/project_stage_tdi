...
porto.partials
				@include('porto.partials.page-header.page-header-285')
					...
					<div class="sort-destination-loader sort-destination-loader-showing mt-4 pt-2">
						<div class="row portfolio-list sort-destination" data-sort-id="portfolio">
							...
							<div class="col-md-6 isotope-item brands">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-217'])
							</div>

							<div class=porto.partialsem medias">
								@include('porto.partials.portfolio-item.portfolio-item-218')
							</div>
porto.partials
							<div class="col-md-6 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-219'])
							</div>porto.partials

							<div class="col-md-6 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-220'])
							</div>

							<div class="col-md-6 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-221'])
							</div>

							<div class="col-md-6 isotope-item brands">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-222'])
							</div>

							<div class="col-md-6 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-223'])
							</div>

							<div class="col-md-6 isotope-item medias">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-224'])
							</div>

							<div class="col-md-6 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-225'])
							</div>

							<div class="col-md-6 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-226'])
							</div>

							<div class="col-md-6 isotope-item medias">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-227'])
							</div>

							<div class="col-md-6 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-228'])
							</div>

							<div class="col-md-6 isotope-item brands">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-243'])
							</div>

							<div class="col-md-6 isotope-item brands">
								@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-244'])
							</div>
					...
					<div class="row py-4 my-5">
						...
						<div class="col-md-6 col-lg-2 mb-5 mb-lg-0">
							...
							<ul class="list list-unstyled mb-0">
								...
								<li claporto.partialsitemap.html">Sitemap</a></li>
							</ul>
						</div>
