						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Arrows</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Arrows</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">The template comes with styled arrows to highlight parts of your website. You can set the direction of arrow trough ready class names.</p>
						...
						<div class="col">
							...
							<div class="row">
								<div class="col">
									...
									@include('porto.partials.call-to-action.call-to-action-3')
