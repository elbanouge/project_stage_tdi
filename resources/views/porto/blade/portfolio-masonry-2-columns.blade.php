...
porto.partials
				@include('porto.partials.page-header.page-header-293')
					...
					<div class="sort-destination-loader sort-destination-loader-showing mt-4 pt-2">
						<div class="row portfolio-list sort-destination" data-sort-id="portfolio">
							...
							<div class="col-md-6 isotope-item brands">
								@include('porto.partials.portfolio-item.portfolio-item-279')
							</div>

							<div class="col-md-6 isotope-item medias">
								@include('porto.partials.portfolio-item.portfolio-item-280')
							</div>

							<div class="col-md-6 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-281')
							</div>

							<div class="col-md-6 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-282')
							</div>

							<div class="col-md-6 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-283')
							</div>

							<div class="col-md-6 isotope-item brands">
								@include('porto.partials.portfolio-item.portfolio-item-284')
							</div>

							<div class="col-md-6 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-285')
							</div>

							<div class="col-md-6 isotope-item medias">
								@include('porto.partials.portfolio-item.portfolio-item-286')
							</div>

							<div class="col-md-6 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-287')
							</div>

							<div class="col-md-6 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-288')
							</div>
