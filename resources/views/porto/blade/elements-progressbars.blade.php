								...
								<div class="col">
									...
									<div class="row">
										<div class="col-lg-4">
											...
											@include('porto.partials.progress.progress-36')

										</div>
										<div class="col-lg-4">

											@include('porto.partials.progress.progress-37')

										</div>
										<div class="col-lg-4">

											@include('porto.partials.progress.progress-38')
									...
									<div class="row">
										<div class="col-lg-6">
											...
											@include('porto.partials.progress.progress-39')
										...
										<div class="col-lg-6">
											...
											@include('porto.partials.progress.progress-40')
										</div>
									</div>
									...
									<div class="row">
										<div class="col-lg-4">
											...
											@include('porto.partials.progress.progress-41')

										</div>
										<div class="col-lg-4">

											@include('porto.partials.progress.progress-42')
									...
									<div class="row">
										...
										<div class="col-lg-3">
											...
											@include('porto.partials.progress.progress-44')

										</div>

										<div class="col-lg-3">

											@include('porto.partials.progress.progress-45')
										...
										<div class="col-lg-3">
											...
											@include('porto.partials.progress.progress-47')
									...
									@include('porto.partials.progress.progress-48')
									@include('porto.partials.progress.progress-49')
									@include('porto.partials.progress.progress-50')
									@include('porto.partials.progress.progress-51')
									
									<hr class="solid my-5">

									<h4>Modern</h4>

									@include('porto.partials.progress.progress-52')
									@include('porto.partials.progress.progress-53')
									@include('porto.partials.progress.progress-54')
									@include('porto.partials.progress.progress-55')
							...
							<div class="row">
								<div class="col-lg-6">
									...
									<div class="progress-bars mt-4">
										...
										@include('porto.partials.progress.progress-56')
										<div class="progress-label">
											<span class="text-1">Design</span>
										</div>
										@include('porto.partials.progress.progress-57')
										<div class="progress-label">
											<span class="text-1">WordPress</span>
										</div>
										@include('porto.partials.progress.progress-58')
										<div class="progress-label">
											<span class="text-1">Photoshop</span>
										</div>
										@include('porto.partials.progress.progress-59')
									</div>
								...
								<div class="col-lg-6">
									...
									<div class="progress-bars mt-4">
										...
										@include('porto.partials.progress.progress-60')
										<div class="progress-label">
											<span class="text-1">Secondary</span>
										</div>
										@include('porto.partials.progress.progress-61')
										<div class="progress-label">
											<span class="text-1">Tertiary</span>
										</div>
										@include('porto.partials.progress.progress-62')
										<div class="progress-label">
											<span class="text-1">Quaternary</span>
										</div>
										@include('porto.partials.progress.progress-63')
									</div>
								...
								<div class="col">
									...
									<div class="row">
										<div class="col-lg-4">
											...
											@include('porto.partials.circular-bar.circular-bar-1')

										</div>
										<div class="col-lg-4">

											@include('porto.partials.circular-bar.circular-bar-2')

										</div>
										<div class="col-lg-4">

											@include('porto.partials.circular-bar.circular-bar-3')
									...
									<div class="row">
										<div class="col-lg-4">
											...
											@include('porto.partials.circular-bar.circular-bar-4')
										...
										<div class="col-lg-4">
											...
											@include('porto.partials.circular-bar.circular-bar-6')
									...
									<div class="row">
										<div class="col-lg-4">
											...
											@include('porto.partials.circular-bar.circular-bar-7')

										</div>
										<div class="col-lg-4">

											@include('porto.partials.circular-bar.circular-bar-8')

										</div>
										<div class="col-lg-4">

											@include('porto.partials.circular-bar.circular-bar-9')
