...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-18')
							...
							<div class="blog-posts">
								...
								<div class="masonry-loader masonry-loader-showing">
									<div class="masonry row" data-plugin-masonry data-plugin-options="{'itemSelector': '.masonry-item'}">
										...
										<div class=porto.partialsault-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5">
											@include('porto.partials.post.post-71')
										</div>
porto.partials
										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5">
											@include('porto.partials.post.post-72')
										</div>porto.partials

										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5">
											@include('porto.partials.post.post-73')
										</div>

										<div class=porto.partialsault-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5">
											@include('porto.partials.post.post-74')
										</div>
porto.partials
										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5">
											@include('porto.partials.post.post-75')
										</div>porto.partials

										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5">
											@include('porto.partials.post.post-76')
										</div>

										<div class=porto.partialsault-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5">
											@include('porto.partials.post.post-77')
										</div>
porto.partials
										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5">
											@include('porto.partials.post.post-78')
										</div>porto.partials

										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5">
											@include('porto.partials.post.post-79')
										</div>

										<div class=porto.partialsault-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5">
											@include('porto.partials.post.post-80')
										</div>
porto.partials
										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5">
											@include('porto.partials.post.post-81')
										</div>porto.partials

										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5">
											@include('porto.partials.post.post-82')
										</div>

										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5">
											@include(porto.partialss.post.post-83')
										</div>

										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5">
											@include('porto.partials.post.post-84')
										</div>

										<div class="masonry-item no-default-style col-sm-6 col-md-4 col-lg-3 col-xl-1-5">
											@include('porto.partials.post.post-85')
										</div>
