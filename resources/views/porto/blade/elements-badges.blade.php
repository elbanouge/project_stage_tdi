						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Badges</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Badges</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">With badges you can create types of status to parts of your website.</p>
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										...
										<p class="m-0">These are the default badge style.</p>
									</div>
								...
								<div class="col-sm-9">
									...
									<span class="badge badge-danger badge-md">Danger</span>
									<span class="badge badge-warning badge-md">Warning</span>
									<span class="badge badge-info badge-md">Info</span>
									<span class="badge badge-light badge-md">Light</span>
									<span class="badge badge-dark badge-md">Dark</span>
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										...
										<p class="m-0">Select between any color you want.</p>
									</div>

								</div>
								<div class="col-sm-9">

									<span class="badge badge-primary text-light badge-md">Primary</span>
									<span class="badge badge-secondary text-light badge-md">Secondary</span>
									<span class="badge badge-tertiary text-light badge-md">Tertiary</span>
									<span class="badge badge-quaternary text-light badge-md">Quaternary</span>
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										...
										<p class="m-0">These are the sizes available for the badges.</p>
									</div>

								</div>
								<div class="col-sm-9">

									<span class="badge badge-primary badge-xs">Primary XS</span>
									<span class="badge badge-primary badge-sm">Primary SM</span>
									<span class="badge badge-primary badge-md">Primary MD</span>
									<span class="badge badge-primary badge-lg">Primary LG</span>
									<span class="badge badge-primary badge-xl">Primary XL</span>
							...
							<div class="row align-items-center pb-4">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										...
										<p class="m-0">Using the badges inside the headings.</p>
									</div>
