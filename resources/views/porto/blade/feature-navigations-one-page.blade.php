@extends('porto.app')
@section('header')
@include('porto.partials.header.header-303')
@endsection

@section('main')
<div role="main" class="main">

				@include('porto.partials.page-header.page-header-219')
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col">
							...
							<div id="section1" class="bg-primary text-light p-4 mb-3 text-center">Section 1</div>
							...
							<div id="section2" class="bg-primary text-light p-4 mb-3 text-center">Section 2</div>
							...
							<div id="section3" class="bg-primary text-light p-4 mb-3 text-center">Section 3</div>
							...
							<div id="section4" class="bg-primary text-light p-4 mb-3 text-center">Section 4</div>
							...
							<div id="section5" class="bg-primary text-light p-4 mb-3 text-center">Section 5</div>
