...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-25')
					...
					<div class="row">
						<div class="col-lg-9">
							<div class="blog-posts">
								...
								@include('porto.partials.post.post-109')

								@include('porto.partials.post.post-110')

								@include('porto.partials.post.post-111')
