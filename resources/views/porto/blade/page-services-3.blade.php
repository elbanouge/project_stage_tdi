...
<div role="main" class="main">
				@include('porto.partials.page-header.page-header-269')
					...
					<div class="cporto.partials
						<div class="row counters counters-sm counters-text-light">
							<div class="col-sm-6 col-lg-3 mb-5 mb-lg-0">
								@include('porto.partials.counter.counter-129')
							</div>
							<div class="col-sm-6 col-lg-3 mb-5 mb-lg-0">
								@include('porto.partials.counter.counter-130')
							</div>
							<div class="col-sm-6 col-lg-3 mb-5 mb-sm-0">
								@include('porto.partials.counter.counter-131')
							</div>
							<div class="col-sm-6 col-lg-3">
								@include('porto.partials.counter.counter-132')
							</div>
						</div>
					</div>
				</section>
				...
				<div class="cporto.partials
					<div class="row py-5 mt-5 mb-4">
						...
						<div class="col-md-6 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="400">
							@include('porto.partials.testimonial.testimonial-137')
						</div>
					</div>
				</div>
