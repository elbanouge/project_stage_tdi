@extends('porto.app')
@section('header')
@include('porto.partials.header.header-185')
@endsection
...
<div role="main" class="main">
				...
				<div class="container">
					<div class="row">
						<div class="col">
							...
							<div class="custom-box-details bg-color-darken custom-box-shadow-1 col-lg-6 ml-5 mb-5 mb-lg-4 float-right clearfix">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<ul class="custom-list-style-1 p-0 mb-0">
											<li>
												<span class="text-color-light">Skype:</span>
									...
									<article class="timeline-box right custom-box-shadow-2">
										<div class="row">
											<div class="experience-info col-lg-3 col-sm-5 bg-color-primary">
												...
												<p class="text-color-light">(3 Years 9 Months)</p>
												<span class="company text-color-light font-weight-semibold">
													Okler Themes
													<span class="company-location text-color-light font-weight-normal text-uppercase">Greater New York</span>
												</span>
											</div>
											<div class="experience-description col-lg-9 col-sm-7 bg-color-dark">
												<h4 class="text-color-light font-weight-semibold">Chief Product Officer</h4>
				...
				<div class="container">
					<div class="row">
						<div class="col">
							...
							@include('porto.partials.owl-carousel.owl-carousel-136')
						</div>
					</div>
				</div>
			</section>
								...
								<div class="col">
									<div class="custom-box-details bg-color-darken custom-box-shadow-1">
										...
										<ul class="custom-list-style-1 p-0">
											<li>
												<span class="font-weight-semibold custom-max-width-1 text-color-light"><img src="img/blank.gif" class="flag flag-us mr-1" alt="English">English:</span>
												<span class="custom-text-color-2">Advanced</span>
											</li>
											<li>
												<span class="font-weight-semibold custom-max-width-1 text-color-light"><img src="img/blank.gif" class="flag flag-es mr-1" alt="Spanish">Spanish:</span>
												<span class="custom-text-color-2">Advanced</span>
											</li>
											<li>
												<span class="font-weight-semibold custom-max-width-1 text-color-light"><img src="img/blank.gif" class="flag flag-fr mr-1" alt="Française">French:</span>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-12 p-0">
							@include('porto.partials.owl-carousel.owl-carousel-137')
						</div>
					</div>
				</div>
			</section>
						...
						<div class="col">
							...
							<div class="row">
								<div class="col-lg-6 mb-5 mb-lg-0">
									@include('porto.partials.thumb-info.thumb-info-375')
								</div>
								<div class="col-lg-6">
									@include('porto.partials.thumb-info.thumb-info-376')
								</div>
							</div>
						</div>
			...
			<footer id="footer" class="m-0 p-0">
				@include('porto.partials.footer-copyright.footer-copyright-35', ['key' => 'footer-copyright.footer-copyright-35'])
			</footer>
		</div>
@endsection
