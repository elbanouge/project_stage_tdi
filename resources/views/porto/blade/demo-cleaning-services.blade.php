@extends('porto.app')
@section('header')
@include('porto.partials.header.header-59')
@endsection
...
<div role="main" class="main">
				...
				<section class="section section-with-shape-divider section-parallax bg-tertiary border-0 m-0" data-plugin-parallax data-plugin-options="{'speed': 1.5, 'parallaxHeight': '110%', 'fadeIn': true}" data-image-src="img/demos/cleaning-services/backgrounds/background-1.jpg">
					...
					<div class="container position-relative z-index-1 pb-5 my-5">
						...
						<div class="row justify-content-center justify-content-lg-start pb-5 mb-5">
							<div class="col-md-10 col-lg-6 text-center text-lg-right pr-lg-4 pb-5 mb-5">
								...
								<a href="#whoweare" data-hash data-hash-offset="150" class="btn btn-secondary btn-modern font-weight-bold text-3 px-5 py-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="700">LEARN MORE</a>
							...
							<ul class="list list-unstyled mb-0">
								<li class="mb-4 mb-lg-2">
									<span class="d-flex align-items-center justify-content-end justify-content-lg-end flex-column flex-lg-row font-weight-medium text-4 text-lg-3 text-xl-4">
										...
										<strong class="text-7 mt-2 mt-lg-0 ml-lg-3">
					...
					<div class="row">
						<div class="col-6 col-xl-3 mb-5 mb-xl-0 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="200">
							<div class="d-flex align-items-center justify-content-center flex-column flex-xl-row text-center">
								...
								<h3 class="text-transform-none text-color-dark font-weight-bold mb-0 text-4 pl-1 ml-xl-2 mt-3 mt-xl-0">30/7 Cleaning Services</h3>
							</div>
						</div>
						<div class="col-6 col-xl-3 divider-left-border mb-5 mb-xl-0 appear-animation" data-appear-animation="fadeInLeftShorter">
							<div class="d-flex align-items-center justify-content-center flex-column flex-xl-row text-center">
								...
								<h3 class="text-transform-none text-color-dark font-weight-bold mb-0 text-4 px-2 px-sm-0 pl-1 ml-xl-2 mt-3 mt-xl-0">20+ Years Experience</h3>
							</div>
						</div>
						<div class="col-6 col-xl-3 divider-left-border appear-animation" data-appear-animation="fadeInRightShorter">
							<div class="d-flex align-items-center justify-content-center flex-column flex-xl-row text-center">
								...
								<h3 class="text-transform-none text-color-dark font-weight-bold mb-0 text-4 px-3 px-sm-0 pl-1 ml-xl-2 mt-3 mt-xl-0">Insured &amp; Bonded</h3>
							</div>
						</div>
						<div class="col-6 col-xl-3 divider-left-border appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="200">
							<div class="d-flex align-items-center justify-content-center flex-column flex-xl-row text-center">
								...
								<h3 class="text-transform-none text-color-dark font-weight-bold mb-0 text-4 pl-1 ml-xl-2 mt-3 mt-xl-0">Trained Professionals</h3>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="row align-items-end pb-3 mb-5 mb-lg-4">
							...
							<div class="col-lg-5 col-xl-4">
								<div class="d-flex justify-content-lg-end">
									...
									<a href="demo-cleaning-services-contact.html" class="btn btn-secondary btn-modern font-weight-bold text-3 btn-px-4 py-3 ml-4 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1600">BOOK NOW</a>
								</div>
							</div>
						</div>
						<div class="row appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="2000">
							<div class="col">
								@include('porto.partials.owl-carousel.owl-carousel-40')
							</div>
						</div>
					</div>
				</section>
				...
				<section class="section border-0 m-0">
					<div class="container">
						...
						<div class="row align-items-center justify-content-center mb-4">
							...
							<div class="col-sm-9 col-lg-5 pl-sm-5">
								<div class="position-relative">
									<div data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.2, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}">
						...
						<div class="featured-boxes featured-boxes-style-4 custom-featured-boxes-style-1">
							<div class="row justify-content-center">
								<div class="col-md-8 col-lg-4">
									@include('porto.partials.featured-box.featured-box-8', ['key' => 'featured-box.featured-box-8'])
								</div>
								<div class="col-md-8 col-lg-4">
									@include('porto.partials.featured-box.featured-box-9', ['key' => 'featured-box.featured-box-9'])
								</div>
								<div class="col-md-8 col-lg-4">
									@include('porto.partials.featured-box.featured-box-10', ['key' => 'featured-box.featured-box-10'])
								</div>
							</div>
						</div>
					</div>
				...
				<section class="section border-0 pt-4 pb-3 m-0">
					<div class="container">
						...
						<div class="row appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="2000">
							<div class="col">
								@include('porto.partials.owl-carousel.owl-carousel-41')
							</div>
						</div>
					</div>
				</section>
				...
				<section class="section section-with-shape-divider bg-transparent border-0 pb-4 m-0">
					...
					<div class="container pt-5 mt-5">
						...
						<div class="row appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">
							<div class="col">
								@include('porto.partials.owl-carousel.owl-carousel-42')
							</div>
						</div>
					</div>
				</section>
					...
					<div class="container pt-5 pb-3 mt-4">
						<div class="row mt-5 mb-5">
							...
							<div class="col-lg-8 pl-lg-4">
								@include('porto.partials.owl-carousel.owl-carousel-43')
							</div>
						</div>
					</div>
				</section>
				...
				<section class="section border-0 pt-4 m-0">
					<div class="container">
						...
						<div class="row appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">
							<div class="col">
								@include('porto.partials.owl-carousel.owl-carousel-44')
							</div>
						</div>
					</div>
				</section>
