...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-300')
				...
				<div class="container py-2">
					...
					<div class="row mt-3 pt-2">
						...
						<div class="col-lg-6">
							...
							<div class="sort-destination-loader sort-destination-loader-showing">
								<div class="row portfolio-list sort-destination" data-sort-id="portfolio">
									...
									<div class="col-12 isotope-item brands">
										@include('porto.partials.portfolio-item.portfolio-item-323')
									</div>

									<div class="col-12 isotope-item medias">
										@include('porto.partials.portfolio-item.portfolio-item-324')
									</div>

									<div class="col-12 isotope-item logos">
										@include('porto.partials.portfolio-item.portfolio-item-325')
									</div>

									<div class="col-12 isotope-item websites">
										@include('porto.partials.portfolio-item.portfolio-item-326')
									</div>
						...
						<div class="col-lg-3">
							@include('porto.partials.sidebar.sidebar-61')
						</div>
					</div>
