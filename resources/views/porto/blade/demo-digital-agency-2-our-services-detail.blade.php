...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-130')

								<section class="mt-3 mt-xl-0 py-5 p-relative z-index-2">
									<div class="container">
										<div class="row">
											<div class="col-xl-4 our-services">
												<h4 class="text-color- custom-text-8 font-weight-bolder custom-title-with-icon custom-title-with-icon-primary mb-4 pb-3">We Can Help You With:</h4>
												<div class="row flex-column pb-lg-5">
													<div class="col">
														<a href="demo-digital-agency-2-our-services-detail.html" class="text-decoration-none">
															<div class="service-card active pl-5 py-4 mb-4 bg-color-primary text-color-light w-100 font-weight-semibold custom-text-4 line-height-6 p-relative">
																UX Design
															</div>
														</a>
													</div>
											...
											<div class="col-xl-8 mt-lg-5 mt-xl-0">
												...
												<div class="accordion custom-accordion mb-4 appear-animation" id="accordion" data-appear-animation="fadeIn" data-appear-animation-delay="1000">
													<div class="card card-default custom-card-default rounded-0">
														<div class="card-header bg-color-tertiary">
															<h4 class="card-title m-0">
																<a class="accordion-toggle px-0 py-3" data-toggle="collapse" data-parent="#accordion" href="#collapse1One">
																	Project Brainstorm
																</a>
															</h4>
														</div>
													...
													<div class="card card-default custom-card-default rounded-0">
														<div class="card-header bg-color-tertiary">
															<h4 class="card-title m-0">
																<a class="accordion-toggle px-0 py-3" data-toggle="collapse" data-parent="#accordion" href="#collapse2Two">
													...
													<div class="card card-default custom-card-default rounded-0">
														<div class="card-header bg-color-tertiary">
															<h4 class="card-title m-0">
																<a class="accordion-toggle px-0 py-3" data-toggle="collapse" data-parent="#accordion" href="#collapse3Three">
																	Project Delivery
																</a>
															</h4>
														</div>
												...
												@include('porto.partials.testimonial.testimonial-39')
...
@section('footer')
@include('porto.partials.footer.footer-124')
@endsection
