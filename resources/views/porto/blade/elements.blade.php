...
<div role="main" class="main">
				...
				<section class="section section-concept section-no-border section-dark section-angled section-angled-reverse p-relative z-index-2 pt-5 m-0" style="background-image: url(img/landing/header_bg.jpg); background-size: cover; background-position: center; animation-duration: 750ms; animation-delay: 300ms; animation-fill-mode: forwards; min-height: 645px;">
					...
					<div class="container pt-lg-5 mt-5">
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								...
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Elements</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">Everything you need to create your website with endless possibilities.</p>
								<a href="#elements" data-hash data-hash-offset="100" class="btn btn-gradient-primary font-weight-semi-bold px-4 btn-py-2 text-3">View Elements <i class="fas fa-arrow-down ml-1"></i></a>
				...
				<section id="elements" class="section section-height-2 border-0 p-relative z-index-3 mt-0 pt-0 mb-0">
