@extends('porto.app')
@section('header')
@include('porto.partials.header.header-248')
@endsection
...
<div role="main" class="main">
				...
				<div class="appear-animation overflow-hidden" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
