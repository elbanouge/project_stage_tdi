...
<div role="main" class="main">
						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Shape Dividers</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Shape Dividers</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">Tons of shape dividers ready styles. Simple and easy to use trough a few lines of code.</p>
				...
				<section id="examples" class="section section-height-5 section-with-shape-divider border-0 lazyload my-5" data-bg-src="img/parallax/parallax-2.jpg">
				...
				<section class="section section-height-5 section-with-shape-divider border-0 lazyload my-5" data-bg-src="img/parallax/parallax-2.jpg">
					...
					<div class="spacer py-5 my-5"></div>
					<div class="shape-divider shape-divider-bottom shape-divider-reverse-xy" style="height: 385px;">
						<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 2000 385" preserveaspectratio="xMinYMin">
							<circle fill="#F7F7F7" opacity="0.2" cx="57" cy="181" r="161"></circle>
							<circle fill="#F4F4F4" opacity="0.3" cx="75.5" cy="158.5" r="169.5"></circle>
							<path fill="#FFFFFF" opacity="0.5" d="M-35,226c17.66,1.2,43.63,2.44,75,2c83.48-1.18,144.86-13.49,188-22c224.54-44.3,165.12-27.27,310-59
				...
				<section class="section section-height-5 section-with-shape-divider border-0 lazyload my-5" data-bg-src="img/parallax/parallax-2.jpg">
					<div class="shape-divider shape-divider-reverse-xy" style="height: 109px;">
				...
				<section class="section section-height-5 section-with-shape-divider border-0 lazyload my-5" data-bg-src="img/parallax/parallax-2.jpg">
					<div class="shape-divider shape-divider-reverse-x" style="height: 212px;">
					...
					<div class="spacer py-5 my-5"></div>
					<div class="shape-divider shape-divider-bottom shape-divider-reverse-y" style="height: 212px;">
						<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 1920 212" preserveaspectratio="xMinYMin">
							<polygon fill="#F3F3F3" points="0,75 479,161 1357,28 1701,56 1920,26 1920,213 0,212 "></polygon>
							<polygon fill="#FFFFFF" points="0,91 481,177 1358,44 1702,72 1920,42 1920,212 0,212 "></polygon>
						</svg>
				...
				<section class="section section-height-5 section-with-shape-divider border-0 lazyload my-5" data-bg-src="img/parallax/parallax-2.jpg">
					...
					<div class="spacer py-5 my-5"></div>
					<div class="shape-divider shape-divider-bottom shape-divider-reverse-y" style="height: 102px;">
						<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 1920 102" preserveaspectratio="xMinYMin">
							<polygon fill="#F3F3F3" points="0,65 220,35 562,63 931,10 1410,68 1920,16 1920,103 0,103 "></polygon>
							<polygon fill="#FFFFFF" points="0,82 219,51 562,78 931,26 1409,83 1920,32 1920,103 0,103 "></polygon>
						</svg>
				...
				<section class="section section-height-5 section-with-shape-divider border-0 lazyload my-5" data-bg-src="img/parallax/parallax-2.jpg">
					<div class="shape-divider shape-divider-reverse-xy" style="height: 576px;">
						<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 1920 576" preserveaspectratio="xMinYMin">
							<path class="svg-fill-color-primary" d="M-12,66c13.35,40.03,28.35,72.62,41,97c12.78,24.63,30.56,58.44,62,97c19.57,24,36.66,40.31,49,52
					...
					<div class="spacer py-5 my-5"></div>
					<div class="spacer py-5 my-5 d-none d-xl-block"></div>
					<div class="spacer py-5 my-5 d-none d-xl-block"></div>
					<div class="spacer py-5 my-5 d-none d-xl-block"></div>
					<div class="spacer py-5 my-5 d-none d-xl-block"></div>
				...
				<section class="section section-height-5 section-with-shape-divider border-0 lazyload my-5" data-bg-src="img/parallax/parallax-2.jpg">
					...
					<div class="spacer py-5 my-5"></div>
					<div class="shape-divider shape-divider-bottom" style="height: 136px;">
						<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 1920 136" preserveaspectratio="xMinYMin">
							<path d="M 0 0.11 L 0 136 L 1920 136 L 1920 1.9 C 1650.0482 79.0955 1327.0648 134 980 134 C 615.6218 134 277.7878 84.5059 0 0.11 Z" fill="#ffffff"></path>
						</svg>
					</div>
				...
				<section class="section section-height-5 section-angled border-0 lazyload my-5" data-bg-src="img/parallax/parallax-2.jpg">
					<div class="section-angled-layer-top section-angled-layer-increase-angle-2 bg-light"></div>
				...
				<section class="section section-height-5 section-angled section-angled-reverse border-0 lazyload my-5" data-bg-src="img/parallax/parallax-2.jpg">
					<div class="section-angled-layer-top section-angled-layer-increase-angle-2 bg-light"></div>
					<div class="section-angled-layer-bottom section-angled-layer-increase-angle-2 bg-light"></div>
					<div class="section-angled-content">
						<div class="spacer py-5 my-5"></div>
				...
				<section class="section section-height-5 section-funnel border-0 lazyload my-5" data-bg-src="img/parallax/parallax-2.jpg">
					<div class="section-funnel-layer-top">
				...
				<section class="section section-height-5 section-with-shape-divider border-0 lazyload my-5" data-bg-src="img/parallax/parallax-2.jpg">
					<div class="shape-divider shape-divider-reverse-x" style="height: 600px;">
						<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 1920 600" preserveaspectratio="xMinYMin">
					...
					<div class="spacer py-5 my-5"></div>
					<div class="spacer py-5 my-5"></div>
					<div class="shape-divider shape-divider-bottom shape-divider-reverse-y" style="height: 600px;">
						<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 1920 600" preserveaspectratio="xMinYMin">
							<path d="m-12.66406,442.40068c352.72654,-76.36348 565.45337,5.45453 696.36219,19.99996c130.90882,14.54542 270.90852,-23.63632 367.27196,-47.27263c96.36344,-23.63631 379.99921,-154.54513 527.27163,-209.09047c147.27242,-54.54535 381.813,-92.55755 406.36076,-99.00598c12.27388,-3.22421 917.96684,-113.93032 715.00991,10.61478c-202.95693,124.5451 -210.46055,521.28714 -198.64021,540.29354c11.82034,19.0064 -2500.90899,-15.53962 -2500.0019,-16.36399c-0.90709,0.82437 -9.99798,-180.99343 -9.09089,-181.8178" stroke-opacity="null" stroke-width="0" stroke="#000" fill="#f7f8f9"></path>
						  	<path d="m-116.90461,507.88064c314.5448,-112.72704 523.63527,-21.81814 878.17999,12.72724c354.54471,34.54538 632.72595,-225.45407 978.17978,-294.54484c172.72691,-34.54538 291.36195,-62.7275 368.52007,-78.40952c77.15812,-15.68202 352.84215,-22.50036 359.66142,-7.04537c13.63854,30.90997 97.72734,614.54347 50.90961,639.99858c-46.81772,25.4551 -855.68236,4.54593 -1433.63569,1.81866c-577.95334,-2.72727 -1155.90718,-5.45466 -1155.45364,-5.45491" stroke-opacity="null" stroke-width="0" stroke="#000" fill="#fbfcfc"></path>
						  	<path d="m-115.93584,623.27542c234.54496,-132.72699 429.09001,-112.72703 678.1804,-83.63619c249.09039,29.09085 389.09011,30.90903 656.36228,-107.2725c267.27217,-138.18153 816.36193,-207.2723 1121.81584,-170.90873c305.45391,36.36356 -292.72666,-19.99996 -293.63778,-18.18228c71.36548,8.18218 627.05432,68.63506 626.48637,265.22584c-0.56794,196.59079 -20.11364,456.59134 -31.02284,531.13767c-10.90919,74.54633 -1561.82313,-36.3646 -1565.45948,-34.54642c-3.63636,1.81818 -1249.08831,-1.81818 -1248.18122,-1.81869c-0.90709,0.00051 39.09282,-234.54445 39.99992,-234.54496c-0.9071,0.00051 -4.54345,-76.36297 -3.63636,-76.36348" stroke-opacity="null" stroke-width="0" stroke="#000" fill="#ffffff"></path>
				...
				<section class="section section-height-5 section-with-shape-divider border-0 lazyload my-5" data-bg-src="img/parallax/parallax-2.jpg">
					<div class="shape-divider shape-divider-reverse-x" style="height: 298px;">
						<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 1920 298" preserveaspectratio="xMinYMin">
							<path fill="#FFF" stroke="#000" stroke-width="0" d="m-16.68437,95.44889c0,0 5.33335,176.00075 660.00283,93.33373c327.33474,-41.33351 503.33549,15.3334 639.00274,35.66682c135.66725,20.33342 59.66691,9.66671 358.33487,28.33346c298.66795,18.66676 268.66829,-45.00088 382.66831,-112.00048c114.00002,-66.9996 718.31698,-59.48704 1221.66946,95.563c503.35248,155.05004 -221.83202,184.10564 -243.66935,197.60521c-21.83733,13.49958 -3008.67549,-19.83371 -3008.00467,-20.83335c-0.67082,0.99964 -30.00428,-232.33469 -10.00419,-317.66839z"></path>
						</svg>
					</div>
					<div class="spacer py-5 my-5"></div>
					<div class="spacer py-5 my-5"></div>
				...
				<div class="container">
					<div class="row">
						<div class="col">
							<h4>Animated</h4>
							<hr>
							<p>Animate any shape divider horizontally. Just wrap the shape divider inside the animation div wrapper.</p>
						</div>
					</div>
				</div>
				...
				<section class="section section-height-5 section-with-shape-divider border-0 lazyload my-5" data-bg-src="img/parallax/parallax-2.jpg">
					...
					<div class="spacer py-5 my-5"></div>
					<div class="shape-divider shape-divider-bottom shape-divider-reverse-y" style="height: 120px;">
						<div class="shape-divider-horizontal-animation shape-divider-horizontal-animation-to-right">
							<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 2000 120" preserveaspectratio="xMinYMin">
								<polygon fill="#FFF" points="-11,2 693,112 2019,6 2019,135 -11,135 "></polygon>
							</svg>
						</div>
				...
				<section class="section section-height-5 section-with-shape-divider border-0 lazyload my-5" data-bg-src="img/parallax/parallax-2.jpg">
					<div class="shape-divider shape-divider-reverse-xy" style="height: 212px;">
						<div class="shape-divider-horizontal-animation shape-divider-horizontal-animation-to-left">
							<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewbox="0 0 1920 212" preserveaspectratio="xMinYMin">
								<polygon fill="#F3F3F3" points="0,75 479,161 1357,28 1701,56 1920,26 1920,213 0,212 "></polygon>
								<polygon fill="#FFFFFF" points="0,91 481,177 1358,44 1702,72 1920,42 1920,212 0,212 "></polygon>
