@extends('porto.app')
@section('header')
@include('porto.partials.header.header-264')
@endsection

@section('main')
<div role="main" class="main">
				<div class="p-relative">
					<section class="section border-0 m-0" style="background-image: url(img/slides/slide-bg-8.jpg); background-size: 100%; background-position: bottom; background-repeat: no-repeat; background-color: #ededed; height: 100vh;">
								...
								<div class="col-lg-6 pb-5">
									<div class="d-flex flex-column align-items-center justify-content-center text-center h-100">
										<h3 class="position-relative text-color-dark text-5 line-height-5 font-weight-medium px-4 mb-2 appear-animation" data-appear-animation="fadeInDownShorter" data-plugin-options="{'minWindowWidth': 0}">
											...
											DO YOU NEED A <span class="position-relative">NEW <span class="position-absolute left-50pct transform3dx-n50 top-0 mt-3"><img src="img/slides/slide-blue-line.png" class="w-auto appear-animation" data-appear-animation="fadeInLeftShorterPlus" data-appear-animation-delay="1000" data-plugin-options="{'minWindowWidth': 0}" alt=""></span></span>
										...
										<h1 class="text-color-dark font-weight-extra-bold text-12 mb-2 appear-animation" data-appear-animation="blurIn" data-appear-animation-delay="500" data-plugin-options="{'minWindowWidth': 0}">WEB DESIGN?</h1>
										<p class="text-4 text-color-dark font-weight-light opacity-7 mb-0" data-plugin-animated-letters data-plugin-options="{'startDelay': 1000, 'minWindowWidth': 0}">Check out our options and features</p>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="header-body header-body-bottom-border">
							<div class="header-container header-container-height-sm container">
								<div class="header-row">
									...
									<div class="porto.partialsy-content-end">
										<div class="header-row">porto.partials
											@include('porto.partials.header-nav.header-nav-214')
					...
					<section class="section section-default section-footer">
						<div class="container">
							<div class="row mt-5 appear-animation" data-appear-animation="fadeInUpShorter">
								...
								<div class="col-lg-6">
									<h2 class="fonporto.partials-6 mb-4"><strong class="font-weight-extra-bold">What</strong> Client’s Say</h2>
									<div class="row">
										@include('porto.partials.owl-carousel.owl-carousel-191')
									</div>
								</div>
							</div>
						</div>
