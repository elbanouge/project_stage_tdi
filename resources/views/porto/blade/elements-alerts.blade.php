						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Alerts</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Alerts</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">With alerts you can highlight important informations for the website user in a simple and effective way.</p>
							...
							<div class="row">
								<div class="col pb-3">
									...
									<div class="alert alert-danger">
										<strong>Oh snap!</strong> Are you using other template? <a href="#" class="alert-link">Buy Porto now</a> and make your customers a lot happier.
									</div>
									...
									<div class="row">
										<div class="col-lg-6">
											...
											<h4 class="mb-0">Dismissible alerts</h4>
										...
										<div class="col-lg-6">
											<h4 class="mb-0">With Icons</h4>
											<p>Add any icon you want from the icons library.</p>

											<div class="alert alert-success">
												<strong><i class="far fa-thumbs-up"></i> Well done!</strong> You successfully read this important alert message.
											</div>
										</div>
									</div>
