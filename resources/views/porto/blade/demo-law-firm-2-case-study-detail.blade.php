@extends('porto.app')
@section('header')
@include('porto.partials.header.header-136')
@endsection

@section('main')
<div role="main" class="main">
				
				@include('porto.partials.page-header.page-header-167')
				...
				<div class="container">
					<div class="row pb-4">
						<div class="col-lg-8 mb-5 mb-lg-0 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="200">
							<h2 class="text-color-dark font-weight-bold text-10 pb-3 mb-4"><em>Family Law Success Case Example</em></h2>
							<img src="img/demos/law-firm-2/cases/case-1-big.jpg" class="img-fluid float-right custom-box-shadow-1 ml-3" alt="">
							<p class="font-weight-bold text-4 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi euismod, sed porta est consectetur. Vestibulum auctor felis eget orci semper vestibulum. </p>
							...
							<h3 class="text-transform-none alternative-font-4 text-color-primary text-4-5 font-weight-bold mb-2">Legal Strategy</h3>
							...
							<p class="mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi euismod, sed porta est consectetur. Vestibulum auctor felis eget orci semper vestibulum. Pellentesque ultricies nibh gravida, accumsan libero luctus, molestie nunc. </p>
							<h3 class="text-transform-none alternative-font-4 text-color-primary text-4-5 font-weight-bold mb-2">Legal Results</h3>
							<p class="pb-2 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed imperdiet libero id nisi euismod, sed porta est consectetur. Vestibulum auctor felis eget orci semper vestibulum. </p>
						...
						<div class="col-lg-4 appear-animation" data-appear-animation="fadeInUpShorterPlus" data-appear-animation-delay="400">
							@include('porto.partials.sidebar.sidebar-24')
						</div>
					</div>
				</div>
				<div class="spacer py-3 my-4"></div>
				...
				<div class="container py-5 my-5">
					<div class="row pb-2 mb-4">
						<div class="col text-center">
							<h3 class="alternative-font-4 text-color-primary font-weight-semibold text-4 mb-1">RECENT CASES</h3>
							<h2 class="text-transform-none text-color-dark font-weight-bold text-10 negative-ls-1 mb-2">Featured Cases</h2>
						</div>
					</div>
					<div class="row">
						<div class="col">
							@include('porto.partials.owl-carousel.owl-carousel-79')
						</div>
					</div>
				</div>
