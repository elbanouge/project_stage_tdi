						...
						<div class="header-row">
							<div class="header-column">
								<div clasporto.partials
									@include('porto.partials.header-logo.header-logo-67')
								</div>
							</div>porto.partials
							<div class="header-column justify-content-end">
								<div class="header-row">
...
<div role="main" class="main">
				@include('porto.partials.owl-carousel.owl-carousel-328')
					...
					<div class="container">
						<div class="row">
							<div class="col appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="200">
								...
								@include('porto.partials.owl-carousel.owl-carousel-329')
									...
									<div class="col-half-section col-half-section-right mb-5 appear-animation" data-appear-animation="fadeInRightShorter">
										...
										<div class="row recent-posts">
											...
											<div class="col-md-6">
												<article>
													<div class="row">
														<div claporto.partials
															<div class="date">
																<span class="day bg-color-light text-color-dark font-weight-extra-bold">14</span>
																<span porto.partialsr-light font-weight-semibold text-color-primary text-1">JAN</span>
															</div>
														</div>
														<div claporto.partials
															<h4 class="font-weight-normal line-height-3 text-4"><a href="blog-post.html" class="text-light">Lorem ipsum dolor sit amet, consectetur</a></h4>
															<p class="text-color-light line-height-5 opacity-6 pr-4 mb-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
															<a hrefporto.partialse text-color-light font-weight-semibold text-2">read more <i class="fas fa-chevron-right text-1 ml-1"></i></a>
														</div>
													</div>
												</article>
											</div>
									...
									<div class="col-half-section mb-5 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="400">
										<div class="row counters counters-sm counters-text-light">
											<div class="col-md-6 mb-5">
												@include('porto.partials.counter.counter-139')
											</div>
											<div class="col-md-6 mb-5">
												@include('porto.partials.counter.counter-140')
											</div>
											<div class="col-md-6 mb-5 mb-md-0">
												@include('porto.partials.counter.counter-141')
											</div>
											<div class="col-md-6">
												@include('porto.partials.counter.counter-142')
											</div>
										</div>
									</div>
								</div>
				...
				<div class="container">
					<div class="row py-5 my-5">
						<div class="col">
							...
							@include('porto.partials.owl-carousel.owl-carousel-330')
				...
				<div class="container my-4">
					<div class="row py-5">
						<div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
							...
							<p clasporto.partialse: (800) 123 4567</p>
