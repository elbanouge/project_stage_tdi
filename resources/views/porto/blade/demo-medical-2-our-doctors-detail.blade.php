@extends('porto.app')
@section('header')
@include('porto.partials.header.header-150')
@endsection
				...
				<div class="container py-5">
					<div class="row">
						<div class="col-lg-4 pb-4 pb-lg-0">
							...
							@include('porto.partials.feature-box.feature-box-97')

							@include('porto.partials.feature-box.feature-box-98')

							@include('porto.partials.feature-box.feature-box-99')
						...
						<div class="col-lg-8">
							...
							@include('porto.partials.process.process-6')
							...
							<div class="progress-bars mt-4 mb-4">
								...
								@include('porto.partials.progress.progress-21')
								<div class="progress-label">
									<span class="text-1">Design</span>
								</div>
								@include('porto.partials.progress.progress-22')
								<div class="progress-label">
									<span class="text-1">WordPress</span>
								</div>
								@include('porto.partials.progress.progress-23')
								<div class="progress-label">
									<span class="text-1">Photoshop</span>
								</div>
								@include('porto.partials.progress.progress-24')
							</div>
