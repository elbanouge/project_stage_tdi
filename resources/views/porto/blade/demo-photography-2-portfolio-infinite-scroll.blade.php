				...
				<div class="container p-0">
					...
					<div id="portfolioInfiniteScrollLoadMoreBtnWrapper" class="row">
						<div class="col text-center">
							...
							<button id="portfolioInfiniteScrollLoadMore" type="button" class="btn btn-portfolioInfiniteScroll-lazy-load btn-quaternary  custom-border-radius font-weight-semibold text-uppercase">View More</button>
						</div>
					</div>
