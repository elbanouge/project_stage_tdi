...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-8')
							...
							<div class="blog-posts">
								...
								<div class="row px-3">
									...
									<div class=porto.partials
										@include('porto.partials.post.post-42')
									</div>
porto.partials
									<div class="col-12">
										@include('porto.partials.post.post-43')
									</div>porto.partials

									<div class="col-12">
										@include('porto.partials.post.post-44')
									</div>

									<div class=porto.partials
										@include('porto.partials.post.post-45')
									</div>
porto.partials
									<div class="col-12">
										@include('porto.partials.post.post-46')
									</div>porto.partials

									<div class="col-12">
										@include('porto.partials.post.post-47')
									</div>

									<div class=porto.partials
										@include('porto.partials.post.post-48')
									</div>
