							...
							<div class="header-row py-2">
								<div class="header-column justify-content-start">
									<div class="header-row">
										@include('porto.partials.header-nav-top.header-nav-top-16')
									</div>
								</div>
								<div class="header-column justify-content-end">
									<div class="header-row">
										<div class="header-nav-features header-nav-features-no-border">
											...
											@include('porto.partials.header-nav-feature.header-nav-feature-4')
										</div>
									</div>
								</div>
							</div>
										...
										<li class="m-0">
											<div class="feature-box feature-box-style-2 align-items-center">
												<div class="feature-box-icon">
													<i claporto.partialst-7 p-relative"></i>
												</div>
							...
							<div class="header-row">
								<div class="header-column">
									<div class="header-row justify-content-end">
										@include('porto.partials.header-nav.header-nav-210')
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row mt-5 appear-animation" data-appear-animation="fadeInUpShorter">
								<div class="col-lg-6">
									<div class="recent-posts mb-5">
										...
										@include('porto.partials.owl-carousel.owl-carousel-193')
									</div>porto.partials
								</div>
								<div class="col-lg-6">
									<h2 class="font-weight-normal text-6 mb-4"><strong class="font-weight-extra-bold">What</strong> Client’s Say</h2>
									<div class="row">
										@include('porto.partials.owl-carousel.owl-carousel-194')
									</div>
								</div>
							</div>
						</div>
							...
							<form id="newsletterForm" class="form-style-5 opacity-10" action="php/newsletter-subscribe.php" method="POST">
								<div class="form-row">
									<div class="form-group col">
										<inpuporto.partialsl" placeholder="Email Address" name="newsletterEmail" id="newsletterEmail" type="text">
									</div>
								</div>
								<div class="form-row">
									<div class="form-group col">
