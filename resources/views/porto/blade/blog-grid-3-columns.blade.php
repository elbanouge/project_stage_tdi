...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-3')
							...
							<div class="blog-posts">
								...
								<div class="row">
									...
									<div class=porto.partials
										@include('porto.partials.post.post-3')
									</div>
porto.partials
									<div class="col-md-4">
										@include('porto.partials.post.post-4')
									</div>porto.partials

									<div class="col-md-4">
										@include('porto.partials.post.post-5')
									</div>

									<div class=porto.partials
										@include('porto.partials.post.post-6')
									</div>
porto.partials
									<div class="col-md-4">
										@include('porto.partials.post.post-7')
									</div>porto.partials

									<div class="col-md-4">
										@include('porto.partials.post.post-8')
									</div>

									<div class=porto.partials
										@include('porto.partials.post.post-9')
									</div>

									<div class="col-md-4">
										@include('porto.partials.post.post-10')
									</div>porto.partials

									<div class="col-md-4">
										@include('porto.partials.post.post-11')
									</div>
