						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Before / After</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Before / After</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">With before/after plugin you can show equal images with different colors at same time.</p>
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										...
										<p class="m-0">This is the default before / after style.</p>
									</div>
								...
								<div class="col-sm-9">
									...
									<div data-plugin-before-after>
										...
										<img src="img/generic/generic-before-after-1-1.jpg">
										<!-- The after image is last -->
										<img src="img/generic/generic-before-after-1-2.jpg">
									</div>
							...
							<div class="row align-items-center">
								...
								<div class="col-sm-9">
									...
									<div data-plugin-before-after data-plugin-options="{'move_slider_on_hover': true, 'move_with_handle_only': true, 'click_to_move': false}">
										<!-- The before image is first -->
										<img src="img/generic/generic-before-after-3-1.jpg">
										<!-- The after image is last -->
										<img src="img/generic/generic-before-after-3-2.jpg">
									</div>
						...
						<div class="col">
							...
							<div class="row align-items-center">
								<div class="col-sm-3">
									...
									<div class="pr-3 pr-sm-5 pb-3 pb-sm-0 border-right-light">
										<h4 class="mb-2">Vertical Orientation</h4>
										<p class="m-0">Demonstrates sliding up and down.</p>
									</div>

								</div>
								<div class="col-sm-9">

									<div data-plugin-before-after data-plugin-options="{'default_offset_pct': 0.7, 'orientation': 'vertical', 'before_label': 'Before', 'after_label': 'After', 'no_overlay': true}">
										<!-- The before image is first -->
										<img src="img/generic/generic-before-after-2-1.jpg">
										<!-- The after image is last -->
										<img src="img/generic/generic-before-after-2-2.jpg">
									</div>
