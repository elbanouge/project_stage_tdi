...
<header id="header" data-plugin-options="{'stickyEnabled': true, 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': true, 'stickyChangeLogo': false, 'stickyStartAt': 0}">
				...
				<div class="header-nav-features header-nav-features-no-border p-static">
					@include('porto.partials.header-nav-feature.header-nav-feature-21')
				</div>
			</header>
@endsection
							...
							<div class="row mt-5 appear-animation" data-appear-animation="fadeInUpShorter">
								<div class="col-lg-6">
									<div class="recent-posts mb-5">
										...
										@include('porto.partials.owl-carousel.owl-carousel-223')
									</div>
								</div>
								<div class="col-lg-6">
									<h2 class="fonporto.partials-6 mb-4"><strong class="font-weight-extra-bold">What</strong> Client’s Say</h2>
									<div class="row">
										@include('porto.partials.owl-carousel.owl-carousel-224')
									</div>
								</div>
							</div>
						</div>
