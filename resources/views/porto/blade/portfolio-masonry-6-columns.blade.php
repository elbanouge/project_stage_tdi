...
porto.partials
				@include('porto.partials.page-header.page-header-297')
...
porto.partials
					<div class="sort-destination-loader sort-destination-loader-showing mt-4 pt-2">
						<div class="row portfolio-list sort-destination" data-sort-id="portfolio">
							...
							<div class="col-md-6 col-lg-2 isotope-item brands">
								@include('porto.partials.portfolio-item.portfolio-item-299')
							</div>

							<div class=porto.partialssotope-item medias">
								@include('porto.partials.portfolio-item.portfolio-item-300')
							</div>
porto.partials
							<div class="col-md-6 col-lg-2 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-301')
							</div>

							<div class="col-md-6 col-lg-2 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-302')
							</div>

							<div class="col-md-6 col-lg-2 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-303')
							</div>

							<div class="col-md-6 col-lg-2 isotope-item brands">
								@include('porto.partials.portfolio-item.portfolio-item-304')
							</div>

							<div class="col-md-6 col-lg-2 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-305')
							</div>

							<div class="col-md-6 col-lg-2 isotope-item medias">
								@include('porto.partials.portfolio-item.portfolio-item-306')
							</div>

							<div class="col-md-6 col-lg-2 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-307')
							</div>

							<div class="col-md-6 col-lg-2 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-308')
							</div>

							<div class="col-md-6 col-lg-2 isotope-item medias">
								@include('porto.partials.portfolio-item.portfolio-item-309')
							</div>

							<div class="col-md-6 col-lg-2 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-310')
							</div>
