@extends('porto.app')
@section('header')
@include('porto.partials.header.header-154')
@endsection

@section('main')
<div role="main" class="main">
				
			@include('porto.partials.page-header.page-header-179')
				...
				<div class="row mt-5 mb-5">
					<div class="col">
						...
						<div class="appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="100">
							@include('porto.partials.feature-box.feature-box-104')

							<hr class="solid my-5">
						</div>

						<div class="appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="100">
							@include('porto.partials.feature-box.feature-box-105')

							<hr class="solid my-5">
						</div>

						<div class="appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="100">
							@include('porto.partials.feature-box.feature-box-106')

							<hr class="solid my-5">
						</div>

						<div class="appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="100">
							@include('porto.partials.feature-box.feature-box-107')

							<hr class="solid my-5">
						</div>

						<div class="appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="100">
							@include('porto.partials.feature-box.feature-box-108')

							<hr class="solid my-5">
						</div>

						<div class="appear-animation" data-appear-animation="fadeInUp" data-appear-animation-delay="100">
							@include('porto.partials.feature-box.feature-box-109')
						</div>
