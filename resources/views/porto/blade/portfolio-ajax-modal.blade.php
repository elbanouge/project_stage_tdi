...
porto.partials
				@include('porto.partials.page-header.page-header-275')
					...
					<div class="sort-destination-loader sort-destination-loader-showing mt-4 pt-2 pb-3 mb-3">
						<div class="row portfolio-list sort-destination popup-gallery-ajax" data-sort-id="portfolio">
							...
							<div class="col-sm-6 col-lg-3 isotope-item brands">
								@include('porto.partials.portfolio-item.portfolio-item-189')
							</div>

							<div class="col-sm-6 col-lg-3 isotope-item medias">
								@include('porto.partials.portfolio-item.portfolio-item-190')
							</div>

							<div class="col-sm-6 col-lg-3 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-191')
							</div>

							<div class="col-sm-6 col-lg-3 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-192')
							</div>

							<div class="col-sm-6 col-lg-3 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-193')
							</div>

							<div class="col-sm-6 col-lg-3 isotope-item brands">
								@include('porto.partials.portfolio-item.portfolio-item-194')
							</div>

							<div class="col-sm-6 col-lg-3 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-195')
							</div>

							<div class="col-sm-6 col-lg-3 isotope-item medias">
								@include('porto.partials.portfolio-item.portfolio-item-196')
							</div>
