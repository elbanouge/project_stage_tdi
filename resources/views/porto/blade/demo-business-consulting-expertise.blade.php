...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-91')
				...
				<div class="container">
					<div class="row pt-1 pb-5 mb-3">
						<div class="col">
							...
							<div class="row mb-3">
								<div class="col">
									@include('porto.partials.feature-box.feature-box-24')
								</div>
							</div>
							<div class="row mb-3">
								<div class="col">
									@include('porto.partials.feature-box.feature-box-25')
								</div>
							</div>
							<div class="row mb-3">
								<div class="col">
									@include('porto.partials.feature-box.feature-box-26')
								</div>
							</div>
							<div class="row mb-3">
								<div class="col">
									@include('porto.partials.feature-box.feature-box-27')
								</div>
							</div>
							<div class="row mb-3">
								<div class="col">
									@include('porto.partials.feature-box.feature-box-28')
								</div>
							</div>
							<div class="row">
								<div class="col">
									@include('porto.partials.feature-box.feature-box-29')
								</div>
							</div>
