@extends('porto.app')
@section('header')
@include('porto.partials.header.header-190')
@endsection

@section('main')
<div role="maiporto.partials

				@include('porto.partials.page-header.page-header-201')
					...
					<div class="container pb-2 mb-4">
						<div class="row justify-content-center align-items-center">
							<div class="col-md-10 col-lg-6 mb-5 mb-lg-0">
								...
								@include('porto.partials.feature-box.feature-box-140')
								@include('porto.partials.feature-box.feature-box-141')
							</div>
