						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Image Hotspots</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Image Hotspots</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">An interactive way to highlight and describe important parts of your images.</p>
					...
					<div class="row mb-4 pb-4">
						<div class="col">
							<div class="image-hotspots">
								<img src="img/bg-hotspots.jpg" class="img-fluid">

								<a style="left: 18%; top: 19%;" class="image-hotspot image-hotspot-primary" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
									<strong>1</strong>
								</a>

								<a style="left: 10%; top: 70%;" class="image-hotspot image-hotspot-primary" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
									<strong>2</strong>
								</a>

								<a style="left: 60%; top: 32%;" class="image-hotspot image-hotspot-dark" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
									<strong>3</strong>
								</a>

								<a style="left: 77%; top: 36%;" class="image-hotspot image-hotspot-light" data-container="body" data-toggle="popover" data-placement="top" data-content="Vivamus sagittis lacus vel augue laoreet rutrum faucibus.">
									<strong>4</strong>
								</a>
