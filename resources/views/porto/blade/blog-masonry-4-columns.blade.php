...
<div role="main" class="main">
				...
				@include('porto.partials.page-header.page-header-17')
							...
							<div class="blog-posts">
								...
								<div class="masonry-loader masonry-loader-showing">
									<div class="masonry row" data-plugin-masonry data-plugin-options="{'itemSelector': '.masonry-item'}">
										...
										<div class=porto.partialsault-style col-md-4 col-lg-3">
											@include('porto.partials.post.post-62')
										</div>
porto.partials
										<div class="masonry-item no-default-style col-md-4 col-lg-3">
											@include('porto.partials.post.post-63')
										</div>porto.partials

										<div class="masonry-item no-default-style col-md-4 col-lg-3">
											@include('porto.partials.post.post-64')
										</div>

										<div class=porto.partialsault-style col-md-4 col-lg-3">
											@include('porto.partials.post.post-65')
										</div>
porto.partials
										<div class="masonry-item no-default-style col-md-4 col-lg-3">
											@include('porto.partials.post.post-66')
										</div>porto.partials

										<div class="masonry-item no-default-style col-md-4 col-lg-3">
											@include('porto.partials.post.post-67')
										</div>

										<div class="masonry-item no-default-style col-md-4 col-lg-3">
											@include('porto.partials.post.post-68')
										</div>

										<div classporto.partialsfault-style col-md-4 col-lg-3">
											@include('porto.partials.post.post-69')
										</div>
