...
<header id="header" class="header-effect-shrink" data-plugin-options="{'stickyEnabled': true, 'stickyEffect': 'shrink', 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': true, 'stickyChangeLogo': true, 'stickyStartAt': 120, 'stickyHeaderContainerHeight': 70}">
						...
						<div class="header-row">
							...
							<div class="header-column justify-content-end">
								<div class="header-row">
									...
									<div class=porto.partials header-nav-features-no-border header-nav-features-lg-show-border order-1 order-lg-2">
			...
			</header>porto.partials
@endsection

@section('main')porto.partials
<div role="main" class="main">

				@include('porto.porto.partialsheader.page-header-302')
...
porto.partials
							<div class="sort-destination-loader sort-destination-loader-showing">
								<div class="row portfolio-list sort-destination" data-sort-id="portfolio">
									...
									<div class=porto.partialssotope-item medias">
...
porto.partials
									...
									<div claporto.partials4 isotope-item logos">
						...
						<div class="col-lg-3">
							@include('porto.partials.sidebar.sidebar-60')
						</div>
					</div>
