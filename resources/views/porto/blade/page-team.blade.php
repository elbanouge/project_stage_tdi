@extends('porto.app')
@section('header')
@include('porto.partials.header.header-354')
@endsection

@section('mainporto.partials
<div role="main" class="main">
				@include('porto.partials.page-header.page-header-273')

				<div class="container py-4">

					@include('porto.partials.nav-pills.nav-pills-36')

					<div class="sort-destination-loader sort-destination-loader-showing mt-4 pt-2">
						<div class="porto.partialsestination" data-sort-id="team">
							<div class="col-12 col-sm-6 col-lg-3 isotope-item leadership">
								@include('porto.partials.thumb-info.thumb-info-502')
							</div>porto.partials
							<div class="col-12 col-sm-6 col-lg-3 isotope-item marketing">
								@include('porto.partials.thumb-info.thumb-info-503')
							</div>porto.partials
							<div class="col-12 col-sm-6 col-lg-3 isotope-item development">
								@include('porto.partials.thumb-info.thumb-info-504')
							</div>porto.partials
							<div class="col-12 col-sm-6 col-lg-3 isotope-item design">
								@include('porto.partials.thumb-info.thumb-info-505')
							</div>porto.partials
							<div class="col-12 col-sm-6 col-lg-3 isotope-item development">
								@include('porto.partials.thumb-info.thumb-info-506')
							</div>porto.partials
							<div class="col-12 col-sm-6 col-lg-3 isotope-item marketing">
								@include('porto.partials.thumb-info.thumb-info-507')
							</div>porto.partials
							<div class="col-12 col-sm-6 col-lg-3 isotope-item development">
								@include('porto.partials.thumb-info.thumb-info-508')
							</div>porto.partials
							<div class="col-12 col-sm-6 col-lg-3 isotope-item development">
								@include('porto.partials.thumb-info.thumb-info-509')
							</div>
						</div>
