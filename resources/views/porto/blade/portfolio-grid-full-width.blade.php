...
<div role="main" class="main">
				...
				@include('portporto.partialse-header.page-header-291')

				<div class="container py-2">
porto.partials
					<ul class="nav nav-pills sort-source sort-source-style-3 justify-content-center" data-sort-id="portfolio" data-option-key="filter" data-plugin-options="{'layoutMode': 'fitRows', 'filter': '*'}">
						<li class="nav-item active" data-option-value="*"><a class="nav-link text-1 text-uppercase active" href="#">Show All</a></li>
						<li class="nporto.partials-value=".websites"><a class="nav-link text-1 text-uppercase" href="#">Websites</a></li>
						...
						<li class="nporto.partials-value=".medias"><a class="nav-link text-1 text-uppercase" href="#">Medias</a></li>
					</ul>
				...
				<div class="container">
					<div class="row py-4 my-5">
						...
						<div class="col-md-6 col-lg-4 mb-5 mb-md-0">
							<h5 clasporto.partials-light mb-3">RECENT NEWS</h5>
							<article class="mb-3">
