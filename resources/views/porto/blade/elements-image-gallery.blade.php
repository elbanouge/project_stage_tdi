						...
						<div class="row pt-3 pb-lg-0 pb-xl-0">
							<div class="col-lg-6 pt-4 mb-5 mb-lg-0">
								<ul class="breadcrumb font-weight-semibold text-4 negative-ls-1">
									...
									<li class="active text-color-primary">Image Gallery</li>
								</ul>
								<h1 class="font-weight-bold text-10 text-xl-12 line-height-2 mb-3">Image Gallery</h1>
								<p class="font-weight-light opacity-7 pb-2 mb-4">Bundled with the premium Isotope plugin, Porto comes with really nice and useful images gallery.</p>
				...
				<div id="examples" class="container py-2">
					...
					<div class="row">
						<div class="col">
							...
							@include('porto.partials.nav-pills.nav-pills-15')
porto.partials
							<div class="sort-destination-loader sort-destination-loader-showing mt-4 pt-2">
								<div class="row portfolio-list sort-destination" data-sort-id="portfolio">
									<div class=porto.partials-lg-3 isotope-item websites">
										@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-56'])
									</div>
									<div class=porto.partials-lg-3 isotope-item medias">
										@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-57'])
									</div>
									<div class=porto.partials-lg-3 isotope-item logos">
										@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-58'])
									</div>
									<div class="col-12 col-sm-6 col-lg-3 isotope-item brands">
										@include('porto.partials.portfolio-item.portfolio-item-56', ['key' => 'portfolio-item.portfolio-item-59'])
									</div>
								</div>
							</div>
						</div>
				...
				<div class="importo.partialstination full-width">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col">
							...
							<div class="maporto.partials-loader-showing">
								<div class="masonry" data-plugin-masonry data-plugin-options="{'itemSelector': '.masonry-item'}">
									<div class="masonry-item">
										<a href="portfolio-single-wide-slider.html">
											@include('porto.partials.thumb-info.thumb-info-426')
										</a>porto.partials
									</div>
									<div class="masonry-item">
										<a href="portfolio-single-wide-slider.html">
											@include('porto.partials.thumb-info.thumb-info-427')
										</a>porto.partials
									</div>
									<div class="masonry-item">
										<a href="portfolio-single-wide-slider.html">
											@include('porto.partials.thumb-info.thumb-info-428')
										</a>porto.partials
									</div>
									<div class="masonry-item">
										<a href="portfolio-single-wide-slider.html">
											@include('porto.partials.thumb-info.thumb-info-429')
										</a>porto.partials
									</div>
									<div class="masonry-item">
										<a href="portfolio-single-wide-slider.html">
											@include('porto.partials.thumb-info.thumb-info-430')
										</a>porto.partials
									</div>
									<div class="masonry-item">
										<a href="portfolio-single-wide-slider.html">
											@include('porto.partials.thumb-info.thumb-info-431')
										</a>porto.partials
									</div>
									<div class="masonry-item">
										<a href="portfolio-single-wide-slider.html">
											@include('porto.partials.thumb-info.thumb-info-432')
										</a>porto.partials
									</div>
									<div class="masonry-item">
										<a href="portfolio-single-wide-slider.html">
											@include('porto.partials.thumb-info.thumb-info-433')
										</a>
									</div>
								</div>
							</div>
							...
							<div class="row justify-content-center mt-4">
								<div class="col-lg-4 mx-auto">
									...
									<div class="thumb-gallery-wrapper">
										@include('porto.partials.owl-carousel.owl-carousel-175')
										@include('porto.partials.owl-carousel.owl-carousel-176')
									</div>
								...
								<div class="col-lg-4 mx-auto">
									...
									<div class="thumb-gallery-wrapper" data-thumbs-items="4" data-thumbs-center="true">
										@include('porto.partials.owl-carousel.owl-carousel-175')
										@include('porto.partials.owl-carousel.owl-carousel-178')
									</div>
porto.partials
								</div>
							</div>
