...
porto.partials
				@include('porto.partials.page-header.page-header-289')
...
porto.partials
					<div class="sort-destination-loader sort-destination-loader-showing mt-4 pt-2">
						<div class="row portfolio-list sort-destination" data-sort-id="portfolio">
							...
							<div class="col-sm-6 col-lg-2 isotope-item brands">
								@include('porto.partials.portfolio-item.portfolio-item-255')
							</div>

							<div class=porto.partialssotope-item medias">
								@include('porto.partials.portfolio-item.portfolio-item-256')
							</div>
porto.partials
							<div class="col-sm-6 col-lg-2 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-257')
							</div>

							<div class="col-sm-6 col-lg-2 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-258')
							</div>

							<div class="col-sm-6 col-lg-2 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-259')
							</div>

							<div class="col-sm-6 col-lg-2 isotope-item brands">
								@include('porto.partials.portfolio-item.portfolio-item-260')
							</div>

							<div class="col-sm-6 col-lg-2 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-261')
							</div>

							<div class="col-sm-6 col-lg-2 isotope-item medias">
								@include('porto.partials.portfolio-item.portfolio-item-262')
							</div>

							<div class="col-sm-6 col-lg-2 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-263')
							</div>

							<div class="col-sm-6 col-lg-2 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-264')
							</div>

							<div class="col-sm-6 col-lg-2 isotope-item medias">
								@include('porto.partials.portfolio-item.portfolio-item-265')
							</div>

							<div class="col-sm-6 col-lg-2 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-266')
							</div>
