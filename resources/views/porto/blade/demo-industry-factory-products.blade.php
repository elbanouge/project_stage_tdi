						...
						<div class="row justify-content-center pb-3 mb-5">
							<div class="col-lg-9 col-xl-8 text-center">
								...
								<div class="overflow-hidden mb-3">
									<h3 class="font-weight-bold text-transform-none text-9 line-height-2 mb-0 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="400">A Selection Of High Quality Products</h3>
								</div>
								...
								<article>
									<div class="card border-0 border-radius-0 box-shadow-1">
										<div class="card-body p-4 z-index-1">
											<a href="demo-industry-factory-products-detail.html">
												<img class="card-img-top border-radius-0 mb-4" src="img/demos/industry-factory/products/product-1.jpg" alt="Product Name">
											</a>
											<div class="card-body p-0">
												<h4 class="card-title mb-3 text-5 font-weight-semibold"><a class="text-color-dark text-color-hover-primary text-decoration-none" href="demo-industry-factory-products-detail.html">Product Name</a></h4>
							...
							<div class="col-md-6 col-lg-4 mb-4">
								<article>
									<div class="card border-0 border-radius-0 box-shadow-1">
										<div class="card-body p-4 z-index-1">
											<a href="demo-industry-factory-products-detail.html">
												<img class="card-img-top border-radius-0 mb-4" src="img/demos/industry-factory/products/product-2.jpg" alt="Product Name">
											</a>
											<div class="card-body p-0">
												<h4 class="card-title mb-3 text-5 font-weight-semibold"><a class="text-color-dark text-color-hover-primary text-decoration-none" href="demo-industry-factory-products-detail.html">Product Name</a></h4>
												<p class="card-text mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra lo...</p>
							...
							<div class="col-md-6 col-lg-4 mb-4">
								<article>
									<div class="card border-0 border-radius-0 box-shadow-1">
										<div class="card-body p-4 z-index-1">
											<a href="demo-industry-factory-products-detail.html">
												<img class="card-img-top border-radius-0 mb-4" src="img/demos/industry-factory/products/product-3.jpg" alt="Product Name">
											</a>
											<div class="card-body p-0">
												<h4 class="card-title mb-3 text-5 font-weight-semibold"><a class="text-color-dark text-color-hover-primary text-decoration-none" href="demo-industry-factory-products-detail.html">Product Name</a></h4>
												<p class="card-text mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra lo...</p>
							...
							<div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
								<article>
									<div class="card border-0 border-radius-0 box-shadow-1">
										<div class="card-body p-4 z-index-1">
											<a href="demo-industry-factory-products-detail.html">
												<img class="card-img-top border-radius-0 mb-4" src="img/demos/industry-factory/products/product-4.jpg" alt="Product Name">
											</a>
											<div class="card-body p-0">
												<h4 class="card-title mb-3 text-5 font-weight-semibold"><a class="text-color-dark text-color-hover-primary text-decoration-none" href="demo-industry-factory-products-detail.html">Product Name</a></h4>
												<p class="card-text mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra lo...</p>
							...
							<div class="col-md-6 col-lg-4 mb-4 mb-md-0">
								<article>
									<div class="card border-0 border-radius-0 box-shadow-1">
										<div class="card-body p-4 z-index-1">
											<a href="demo-industry-factory-products-detail.html">
												<img class="card-img-top border-radius-0 mb-4" src="img/demos/industry-factory/products/product-5.jpg" alt="Product Name">
											</a>
											<div class="card-body p-0">
												<h4 class="card-title mb-3 text-5 font-weight-semibold"><a class="text-color-dark text-color-hover-primary text-decoration-none" href="demo-industry-factory-products-detail.html">Product Name</a></h4>
												<p class="card-text mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra lo...</p>
							...
							<div class="col-md-6 col-lg-4">
								<article>
									<div class="card border-0 border-radius-0 box-shadow-1">
										<div class="card-body p-4 z-index-1">
											<a href="demo-industry-factory-products-detail.html">
												<img class="card-img-top border-radius-0 mb-4" src="img/demos/industry-factory/products/product-6.jpg" alt="Product Name">
											</a>
											<div class="card-body p-0">
												<h4 class="card-title mb-3 text-5 font-weight-semibold"><a class="text-color-dark text-color-hover-primary text-decoration-none" href="demo-industry-factory-products-detail.html">Product Name</a></h4>
												<p class="card-text mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc viverra lo...</p>
