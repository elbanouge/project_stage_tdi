							...
							<div class="header-column justify-content-end">
								<div class="header-row">
									...
									<div class="header-nav-features header-nav-features-no-border header-nav-features-lg-show-border order-1 order-lg-2">
										@include('pporto.partialsheader-nav-feature.header-nav-feature')
...
porto.partials
@section('main')
<div role="main" clasporto.partials

				@include('porto.bporto.partialseader.page-header-310')

				<div class="contaporto.partials

					<div class="row porto.partials
						<div class="col-lg-8 mb-4 mb-lg-0">

							@include('porto.partials.lightbox.lightbox-73')

							<hr class="solid my-5 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="1000">
							
							<div class="appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="1200">
						...
						<div class="col-lg-4">
							<div class="overflow-hidden">
								<h2 class="text-color-dark font-weight-normal text-4 mb-0 pt-1 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="300">Project <strong class="font-weight-extra-bold">Description</strong></h2>
							</div>
							<p class="appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="500">Donec volutpat nibh sit amet libero ornare non laoreet arcu luctus. Donec id arcu quis mauris euismod placerat sit amet ut metus. Sed imperdiet fringilla sem eget euismod. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.</p>

							<div class="overflow-hidden">
								<h2 class="text-color-dark font-weight-normal text-4 mb-0 mt-4 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="700">Project <strong class="font-weight-extra-bold">Details</strong></h2>
							</div>
