...
porto.partials
				@include('porto.partials.page-header.page-header-288')
...
porto.partials
					<div class="sort-destination-loader sort-destination-loader-showing mt-4 pt-2">
						<div class="row portfolio-list sort-destination" data-sort-id="portfolio">
							...
							<div class="colmd-6 col-lg-1-5 isotope-item brands">
								@include('porto.partials.portfolio-item.portfolio-item-245')
							</div>

							<div class="colmd-6 col-lg-1-5 isotope-item medias">
								@include('porto.partials.portfolio-item.portfolio-item-246')
							</div>

							<div class="colmd-6 col-lg-1-5 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-247')
							</div>

							<div class="colmd-6 col-lg-1-5 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-248')
							</div>

							<div class="colmd-6 col-lg-1-5 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-249')
							</div>

							<div class="colmd-6 col-lg-1-5 isotope-item brands">
								@include('porto.partials.portfolio-item.portfolio-item-250')
							</div>

							<div class="colmd-6 col-lg-1-5 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-251')
							</div>

							<div class="colmd-6 col-lg-1-5 isotope-item medias">
								@include('porto.partials.portfolio-item.portfolio-item-252')
							</div>

							<div class="colmd-6 col-lg-1-5 isotope-item logos">
								@include('porto.partials.portfolio-item.portfolio-item-253')
							</div>

							<div class="colmd-6 col-lg-1-5 isotope-item websites">
								@include('porto.partials.portfolio-item.portfolio-item-254')
							</div>
